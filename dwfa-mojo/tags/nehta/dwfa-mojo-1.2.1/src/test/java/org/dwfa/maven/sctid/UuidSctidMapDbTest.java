...
public class UuidSctidMapDbTest extends TestCase {
    ...
    private UuidSctidMapDb mapDb = UuidSctidMapDb.getInstance();
    ...
    protected void setUp() throws Exception {
        super.setUp();
        generateTestMap();
        mapDb.openDb(testDBMap, testFixedMap.getParentFile(), testMap.getParentFile(), true, false);
    ...
    public void testGetUuidList() throws Exception {
        ...
        assertFalse(mapDb.getUuidList(sctId).isEmpty());
        assertEquals(2, mapDb.getUuidList(sctId).size());
    ...
    public void testExistingDb() throws Exception {
        mapDb.openDb(testDBMap, testFixedMap.getParentFile(), testMap.getParentFile(), false, false);
    ...
    public void testCreateDbWithValidationOn() throws Exception {
        ...
        mapDb.openDb(testDBMap, testFixedMap.getParentFile(), testMap.getParentFile(), true, true);
    ...
    public void testUpdateDbWithValidationOn() throws Exception {
        ...
        UuidSctidMapDb mapDb = UuidSctidMapDb.getInstance();
        mapDb.openDb(testDBMap, testFixedMap.getParentFile(), null, true, true);
