...
public class IdsMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        File goalFileDirectory =
                new File("target" + File.separator + "completed-mojos");
        ...
        if (!goalFile.exists()) {
            ...
            try {
                ...
                if (writeHeader) {
                    writer
                        .write("Primary UUID\tSource System UUID\tSource Id\tStatus Id\tEffective Date\tPath UUID");
                    writer.newLine();
                }
                ...
                BufferedReader reader =
                        new BufferedReader(new FileReader(uuidsFile));
                ...
                while (line != null) {
                    ...
                    if (sctid != null) {
                        ...
                        writer.write(uuid + "\t" + source + "\t" + sctid + "\t"
                            + status + "\t" + effective_date + "\t" + path);
                        writer.newLine();
                    }
                    line = reader.readLine();
                }
