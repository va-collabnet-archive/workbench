...
public class AddConceptContainsRelToRefsetSpec extends AbstractAddRefsetSpecTask {
    /**
	 * 
	 */
    ...
    protected I_ThinExtByRefPartConceptConcept createAndPopulatePart(I_TermFactory tf, I_Path p,
        ...
        specPart.setC2id(RefsetAuxiliary.Concept.CONCEPT_CONTAINS_REL_GROUPING.localize().getNid());
