...
/**
 * Task for adding a "relationship refinability is child of"
...
public class RelationshipRefinabilityIsChildOf extends AddStructuralQueryToRefsetSpec {
    /**
	 * 
	 */
    ...
    protected int getStructuralQueryTokenId() throws IOException, TerminologyException {
        return RefsetAuxiliary.Concept.REL_REFINABILITY_IS_CHILD_OF.localize().getNid();
    }
