...
public class UuidSnomedMap implements Map<UUID, Long>, I_MapUuidsToSnomed {
    ...
    protected Map<Long, String> effectiveDateOfSctId = new HashMap<Long, String>();

    protected PROJECT project = null;
    protected NAMESPACE namespace = null;

    protected UuidSnomedMap(PROJECT project, NAMESPACE namespace) {
        super();
        this.project = project;
        this.namespace = namespace;
    }

    protected UuidSnomedMap() {
        super();
    }
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#addFixedMap(java.util.Map)
     */
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#containsKey(java.lang.Object)
     */
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#containsValue(java.lang.Object
     * )
     */
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#getWithGeneration(java.util
     * .UUID, org.dwfa.maven.transform.SctIdGenerator.TYPE)
     */
    ...
    protected static long getSequence(Long sctId) throws StringIndexOutOfBoundsException {
        String sctIdStr = sctId.toString();
        String sequence = sctIdStr.substring(0, sctIdStr.length() - "1000036106".length());
     ...
     * (non-Javadoc)
     * 
     * @see org.dwfa.maven.transform.I_MapUuidsToSnomed#put(java.util.UUID,
     * java.lang.Long)
     */
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#putEffectiveDate(java.lang
     ...
     * 
     * @see
     * org.dwfa.maven.transform.I_MapUuidsToSnomed#getEffectiveDate(java.lang
     * .Long)
     */
