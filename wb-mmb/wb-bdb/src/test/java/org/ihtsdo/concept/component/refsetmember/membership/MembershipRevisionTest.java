...
public class MembershipRevisionTest {

    private MembershipRevision testObj1;
    private MembershipRevision testObj2;
    private MembershipRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<MembershipRevision> coll = new java.util.HashSet<MembershipRevision>();
        coll.add(testObj1);
    ...
    private MembershipRevision makeTestObject1() {
        
        // Create an object to test... 
        MembershipRevision obj = new MembershipRevision();
    ...
    private MembershipRevision makeTestObject2() {
