...
public class MembershipMemberTest {

    private MembershipMember testObj1;
    private MembershipMember testObj2;
    private MembershipMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<MembershipMember> coll = new java.util.HashSet<MembershipMember>();
        coll.add(testObj1);
    ...
    private MembershipMember makeTestObject1() {
        
        // Create an object to test... 
        MembershipMember obj = new MembershipMember();
    ...
    private MembershipMember makeTestObject2() {
