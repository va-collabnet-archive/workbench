...
public class StrMemberTest {

    private StrMember testObj1;
    private StrMember testObj2;
    private StrMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<StrMember> coll = new java.util.HashSet<StrMember>();
        coll.add(testObj1);
    ...
    private StrMember makeTestObject1() {
        
        // Create an object to test... 
        StrMember obj = new StrMember();
    ...
    private StrMember makeTestObject2() {
