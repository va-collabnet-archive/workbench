...
public class InstructWithDoneAndTodoBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(InstructWithDoneAndTodo.class);
        bd.setDisplayName("<html><font color='green'><center>Instruct and Wait<br>Done and TODO");
        return bd;
    }
}
