...
public class CleanupSvnEntryBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(CleanupSvnEntry.class);
        bd.setDisplayName("<html><font color='green'><center>Cleanup Svn Entry");
        return bd;
    }
}
