...
public class ClearEditPathForProfileBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(ClearEditPathForProfile.class);
        bd.setDisplayName("<html><font color='green'><center>clear edit path<br>for profile");
        return bd;
    }
}
