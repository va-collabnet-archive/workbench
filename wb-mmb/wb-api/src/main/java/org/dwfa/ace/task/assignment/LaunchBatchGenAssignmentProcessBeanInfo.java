...
public class LaunchBatchGenAssignmentProcessBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor processFileStr = new PropertyDescriptor("processFileStr",
                getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] = { batchGenAssigneePropName, uuidListListPropName, processFileStr,
