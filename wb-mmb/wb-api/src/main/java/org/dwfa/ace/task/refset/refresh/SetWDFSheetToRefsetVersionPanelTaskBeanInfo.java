...
/**
 * The SetWDFSheetToRefsetVersionPanelTaskBeanInfo class describes the visible
 * elements of the
 * Workflow task SetWDFSheetToRefsetVersionPanelTask so that it can be displayed
 * in the
 * Process Builder.
 * 
 * @author Perry Reid
...
public class SetWDFSheetToRefsetVersionPanelTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = { profilePropName, refsetVersionPropName, refsetUuidPropName };
