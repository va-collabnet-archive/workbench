...
/**
 * Task for adding a "relationship refinability is descendent of"
...
public class RelationshipRefinabilityIsDescendentOf extends AddStructuralQueryToRefsetSpec {
    /**
	 * 
	 */
    ...
    protected int getStructuralQueryTokenId() throws IOException, TerminologyException {
        return RefsetAuxiliary.Concept.REL_REFINABILITY_IS_DESCENDENT_OF.localize().getNid();
    }
