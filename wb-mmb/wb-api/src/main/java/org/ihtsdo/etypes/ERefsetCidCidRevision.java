...
public class ERefsetCidCidRevision extends ERevision {
    ...
    public ERefsetCidCidRevision(DataInput in) throws IOException, ClassNotFoundException {
        super();
        readExternal(in);
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null)
            return false;
        if (ERefsetCidCidRevision.class.isAssignableFrom(obj.getClass())) {
            ERefsetCidCidRevision another = (ERefsetCidCidRevision) obj;
