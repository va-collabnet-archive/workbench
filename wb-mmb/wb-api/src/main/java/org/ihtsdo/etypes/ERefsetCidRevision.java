...
public class ERefsetCidRevision extends ERevision {

    public static final long serialVersionUID = 1;

    protected UUID c1Uuid;

    public ERefsetCidRevision(DataInput in) throws IOException, ClassNotFoundException {
        super();
        readExternal(in);
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null)
            return false;
        if (ERefsetCidRevision.class.isAssignableFrom(obj.getClass())) {
            ERefsetCidRevision another = (ERefsetCidRevision) obj;
