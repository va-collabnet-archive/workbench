...
public class ERefsetCidLongRevision extends ERevision {
    ...
    public ERefsetCidLongRevision(DataInput in) throws IOException, ClassNotFoundException {
        super();
        readExternal(in);
    }
    ...
    /**
     * Returns a hash code for this <code>ERefsetCidLongVersion</code>.
     * 
     * @return a hash code value for this <tt>ERefsetCidLongVersion</tt>.
     */
    public int hashCode() {
    ...
    public boolean equals(Object obj) {
        if (obj == null)
            return false;
        if (ERefsetCidLongRevision.class.isAssignableFrom(obj.getClass())) {
            ERefsetCidLongRevision another = (ERefsetCidLongRevision) obj;
