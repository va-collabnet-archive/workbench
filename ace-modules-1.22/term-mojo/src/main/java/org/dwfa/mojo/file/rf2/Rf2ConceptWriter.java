...
public class Rf2ConceptWriter extends GenericFileWriter<Rf2ConceptRow> {

    public Rf2ConceptWriter(File conceptFile) throws IOException {
        newLineChars = "\r\n";

        open(conceptFile, false);
        writeHeader(new Rf2ConceptRow().getHeader());
    }
     ...
     */
    @Override
    protected String serialize(Rf2ConceptRow conceptRow) throws IOException, TerminologyException {
