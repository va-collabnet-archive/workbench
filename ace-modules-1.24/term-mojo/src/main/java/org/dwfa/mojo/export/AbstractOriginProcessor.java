...
public abstract class AbstractOriginProcessor implements OriginProcessor {
    ...
    protected final List<PositionDescriptor> releasePositions;
    /**Origins to be Exported.*/
    protected final PositionDescriptor[] originsForExport;

    public AbstractOriginProcessor(I_GetConceptData currentConcept, List<PositionDescriptor> releasePositions, PositionDescriptor[] originsForExport) {
        this.currentConcept = currentConcept;
        this.releasePositions = releasePositions;
