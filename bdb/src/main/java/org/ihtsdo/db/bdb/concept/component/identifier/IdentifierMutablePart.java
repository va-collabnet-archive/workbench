...
public abstract class IdentifierMutablePart 
	extends MutablePart<IdentifierMutablePart> 
		implements I_IdPart {

	private int sourceSystemNid;
	private Object sourceId;
	
	protected IdentifierMutablePart(int statusNid, int pathNid, long time) {
		super(statusNid, pathNid, time);
	}

	protected IdentifierMutablePart(int statusAtPositionNid) {
	...
	@Override
	public IdentifierMutablePart makeAnalog(int statusNid, int pathNid, long time) {
