...
public class ConceptMutablePart extends RefsetMemberMutablePart
	implements I_ThinExtByRefPartConcept {
	
	private int c1Nid;

	protected ConceptMutablePart(int statusNid, int pathNid, long time) {
		super(statusNid, pathNid, time);
	}

	protected ConceptMutablePart(int statusAtPositionNid) {
		super(statusAtPositionNid);
	}

	public ConceptMutablePart(TupleInput input) {
		super(input);
		c1Nid = input.readInt();
	}
