...
public class CidStrMemberTest {

    private CidStrMember testObj1;
    private CidStrMember testObj2;
    private CidStrMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidStrMember> coll = new java.util.HashSet<CidStrMember>();
        coll.add(testObj1);
    ...
    private CidStrMember makeTestObject1() {
        ...
        obj.additionalVersions = new ArrayList<CidStrRevision>(1);
        ...
        rev.setC1id(1);
        rev.setC1Nid(1);
        rev.setStrValue("Test Object 1 - Rev 1");
        obj.additionalVersions.add(rev); 
        
        return obj; 
    }

    private CidStrMember makeTestObject2() {
        ...
        obj.additionalVersions = new ArrayList<CidStrRevision>(2);
        ...
        rev.setC1id(2);
        rev.setC1Nid(2);
        rev.setStrValue("Test Object 2 - Rev 1");
        obj.additionalVersions.add(rev); 
