...
public class CidStrRevisionTest {

    private CidStrRevision testObj1;
    private CidStrRevision testObj2;
    private CidStrRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidStrRevision> coll = new java.util.HashSet<CidStrRevision>();
        coll.add(testObj1);
    ...
    private CidStrRevision makeTestObject1() {
        ...
        CidStrMember member = new CidStrMember();
        ...
        member.setC1Nid(1);
        member.setStrValue("Test Object 1 - Rev 1");
    ...
    private CidStrRevision makeTestObject2() {
        ...
        member.setC1Nid(2);
        member.setStrValue("Test Object 2 - Rev 1");
