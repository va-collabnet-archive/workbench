...
public class CopyFromPathToPath extends AbstractMojo {
    ...
    /**
     * Indicates whether to use the SNOMED "IS A" relationship when searching for relationships. Set this to false
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            throw new MojoExecutionException(
                "Failed copying from paths " + fromPaths + " to path " + toPath, e);
        }
    }
    ...
    private LineageHelper getLineageHelper() {
        if (includeSnomedIsA) {
            ...
            return new LineageHelper() {
                @Override protected I_IntSet getIsARelTypes() throws Exception {
