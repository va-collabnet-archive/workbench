...
public class IntegerRefsetHandler extends MemberRefsetHandler {
    ...
    public String formatRefsetLine(I_TermFactory tf, I_ExtendByRefVersion tuple, boolean sctid)
        ...
        I_ExtendByRefPartInteger integerPart = (I_ExtendByRefPartInteger) tuple.getMutablePart();

        return super.formatRefsetLine(tf, tuple, sctid) + MemberRefsetHandler.FILE_DELIMITER + integerPart.getValue();
    }
    ...
    public String formatRefsetLine(I_TermFactory tf, I_ExtendByRefPart part, Integer memberId, int refsetId,
        ...
        I_ExtendByRefPartInteger intPart = (I_ExtendByRefPartInteger) part;

        return super.formatRefsetLine(tf, part, memberId, refsetId, componentId, sctId)
            + MemberRefsetHandler.FILE_DELIMITER + intPart.getValue();
    }
    ...
    protected I_ExtendByRefPart processLine(String line) {
        ...
        try {
            ...
            I_ExtendByRef versioned = getExtensionVersioned(line, RefsetAuxiliary.Concept.INT_EXTENSION);
