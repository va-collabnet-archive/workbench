...
public class DirectoryFileFilterMojo extends AbstractMojo {
     ...
     * be overwritten unless append is set explicitly to true
     * 
     * @parameter
     * @required
     */
    ...
    /**
     * Indicates that if an output file is present whether it should be overwritten or appended to
