...
public class AceIdentifierWriter extends GenericFileWriter<AceIdentifierRow> {
    ...
    public AceIdentifierWriter(File conceptFile, boolean append) throws IOException {
        newLineChars = "\r\n";

        open(conceptFile, append);
    }
     ...
     */
    @Override
    protected String serialize(AceIdentifierRow idRow) throws IOException, TerminologyException {
        return idRow.toString();
    }
}
