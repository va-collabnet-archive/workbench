    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            if (conflictResolutionStrategy != null) {
                Class<I_ManageConflict> clazz = (Class<I_ManageConflict>) Class.forName(conflictResolutionStrategy);
                activeConfig.setConflictResolutionStrategy(clazz);
            }
        } catch (IOException e) {
            throw new MojoExecutionException(e.getLocalizedMessage(), e);
            ...
            throw new MojoExecutionException("Cannot create class", e);
        }
