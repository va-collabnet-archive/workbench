...
public class ConceptConstants {
    ...
    public static final ConceptSpec DUPLICATE_STATUS =
            new ConceptSpec(
                "Duplicate component (foundation metadata concept)",
                "4ee071f5-d04b-4293-9349-7d5b6cfa245c");
    public static final ConceptSpec AMBIGUOUS_STATUS =
            new ConceptSpec(
                "Ambiguous component (foundation metadata concept)",
                "78de85bc-946d-410f-85c5-ed3a10153adf");
    public static final ConceptSpec ERRONEOUS_STATUS =
            new ConceptSpec(
                "Erroneous component (foundation metadata concept)",
                "b2b54b58-90b8-4bf8-a83d-84fbced3027c");
    public static final ConceptSpec OUTDATED_STATUS =
            new ConceptSpec("Outdated component (foundation metadata concept)",
                "afd4210f-ddbf-4e9e-8d9c-9a50dd38e49d");
    public static final ConceptSpec INAPPROPRIATE_STATUS =
            new ConceptSpec(
                "Inappropriate component (foundation metadata concept)",
                "eddca00d-583c-455f-af08-5fea1adc08dc");
    public static final ConceptSpec MOVED_ELSEWHERE_STATUS =
            new ConceptSpec(
                "Component moved elsewhere (foundation metadata concept)",
                "0f726025-6b09-41de-a59c-e8309afaf987");
}
