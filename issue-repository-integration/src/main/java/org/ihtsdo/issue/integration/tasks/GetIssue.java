...
public class GetIssue extends AbstractTask {
...
//			.readAttachement(WorkerAttachmentKeys.ACE_FRAME_CONFIG.name());
			try{
				...
				if (IssuePropName == null) {
					throw new TaskFailedException("Issue repository concept is required");
				}

				if (externalId == null) {
					throw new TaskFailedException("External Id is required");
				}
				...
				Issue issue=jwto.getIssue(repository, externalId);
				

				process.writeAttachment(IssuePropName, issue);
