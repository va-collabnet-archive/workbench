...
/**
 * The Class ExecuteInboxWorkerLogic.
 */
@BeanList(specs = 
	  { @Spec(directory = "tasks/ide/issues", type = BeanType.TASK_BEAN)})
public class ExecuteInboxWorkerLogic extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
    	...
    	IssueSearchCriteria criteria = new IssueSearchCriteria(null, "Ready to download", null,null,null,null, null);
    	IssueAssignmentsUtil.createAssignmentsFromIssues(repository, criteria, worker, "Downloaded");
