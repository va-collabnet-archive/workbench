...
/**
 * The Class ReAddressIssueToOriginator.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/ide/issues", type = BeanType.TASK_BEAN)})
public class ReAddressIssueToOriginator extends AbstractTask {
	...
	/**
	 * Instantiates a new re address issue to originator.
	 * 
	 * @throws MalformedURLException the malformed url exception
	 */
	public ReAddressIssueToOriginator() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		...
		issue.setExternalUser(process.getOriginator());
