...
/**
 * The Class LaunchReportPanel.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class LaunchReportPanel extends AbstractTask {
	 ...
	 */
	public LaunchReportPanel() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			/*WorksetReport thp=PanelHelperFactory.getTranslationHelperPanel();
	        ...
	        signpostPanel.add(report, BorderLayout.CENTER);
