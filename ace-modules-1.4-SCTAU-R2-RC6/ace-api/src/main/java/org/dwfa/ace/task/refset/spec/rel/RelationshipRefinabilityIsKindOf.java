...
/**
 * Task for adding a "relationship refinability is kind of"
...
public class RelationshipRefinabilityIsKindOf extends AddStructuralQueryToRefsetSpec {
    /**
	 * 
	 */
    ...
    protected int getStructuralQueryTokenId() throws IOException, TerminologyException {
        return RefsetAuxiliary.Concept.REL_REFINABILITY_IS_KIND_OF.localize().getNid();
    }
