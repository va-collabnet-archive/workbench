...
import org.ihtsdo.project.issue.manager.IssuesListPanel;
import org.ihtsdo.tk.api.PathBI;
import org.ihtsdo.tk.api.PositionBI;

/**
 * The Class testIssuesListPanel.
 */
public class testIssuesListPanel extends javax.swing.JFrame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    new testIssuesListPanel().setVisible(true);
                } catch (Exception e) {
    ...
    /**
     * Instantiates a new test issues list panel.
     *
     * @throws Exception the exception
     */
    public testIssuesListPanel() throws Exception {
...
//	/*		List<I_Path> lpath=Terms.get().getPaths();
...
//		System.exit(0);
    ...
    private void iniComponents() throws Exception {
        ...
        pm = new IssuesListPanel(termFactory);
