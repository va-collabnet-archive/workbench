...
import org.ihtsdo.project.panel.WorkflowDefinitionPanel;
...
public class OpenWorkflowDefinitionPanel extends AbstractTask {
     ...
     */
    public OpenWorkflowDefinitionPanel() throws MalformedURLException {
        super();
    }
...
//				Worker nWorker=new MasterWorker(worker.getJiniConfig());
                WorkflowDefinitionPanel uiPanel = new WorkflowDefinitionPanel();

                tp.addTab(TranslationHelperPanel.WORKFLOWDEFINITION_TAB_NAME, uiPanel);
