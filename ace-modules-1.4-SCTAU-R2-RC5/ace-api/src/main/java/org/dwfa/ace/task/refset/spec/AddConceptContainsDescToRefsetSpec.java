...
public class AddConceptContainsDescToRefsetSpec extends AbstractAddRefsetSpecTask {
    /**
	 * 
	 */
    ...
    protected I_ThinExtByRefPartConceptConcept createAndPopulatePart(I_TermFactory tf, I_Path p,
        ...
        I_ThinExtByRefPartConceptConcept specPart = tf.newExtensionPart(I_ThinExtByRefPartConceptConcept.class);
        if (getClauseIsTrue()) {
        ...
        specPart.setC2id(RefsetAuxiliary.Concept.CONCEPT_CONTAINS_DESC_GROUPING.localize().getNid());
