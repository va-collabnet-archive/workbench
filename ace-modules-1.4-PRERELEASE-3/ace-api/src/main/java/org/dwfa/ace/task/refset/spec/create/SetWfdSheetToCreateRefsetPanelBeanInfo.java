...
/**
 * The SetWfdSheetToCreateRefsetPanelBeanInfo class describes the visible elements of the 
 * Workflow task SetWfdSheetToCreateRefsetPanel so that it can be displayed in the 
 * Process Builder. 
 * 
 * @author  Perry Reid
 * @version 1.0, December 2009 
 */
public class SetWfdSheetToCreateRefsetPanelBeanInfo extends SimpleBeanInfo {

    public SetWfdSheetToCreateRefsetPanelBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetWfdSheetToCreateRefsetPanel.class);
        bd.setDisplayName("<html><font color='green'><center>Set WFD Sheet to<br>Create Refset Panel");
        return bd;
    }
