...
public class CreateMemberRefset extends AbstractMojo {
    ...
    /**
     * @parameter
     *            The UUID for an alternate "Is a" relationship (defaults to
     *            null)
     */
    ...
    /**
     * @parameter
     *            Whether to include the parent or just the normal members
     */
    private boolean markParents = Boolean.TRUE;
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
            ...
            calc.setMarkParents(markParents);
