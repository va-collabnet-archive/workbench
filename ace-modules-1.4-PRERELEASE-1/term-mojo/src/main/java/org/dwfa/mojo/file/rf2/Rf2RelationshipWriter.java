...
public class Rf2RelationshipWriter extends GenericFileWriter<Rf2RelationshipRow> {

    public Rf2RelationshipWriter(File file) throws IOException {
        newLineChars = "\r\n";

        open(file, false);
        writeHeader(new Rf2RelationshipRow().getHeader());
    }
     ...
     */
    @Override
    protected String serialize(Rf2RelationshipRow replationshipRow) throws IOException,
