...
import org.dwfa.ace.search.DescSearchResultsTablePopupListener;
...
public class WorkflowHistorySearchPanel extends JPanel implements I_MakeCriterionPanel {
    ...
    private List<AbstractWorkflowHistorySearchTest> extraCriterion;
...
//        for (AbstractWorkflowHistorySearchTest criterion : qb.getExtraCriterion()) {
...
//        }
   ...
   @Override
    ...
    private boolean updateExtraCriterion() {
        extraCriterion = new ArrayList<AbstractWorkflowHistorySearchTest>();
        
		for (WorkflowHistoryCriterionPanel criterionPanel : criterionPanels) 
        {
    		AbstractWorkflowHistorySearchTest test = (AbstractWorkflowHistorySearchTest) criterionPanel.getBean();
    ...
    public void performWorkflowHistorySearch(String query, List<AbstractWorkflowHistorySearchTest> extraCriterion) throws Exception {
