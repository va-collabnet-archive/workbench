 ...
 * @author marc
 */
    class JComboBoxExistingParentsRender extends JLabel implements ListCellRenderer {

        public JComboBoxExistingParentsRender() {
            setOpaque(true);
        ...
        public Component getListCellRendererComponent(JList jlist, Object o, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (jlist.getModel().getSize() == 0) {
                // EMPTY CONCEPT LIST
                setText("(add concept with parent to list)");
                return this;
            }
