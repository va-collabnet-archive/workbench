 ...
 * @author marc
 */
public class BatchActionTaskDescriptionInitialCapsUI extends javax.swing.JPanel implements I_BatchActionTask {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Case insensitive (false)", "Case sensitive (true)" }));
