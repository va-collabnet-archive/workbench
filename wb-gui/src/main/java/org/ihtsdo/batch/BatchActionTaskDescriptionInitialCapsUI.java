 ...
 * @author marc
 */
public class BatchActionTaskDescriptionInitialCapsUI
     ...
     */
    public BatchActionTaskDescriptionInitialCapsUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxChangeToCase = new javax.swing.JComboBox();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxChangeToCase, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jCheckBoxSearchIsCaseSensitiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxSearchIsCaseSensitiveActionPerformed
        ...
        ((BatchActionTaskDescriptionInitialCaps) task).setIsSearchCaseSensitive(checkboxState);
    ...
    private javax.swing.JComboBox jComboBoxChangeToCase;
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) {
        ...
        // SET ACTION VALUES
        int idx = jComboBoxChangeToCase.getSelectedIndex();
        if (idx == 0) {
            ((BatchActionTaskDescriptionInitialCaps) task).setTargetCaseSensitivity(false);
        } else {
            ((BatchActionTaskDescriptionInitialCaps) task).setTargetCaseSensitivity(true);
        }
        ...
        ((BatchActionTaskDescriptionInitialCaps) task).setSearchText(valStr);
        ...
        if (jComboBoxExistingRefsets.getSelectedIndex() > 0) {
            ...
            if (refsetBI != null) {
                ...
                ((BatchActionTaskDescriptionInitialCaps) task).setCollectionNid(refsetNid);
            } else {
                BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.DESCRIPTION_INITIAL_CHAR_CASE_SENSITIVITY,
                        BatchActionEventType.TASK_INVALID, "no selected refset"));
                return null;
            }
        } else {
            ((BatchActionTaskDescriptionInitialCaps) task).setCollectionNid(Integer.MAX_VALUE);
        }

        // CHECK MATCH FILTER
        ((BatchActionTaskDescriptionInitialCaps) task).useFilter = jCheckBoxMatch.isSelected();
        if (jCheckBoxMatch.isSelected() == false) {
            ((BatchActionTaskDescriptionInitialCaps) task).setMatchValue(null);
            return task;
        }

        // SET MATCH VALUE
        ((BatchActionTaskDescriptionInitialCaps) task).setRefsetType(TK_REFEX_TYPE.CID);
        Integer valConcept = ((ValueDndNidUI) jPanelValueMatch).getValue();
        if (valConcept != null) {
            ((BatchActionTaskDescriptionInitialCaps) task).setMatchValue(valConcept);
            return task;
        }
