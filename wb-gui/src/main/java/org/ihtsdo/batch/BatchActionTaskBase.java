...
public class BatchActionTaskBase extends javax.swing.JPanel {
    ...
    private static final int DESCRIPTION_INITIAL_CAPS_CHANGE = 0;
    ...
    private void actionSelectTaskType(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actionSelectTaskType
        ...
        switch (batchActionLevel) {
            ...
            case DESCRIPTION_LEVEL:
                switch (idx) {
                    case DESCRIPTION_INITIAL_CAPS_CHANGE:
                        if (actionTaskType.compareTo(BatchActionTaskType.DESCRIPTION_INITIAL_CAPS_CHANGE) != 0) {
                            actionTaskType = BatchActionTaskType.DESCRIPTION_INITIAL_CAPS_CHANGE;
    ...
    private DefaultComboBoxModel newBatchActionTypeComboBoxModel() {
        ...
        switch (batchActionLevel) {
            ...
            case DESCRIPTION_LEVEL:
                sa = new String[]{
                    "Initial Caps, Change True/False",
                    "Retire Description",
                    "Text, Find & Replace",
