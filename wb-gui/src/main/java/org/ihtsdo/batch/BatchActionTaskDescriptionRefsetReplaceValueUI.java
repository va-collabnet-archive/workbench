 ...
 * @author marc
 */
public class BatchActionTaskDescriptionRefsetReplaceValueUI extends javax.swing.JPanel implements I_BatchActionTask {
     ...
     */
    public BatchActionTaskDescriptionRefsetReplaceValueUI() {
        initComponents();
        ...
        ValueDndNidUI tmp = new ValueDndNidUI("Set Member Value To:");
        layout.replace(jPanelSetValue, tmp.getPanel());
        jPanelSetValue = tmp.getPanel();

        // Setup Filter Value Panel
        layout = (GroupLayout) jPanelCriteria.getLayout();
        tmp = new ValueDndNidUI("Member Match Value:");
        ...
        jPanelSetValue.setEnabled(true);
        jPanelSetValue.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jPanelSetValue = new javax.swing.JPanel();
        ...
        javax.swing.GroupLayout jPanelSetValueLayout = new javax.swing.GroupLayout(jPanelSetValue);
        jPanelSetValue.setLayout(jPanelSetValueLayout);
        jPanelSetValueLayout.setHorizontalGroup(
            jPanelSetValueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        jPanelSetValueLayout.setVerticalGroup(
            jPanelSetValueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 31, Short.MAX_VALUE)
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanelSetValue, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jComboBoxSearchByConstraintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSearchByConstraintActionPerformed
        ...
        if (idx >= 0) {
            ...
            idx = ((BatchActionTaskDescriptionRefsetReplaceValue) task).getSearchByTextConstraint();
    ...
    private void jComboBoxSearchByTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSearchByTypeActionPerformed
        ...
        if (idx >= 0) {
            ...
            idx = ((BatchActionTaskDescriptionRefsetReplaceValue) task).getSearchByType();
    ...
    private void jComboBoxSearchByLanguageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSearchByLanguageActionPerformed
        ...
        if (idx >= 0) {
            ...
            idx = ((BatchActionTaskDescriptionRefsetReplaceValue) task).getSearchByLanguage();
    ...
    private javax.swing.JPanel jPanelSetValue;
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) {
        ...
        if (jComboBoxExistingRefsets.getSelectedIndex() > 0) {
            ...
            ((BatchActionTaskDescriptionRefsetReplaceValue) task).setCollectionNid(Integer.MAX_VALUE);
        }

        // CHECK MATCH FILTER
        ((BatchActionTaskDescriptionRefsetReplaceValue) task).useFilter = jCheckBoxMatch.isSelected();
