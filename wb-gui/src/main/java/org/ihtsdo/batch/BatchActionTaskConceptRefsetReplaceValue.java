...
/**
 * BatchActionTaskConceptRefsetReplaceValue
 * 
 */
public class BatchActionTaskConceptRefsetReplaceValue extends BatchActionTask {
    ...
    public BatchActionTaskConceptRefsetReplaceValue() {
            ...
            if (rvbi.getRefexNid() == collectionNid) {
                if (matchValue == null) {
                    ...
                    BatchActionEventReporter.add(new BatchActionEvent(c,
                            BatchActionTaskType.CONCEPT_REFSET_REPLACE_VALUE,
