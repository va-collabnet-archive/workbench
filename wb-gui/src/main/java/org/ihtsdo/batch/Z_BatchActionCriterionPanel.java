...
public class Z_BatchActionCriterionPanel extends JPanel {

    private static final long serialVersionUID = 1L;

    JPanel editorPanel = new JPanel();
    protected JComboBox criterionCombo; // Criterion Selection Combo Box
    List<String> comboItems = new ArrayList<String>(); // Criterion Selction Combo Box Strings[]
    ...
    public Z_BatchActionCriterionPanel(Z_I_MakeBatchActionCriterionPanel searchPanel, I_TestSearchResults beanToSet)
    ...
    public Z_BatchActionCriterionPanel(Z_I_MakeBatchActionCriterionPanel searchPanel, I_TestSearchResults beanToSet,
        ...
        addButton.addActionListener(new EditAddBatchActionCriterion(searchPanel));
        add(addButton, gbc);
        ...
        removeButton.addActionListener(new EditDelBatchActionCriterion(searchPanel, this));
    ...
    public class CriterionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                Z_BatchActionCriterionPanel.this.invalidate();
                Z_BatchActionCriterionPanel.this.validate();
                Z_BatchActionCriterionPanel.this.doLayout();
            } catch (Exception ex) {
                AceLog.getAppLog().alertAndLogException(ex);
            }
        }
