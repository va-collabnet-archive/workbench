 ...
 * 
 */
public class BatchActionTaskLogicDisjoinAdd extends BatchActionTask {
     ...
     */
    public BatchActionTaskLogicDisjoinAdd() {
    }
    ...
    public boolean execute(ConceptVersionBI c, EditCoordinate ec, ViewCoordinate vc) throws Exception {
        ...
        for (RefexVersionBI rvbi : currentRefexes) {
            if (rvbi.getCollectionNid() == collectionNid) {
                BatchActionEventReporter.add(new BatchActionEvent(c, BatchActionTaskType.LOGIC_DISJOIN_CONCEPTS,
