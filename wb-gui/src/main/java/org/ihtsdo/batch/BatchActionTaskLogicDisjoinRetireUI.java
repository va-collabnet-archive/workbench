...
public class BatchActionTaskLogicDisjoinRetireUI extends javax.swing.JPanel implements I_BatchActionTask {
    ...
    public BatchActionTaskLogicDisjoinRetireUI() {
        ...
        // TASK
        this.task = new BatchActionTaskLogicDisjoinRetire();
    }
            ...
            try {
                ...
                for (I_ExtendByRef member : rsMembers) {
                    ...
                    for (RefexVersionBI mrvbi : mRefexes) {
                        for (int editPath : ec.getEditPaths()) {
                            mrvbi.makeAnalog(SnomedMetadataRfx.getSTATUS_RETIRED_NID(),
                                    ec.getAuthorNid(), editPath, Long.MAX_VALUE);
                        }
                    }
                    ...
                    BatchActionEventReporter.add(new BatchActionEvent(cvbi,
                            BatchActionTaskType.LOGIC_RETIRE_DISJOIN_CONCEPTS,
                ...
                for (int editPath : ec.getEditPaths()) {
                    if (c.getConAttrsActive() != null) {
                        c.getConAttrsActive().makeAnalog(SnomedMetadataRfx.getSTATUS_RETIRED_NID(),
                                ec.getAuthorNid(), editPath, Long.MAX_VALUE);
                    }
                }
                ...
                Logger.getLogger(BatchActionTaskLogicDisjoinRetireUI.class.getName()).log(Level.SEVERE, null, ex);
