...
public class BatchActionTaskConceptParentRetireUI extends javax.swing.JPanel implements I_BatchActionTask {
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) throws IOException {
        ...
        if (fromParentBI != null) {
            ...
            ((BatchActionTaskConceptParentRetire) task).setSelectedRoleTypeNid(nidLinkage);
            ((BatchActionTaskConceptParentRetire) task).setSelectedDestNid(nidParent);
            return task;
        } else {
            BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.CONCEPT_PARENT_RETIRE,
