    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) {
        ...
        if (jComboBoxExistingRefsets.getSelectedIndex() > 0) {
            ...
            if (refsetBI != null) {
                ...
                BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.DESCRIPTION_REFSET_RETIRE_MEMBER,
        ...
        // CHECK MATCH FILTER
        ((BatchActionTaskDescriptionRefsetRetireMember) task).useFilter = jCheckBoxMatch.isSelected();
