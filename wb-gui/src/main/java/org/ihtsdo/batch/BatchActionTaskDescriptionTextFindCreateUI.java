 ...
 * @author marc
 */
public class BatchActionTaskDescriptionTextFindCreateUI extends javax.swing.JPanel implements I_BatchActionTask {
     ...
     */
    public BatchActionTaskDescriptionTextFindCreateUI() {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextFieldSearchText, javax.swing.GroupLayout.DEFAULT_SIZE, 442, Short.MAX_VALUE)
                            .addComponent(jTextFieldCreateNew))))
                .addContainerGap())
        );
    ...
    private void jCheckBoxSearchIsCaseSensitiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxSearchIsCaseSensitiveActionPerformed
        ...
        ((BatchActionTaskDescriptionTextFindCreate) task).setIsSearchCaseSensitive(checkboxState);
    ...
    private javax.swing.JTextField jTextFieldCreateNew;
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) {
        ...
        ((BatchActionTaskDescriptionTextFindCreate) task).setSearchText(searchTextStr);

        // Description Replace Text
        String replaceTextStr = jTextFieldCreateNew.getText();
        if (replaceTextStr.equalsIgnoreCase("")) {
            replaceTextStr = null;
        }
        ((BatchActionTaskDescriptionTextFindCreate) task).setReplacementText(replaceTextStr);
        ...
        if (jComboBoxExistingRefsets.getSelectedIndex() > 0) {
            ...
            if (refsetBI != null) {
                ...
                ((BatchActionTaskDescriptionTextFindCreate) task).setCollectionNid(refsetNid);
            } else {
                BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.DESCRIPTION_TEXT_FIND_CREATE,
                        BatchActionEventType.TASK_INVALID, "no selected refset"));
                return null;
            }
        } else {
            ((BatchActionTaskDescriptionTextFindCreate) task).setCollectionNid(Integer.MAX_VALUE);
        }

        // CHECK MATCH FILTER
        ((BatchActionTaskDescriptionTextFindCreate) task).useFilter = jCheckBoxMatch.isSelected();
        if (jCheckBoxMatch.isSelected() == false) {
            ((BatchActionTaskDescriptionTextFindCreate) task).setMatchValue(null);
            return task;
        }

        // SET MATCH VALUE
        ((BatchActionTaskDescriptionTextFindCreate) task).setRefsetType(TK_REFEX_TYPE.CID);
        Integer valConcept = ((ValueDndNidUI) jPanelValueMatch).getValue();
        if (valConcept != null) {
            ((BatchActionTaskDescriptionTextFindCreate) task).setMatchValue(valConcept);
            return task;
        }
