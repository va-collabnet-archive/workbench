 ...
 * @author marc
 */
public class BatchActionTaskRelationshipRoleRetireUI extends javax.swing.JPanel implements I_BatchActionTask {

    BatchActionTask task;

    /** Creates new form BatchActionTaskRelationshipRoleRetireUI */
    public BatchActionTaskRelationshipRoleRetireUI() {
        initComponents();
        task = new BatchActionTaskRelationshipRoleRetire();
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) throws Exception {
        ...
        if (termRoleType != null) {
            ((BatchActionTaskRelationshipRoleRetire) task).setRoleNid(termRoleType.getNid());
        } else {
            BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.RELATIONSHIP_ROLE_RETIRE,
        ...
        if (termRoleValue != null) {
            ((BatchActionTaskRelationshipRoleRetire) task).setValueNid(termRoleValue.getNid());
        } else {
            BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.RELATIONSHIP_ROLE_RETIRE,
