 ...
 * @author marc
 */
public class BatchActionTaskRelationshipRoleAddUI extends javax.swing.JPanel implements I_BatchActionTask {

    BatchActionTask task;

    /** Creates new form BatchActionTaskRelationshipRoleAddUI */
    public BatchActionTaskRelationshipRoleAddUI() {
        initComponents();
        this.task = new BatchActionTaskRelationshipRoleAdd();
    ...
    public BatchActionTask getTask(EditCoordinate ec, ViewCoordinate vc, List<ConceptChronicleBI> concepts) throws Exception {
        ...
        if (termRoleType != null) {
            ((BatchActionTaskRelationshipRoleAdd) task).setRoleNid(termRoleType.getNid());
        } else {
            BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.RELATIONSHIP_ROLE_ADD,
        ...
        if (termRoleValue != null) {
            ((BatchActionTaskRelationshipRoleAdd) task).setValueNid(termRoleValue.getNid());
        } else {
            BatchActionEventReporter.add(new BatchActionEvent(null, BatchActionTaskType.RELATIONSHIP_ROLE_ADD,
