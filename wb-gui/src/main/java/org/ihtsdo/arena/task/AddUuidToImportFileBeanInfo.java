...
public class AddUuidToImportFileBeanInfo extends SimpleBeanInfo {
     ...
     * 
     */
    public AddUuidToImportFileBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = {msFileProp };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(AddUuidToImportFile.class);
        bd.setDisplayName("<html><font color='green'><center>Add UUID To Import File");
        return bd;
    }
