    ...
    private void createBlueprintConcept() throws ContradictionException {
        ...
        try {
            ...
            if (uuidArray.length > 0) {
                ConceptVersionBI firstParent =
                        Ts.get().getConceptVersion(config.getViewCoordinate(), uuidArray[0]);
                Collection<? extends RelationshipVersionBI> outgoingIsa = firstParent.getRelsOutgoingActiveIsa();
                ...
                if (!outgoingIsa.isEmpty()) {
                    ...
                    Collection<? extends RelationshipVersionBI> incomingIsa =
                            firstParent.getRelsIncomingActiveIsa();
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                if ((fsn.extractText().length() != 0)
                    ...
                    ConceptVersionBI parentConcept = Ts.get().getConceptVersion(config.getViewCoordinate(),
                            nidList.get(0));
