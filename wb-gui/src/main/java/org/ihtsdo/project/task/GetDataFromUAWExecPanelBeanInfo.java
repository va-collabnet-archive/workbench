...
/**
 * The Class GetDataFromUAWExecPanelBeanInfo.
 */
public class GetDataFromUAWExecPanelBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new gets the data from uaw exec panel bean info.
     */
    public GetDataFromUAWExecPanelBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor rv[] = {profilePropName, memberPropName, projectPropName};
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(GetDataFromUAWExecPanel.class);
        bd.setDisplayName("<html><font color='green'><center>Get data<br>from UAW panel<br>for taxonomy");
        return bd;
    }
}
