 ...
 */
public class GetInforForUnassignedWorkDC extends JPanel {
     ...
     * @param refId
     */
    public GetInforForUnassignedWorkDC(I_ConfigAceFrame config, Integer refId, List<TranslationProject> projects) {
        this.config = config;
        initComponents();
        I_GetConceptData langConcept;
        try {
            langConcept = Terms.get().getConcept(refId);
            label6.setText(langConcept.toString());
    ...
    private void initComponents() {
        ...
        ((GridBagLayout) getLayout()).columnWidths = new int[]{15, 0, 0, 10, 0};
        ((GridBagLayout) getLayout()).rowHeights = new int[]{15, 0, 15, 0, 15, 0, 0, 0, 0};
        ...
        //---- label5 ----
        label5.setText("Assign default worklist to modified terms");
        add(label5, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0,
        ...
        add(label4, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0,
                ...
                new Insets(0, 0, 5, 5), 0, 0));
        add(label6, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));

        //---- label1 ----
        label1.setText("Assign to");
        add(label1, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));

        //---- label2 ----
        label2.setText("Project");
        add(label2, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
        ...
        add(projectCombo, new GridBagConstraints(2, 6, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));

        //---- label3 ----
        label3.setText("WorkList");
        add(label3, new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        ...
        add(nacWorkListCombo, new GridBagConstraints(2, 7, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 0, 5), 0, 0));
