...
/**
 * The Class LaunchIssuePanelToMP.
 */
@BeanList(specs = {
    @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class LaunchIssuePanelToMP extends AbstractTask {
    ...
    /**
     * Instantiates a new launch issue panel to mp.
     *
     * @throws MalformedURLException the malformed url exception
     */
    public LaunchIssuePanelToMP() throws MalformedURLException {
        super();
    }
