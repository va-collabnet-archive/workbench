...
/**
 * The Class LaunchIssuePanel.
 */
@BeanList(specs = {
    @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class LaunchIssuePanel extends AbstractTask {
    ...
    /**
     * Instantiates a new launch issue panel.
     *
     * @throws MalformedURLException the malformed url exception
     */
    public LaunchIssuePanel() throws MalformedURLException {
        super();
    }
