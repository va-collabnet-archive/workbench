 ...
 * 
 * @goal post-process-attribute-refset-open
 * @requiresDependencyResolution compile
 */

public class RF2AttributeValueOpenPostMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		try {
			...
			File attValueFileName = new File(exportFolder, 
					config.getExportFileName() + releaseDate + "." + config.getFileExtension());
			
			RF2ArtifactPostExportImpl pExp=new RF2ArtifactPostExportImpl(FILE_TYPE.RF2_ATTRIBUTE_VALUE , new File( rf2FullFolder),
					attValueFileName, new File(outputFolder), targetDirectory,
