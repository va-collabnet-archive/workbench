 ...
 * @author Alo
 * 
 * @goal post-process-review-status
 * @requiresDependencyResolution compile
 */

public class RF2ReviewStatusPostMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		try {
			...
			RF2ArtifactPostExportImpl pExp=new RF2ArtifactPostExportImpl(FILE_TYPE.RF2_REVIEW_STATUS, new File( rf2FullFolder),
