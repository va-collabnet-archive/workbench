...
import org.ihtsdo.rf2.derivatives.factory.RF2ReviewStatusFactory;
 ...
 * 
 * @goal export-review-status
 * @requiresDependencyResolution compile
 */

public class RF2ReviewStatusExporterMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			RF2ReviewStatusFactory factory = new RF2ReviewStatusFactory(config);
			factory.export();
