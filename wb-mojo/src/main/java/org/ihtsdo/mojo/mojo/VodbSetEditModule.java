...
/**
 * 
 * @goal vodb-set-edit-module
 * 
 * @phase process-resources
 * @requiresDependencyResolution compile
 */
public class VodbSetEditModule extends AbstractMojo {
	 ...
	 * @required
	 */
	private ConceptDescriptor editModule;
	...
	public ConceptDescriptor getEditModule() {
		return editModule;
	}

	public void setEditPaths(ConceptDescriptor editModule) {
