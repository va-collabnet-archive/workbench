 ...
 */
package org.ihtsdo.mojo.mojo.relformat.mojo.directimport;
...
import org.ihtsdo.mojo.mojo.relformat.mojo.db.DerbyFileRunner;
import org.ihtsdo.mojo.mojo.relformat.mojo.db.DerbyFileRunnerImpl;
...
public final class DerbyDirectImportMojo extends AbstractMojo {
    ...
    private List<File> getDerbyFiles() {
        return fileLister.list(locationOfDerbyFiles, Arrays.asList("^(.)*\\.derb$"), Arrays.<String> asList());
    }
