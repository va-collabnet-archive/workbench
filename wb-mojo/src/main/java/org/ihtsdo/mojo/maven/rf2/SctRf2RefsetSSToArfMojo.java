 ...
 *
 * @goal underdev-sct-rf2-refset-ss-to-arf
 * @requiresDependencyResolution compile
 * @requiresProject false
 */
public class SctRf2RefsetSSToArfMojo extends AbstractMojo implements Serializable {
     ...
     * 
     * @parameter default-value="der2_ssRefset_"
     */
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().info("::: BEGIN SctRf2RefsetSSToArfMojo");
        ...
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                    outDir + "concept_refsetss_rf2.refset"), "UTF-8"));
            getLog().info("::: CONCEPT REFSET FILE: " + outDir + "concept_refsetss_rf2.refset");
            ...
            for (Rf2File rf2File : filesIn) {
            	List<? extends Rf2_RefsetBaseRecord> members = 
            			RF2_RefsetRecordFactory.parseRefset(rf2File, exclusions, Rf2_RefsetSSRecord.class);
            ...
            Logger.getLogger(SctRf2RefsetSSToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetSSToArfMojo UnsupportedEncodingException", ex);
        } catch (TerminologyException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetSSToArfMojo Terminology error", ex);
        } catch (IOException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetSSToArfMojo file error", ex);
        } catch (ParseException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetSSToArfMojo file name parse error", ex);
        } catch (Exception ex) {
        	Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetSSToArfMojo general error", ex);			
		}
        getLog().info("::: END SctRf2RefsetSSToArfMojo");
    }       
}
