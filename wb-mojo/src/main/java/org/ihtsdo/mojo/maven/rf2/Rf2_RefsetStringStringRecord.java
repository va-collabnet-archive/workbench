...
public class Rf2_RefsetStringStringRecord implements Comparable<Rf2_RefsetStringStringRecord> {
    ...
    public Rf2_RefsetStringStringRecord(String id, String dateStr, boolean active, String moduleUuidStr,
            long refsetIdL, long referencedComponentIdL, String string1, String string2) throws ParseException {
        this.id = id;
    ...
    static Rf2_RefsetStringStringRecord[] parseRefset(Rf2File f, Long[] exclusions)
            throws IOException, ParseException {

        int count = Rf2File.countFileLines(f);
        int countExludedMembers = 0;
        int currentCount = 0;
        ArrayList<Rf2_RefsetStringStringRecord> a = new ArrayList<>();
        ...
        int STRING1 = 6; // first string extension
        int STRING2 = 7; // section string extension
        ...
        try {
			while (br.ready()) {
			    ...
			    a.add(new Rf2_RefsetStringStringRecord(line[ID],
        ...
        Logger.getLogger(Rf2_RefsetStringStringRecord.class.getName()).info(sb.toString());
        ...
        Rf2_RefsetStringStringRecord[] b = new Rf2_RefsetStringStringRecord[a.size()];
        int idx = 0;
        for (Rf2_RefsetStringStringRecord rec : a) {
            b[idx] = rec;
            idx++;
        }
    ...
    public void writeArf(BufferedWriter writer) throws IOException, TerminologyException {
        ...
        // String1 Extension Value
        writer.append(string1 + TAB_CHARACTER);
        
        // String2 Extension Value
        writer.append(string2 + TAB_CHARACTER);
    ...
    @Override
    public int compareTo(Rf2_RefsetStringStringRecord t) {
