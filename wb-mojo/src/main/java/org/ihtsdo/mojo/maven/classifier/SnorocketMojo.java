...
public class SnorocketMojo extends AbstractMojo {
    ...
    private void setupCoreNids() throws MojoFailureException {
        ...
        try {
            ...
            isNOT_REFINABLE =
                    tf.uuidToNative(ArchitectonicAuxiliary.Concept.NOT_REFINABLE.getUids());
            isMANDATORY_REFINABILITY =
                    tf.uuidToNative(ArchitectonicAuxiliary.Concept.MANDATORY_REFINABILITY.getUids());
