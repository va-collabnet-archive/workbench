 ...
 *
 * @goal underdev-sct-rf2-refset-ci-to-arf
 * @requiresDependencyResolution compile
 * @requiresProject false
 */
public class SctRf2RefsetCIToArfMojo extends AbstractMojo implements Serializable {
     ...
     * 
     * @parameter default-value="der2_ciRefset_"
     */
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().info("::: BEGIN SctRf2RefsetCIToArfMojo");
        ...
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                    outDir + "concept_refsetci_rf2.refset"), "UTF-8"));
            getLog().info("::: CONCEPT REFSET FILE: " + outDir + "concept_refsetci_rf2.refset");
            ...
            for (Rf2File rf2File : filesIn) {            	
            	List<? extends Rf2_RefsetBaseRecord> members = 
            			RF2_RefsetRecordFactory.parseRefset(rf2File, exclusions, Rf2_RefsetCIRecord.class);
            ...
            Logger.getLogger(SctRf2RefsetCIToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCIToArfMojo UnsupportedEncodingException", ex);
        } catch (TerminologyException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCIToArfMojo Terminology error", ex);
        } catch (IOException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCIToArfMojo file error", ex);
        } catch (ParseException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCIToArfMojo file name parse error", ex);
        } catch (Exception ex) {
        	Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCIToArfMojo general error", ex);			
		}
        getLog().info("::: END SctRf2RefsetCIToArfMojo");
    }
}
