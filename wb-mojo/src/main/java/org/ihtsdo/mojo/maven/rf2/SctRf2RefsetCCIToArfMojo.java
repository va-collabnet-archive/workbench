 ...
 *
 * @goal underdev-sct-rf2-refset-cci-to-arf
 * @requiresDependencyResolution compile
 * @requiresProject false
 */
public class SctRf2RefsetCCIToArfMojo extends AbstractMojo implements Serializable {
     ...
     * 
     * @parameter default-value="der2_cciRefset_"
     */
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        getLog().info("::: BEGIN SctRf2RefsetCCIToArfMojo");
        ...
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                    outDir + "concept_refsetcci_rf2.refset"), "UTF-8"));
            getLog().info("::: CONCEPT REFSET FILE: " + outDir + "concept_refsetcci_rf2.refset");
            ...
            for (Rf2File rf2File : filesIn) {
            	List<? extends Rf2_RefsetBaseRecord> members = 
            			RF2_RefsetRecordFactory.parseRefset(rf2File, exclusions, Rf2_RefsetCCIRecord.class);
            ...
            Logger.getLogger(SctRf2RefsetCCIToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCCIToArfMojo UnsupportedEncodingException", ex);
        } catch (TerminologyException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCCIToArfMojo Terminology error", ex);
        } catch (IOException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCCIToArfMojo file error", ex);
        } catch (ParseException ex) {
            Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCCIToArfMojo file name parse error", ex);
        } catch (Exception ex) {
        	Logger.getLogger(SctRf2ToArfMojo.class.getName()).log(Level.SEVERE, null, ex);
            throw new MojoFailureException("RF2/ARF SctRf2RefsetCCIToArfMojo general error", ex);			
		}
        getLog().info("::: END SctRf2RefsetCCIToArfMojo");
    }    
}
