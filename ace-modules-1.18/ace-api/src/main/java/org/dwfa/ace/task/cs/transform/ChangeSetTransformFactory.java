 ...
 * 
 * The strategy is to match by the file name suffix, each known transformer
 * class defines the
 * file suffix it can handle as an input and then by setting the output suffix
 * in the invoked transformer
...
public class ChangeSetTransformFactory {
    ...
    public static ChangeSetTransformer getTransformForFile(File file) throws InstantiationException,
