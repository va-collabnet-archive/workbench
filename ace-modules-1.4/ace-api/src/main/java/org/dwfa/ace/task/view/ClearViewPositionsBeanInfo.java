...
public class ClearViewPositionsBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(ClearViewPositions.class);
        bd.setDisplayName("<html><font color='green'><center>clear view positions");
        return bd;
    }
}
