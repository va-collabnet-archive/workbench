...
public class ThinExtByRefPartConceptConcept extends ThinExtByRefPart implements
		I_ThinExtByRefPartConceptConcept {
	private int c1id;
	private int c2id;
	...
	public boolean equals(Object obj) {
		if (super.equals(obj)) {
			if (ThinExtByRefPartConceptConcept.class.isAssignableFrom(obj
					.getClass())) {
