...
public class ConCoreBdb implements I_StoreInBdb {
	...
	public ConCoreBdb(Environment env, DatabaseConfig dbConfig)
		...
		while (partCursor.getNext(foundKey, foundData, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
			...
			I_ConceptAttributePart conAttrPart = (I_ConceptAttributePart) conPartBinding
	 ...
	 */
	public int getConPartId(I_ConceptAttributePart conAttrPart)
			throws DatabaseException {
	 ...
	 */
	public I_ConceptAttributePart getConPart(int partId)
			throws DatabaseException {
