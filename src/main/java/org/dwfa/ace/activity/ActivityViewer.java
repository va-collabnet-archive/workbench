...
public class ActivityViewer {
	...
	public static void reSort() {
		if (headless == false) {
			SwingUtilities.invokeLater(new Runnable() {
				...
				//TODO turn this into a future task... So sorting does not occur on event loop...
				public void run() {
					try {
	...
	private static void addSecondaryActivityPanel(final 
			Set<JPanel> secondaryPanels, final I_ShowActivity a) {
		SwingUtilities.invokeLater(new Runnable() {
