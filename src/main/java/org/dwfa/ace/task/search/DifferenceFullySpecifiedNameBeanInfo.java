...
public class DifferenceFullySpecifiedNameBeanInfo extends
        AbstractSearchTestBeanInfo {
    private static DifferencePreferredNameSearchInfo searchInfo =
            new DifferencePreferredNameSearchInfo();
