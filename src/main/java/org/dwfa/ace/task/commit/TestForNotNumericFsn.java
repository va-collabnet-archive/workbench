...
/**
 * The <code>TestForNotNumericFsn</code> class represents a data constraint test that is to be run on any
 * <code>concept</code> to verify that it has a 'fully specified name' that is not a purely numeric value.
 *
