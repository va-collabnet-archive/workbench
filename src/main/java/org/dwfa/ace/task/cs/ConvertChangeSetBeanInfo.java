...
public class ConvertChangeSetBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            changeSetTransformer
                .setShortDescription("The fully qualified name of the class to use to convert the change set. ");

            PropertyDescriptor rv[] =
                    { filename, outputSuffix, changeSetTransformer };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Convert Change Set");
        return bd;
    }
}
