...
public class ConvertAllChangeSetsBeanInfo extends SimpleBeanInfo {
	   public PropertyDescriptor[] getPropertyDescriptors() {
	        try {  
	            ...
	            PropertyDescriptor rv[] = { rootDirStr, recurseSubdirectories, outputSuffix, inputSuffix, changeSetTransformer };
	            return rv;
