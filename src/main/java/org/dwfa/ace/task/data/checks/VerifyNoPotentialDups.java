...
//            	Object obj = process.readProperty(activeConceptPropName);
...
//        	}
            ...
            for (I_GetConceptData potDupConcept: selectedConcept.getSourceRelTargets(config.getAllowedStatus(), 
            	...
            	List<I_ConceptAttributeTuple> statusTuples = potDupConcept.getConceptAttributeTuples(statusTypeSet, config.getViewPositionSet() );
