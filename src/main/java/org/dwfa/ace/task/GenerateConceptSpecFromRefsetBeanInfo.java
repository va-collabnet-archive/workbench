...
public class GenerateConceptSpecFromRefsetBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor packageName =
                    new PropertyDescriptor("packageNamePropertyKey",
            ...
            PropertyDescriptor className =
                    new PropertyDescriptor("classNamePropertyKey",
                        GenerateConceptSpecFromRefset.class);
            ...
            PropertyDescriptor outputDirectory =
                    new PropertyDescriptor("outputDirectoryPropertyKey",
                        GenerateConceptSpecFromRefset.class);
            ...
            PropertyDescriptor rv[] =
                    { packageName, className, outputDirectory };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(GenerateConceptSpecFromRefset.class);
        bd
