 ...
 */
public class SetWFDSheetToRefreshRefsetSpecParamsPanelTaskBeanInfo extends
        SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            editorInboxPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            editorInboxPropName
                .setDisplayName("<html><font color='green'>editor inbox prop name:");
            editorInboxPropName
                .setShortDescription("[IN] The next person the BP will go to.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    SetWFDSheetToRefreshRefsetSpecParamsPanelTask.class);
        bd
            .setDisplayName("<html><font color='green'><center>Set WFD Sheet to<br>Refresh Refset Spec<br>Params panel");
        return bd;
    }
