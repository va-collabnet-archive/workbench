    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            includeMetaDataConcepts =
                    new PropertyDescriptor("includeMetaDataConcepts", getBeanDescriptor().getBeanClass());
            ...
            includeMetaDataRelationships =
                    new PropertyDescriptor("includeMetaDataRelationships", getBeanDescriptor().getBeanClass());
            ...
            includeMetaDataDescriptions =
                    new PropertyDescriptor("includeMetaDataDescriptions", getBeanDescriptor().getBeanClass());
            ...
            includeMemberExtensions =
                    new PropertyDescriptor("includeMemberExtensions", getBeanDescriptor().getBeanClass());
            ...
            includeParentExtensions =
                    new PropertyDescriptor("includeParentExtensions", getBeanDescriptor().getBeanClass());
            ...
            includeCommentExtensions =
                    new PropertyDescriptor("includeCommentExtensions", getBeanDescriptor().getBeanClass());
            ...
            includePromotionExtensions =
                    new PropertyDescriptor("includePromotionExtensions", getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] =
                    { refsetSpecUuidPropName, statusTermEntry, includeMetaDataConcepts, includeMetaDataRelationships,
                     includeMetaDataDescriptions, includeSpecExtensions, includeMemberExtensions,
                     includeParentExtensions, includeCommentExtensions, includePromotionExtensions };
            return rv;
