...
public class RemoveListViewConceptsFromRefset extends AbstractTask {
	...
	public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
		try {
			...
			getLogger().info(
					"Remove concepts from list view from refset '" + refset.getInitialText() +
			...
			new MemberRefsetHelper().removeAllFromRefset(refset.getConceptId(), newMembers, value.getConceptId(), 
