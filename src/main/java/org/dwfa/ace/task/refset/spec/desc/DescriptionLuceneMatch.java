...
/**
 * Task for adding a "description lucene match" structural query to a refset spec.
 * @author Chrissy Hill
 *
 */
@BeanList(specs = { @Spec(directory = "tasks/refset/spec", type = BeanType.TASK_BEAN) })
public class DescriptionLuceneMatch extends AddStructuralQueryToRefsetSpec {
	/**
	 * 
	 */
