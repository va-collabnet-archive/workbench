...
/**
 * Shows the Select Refset and Position panel in the WF Details panel.
 * 
 * @author Perry Reid
 * 
 */
@BeanList(specs = { @Spec(directory = "tasks/refset/spec/wf", type = BeanType.TASK_BEAN) })
public class SetWFDSheetToRefsetSpecSelectionPanelTask extends AbstractTask {
    ...
    private void doRun(final I_EncodeBusinessProcess process, final I_Work worker) {
        ...
        try {
            ...
            wfSheet.add(new PanelRefsetSpecSelection(refsets, wfSheet), BorderLayout.NORTH);
