...
public class RefreshMemberRefsetUsingListViewConceptsBeanInfo extends
        SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] =
                    { refsetConceptPropName, conceptExtValuePropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    RefreshMemberRefsetUsingListViewConcepts.class);
        bd
            .setDisplayName("<html><font color='green'><center>Refresh member refset<br>using list view concepts");
        return bd;
    }
