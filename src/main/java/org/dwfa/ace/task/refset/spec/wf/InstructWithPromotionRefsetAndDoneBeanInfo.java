...
public class InstructWithPromotionRefsetAndDoneBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] =
                    { instruction, profilePropName, processPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(InstructWithPromotionRefsetAndDone.class);
        bd
            .setDisplayName("<html><font color='green'><center>Instruct and Wait:<br>Promotion refset and done");
        return bd;
    }
}
