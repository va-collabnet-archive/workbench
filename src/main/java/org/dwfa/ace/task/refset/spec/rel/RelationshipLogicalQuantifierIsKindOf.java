...
/**
 * Task for adding a "relationship logical quantifier is kind of" structural query to a refset spec.
 * 
 * @author Chrissy Hill
 * 
 */
...
public class RelationshipLogicalQuantifierIsKindOf extends AddStructuralQueryToRefsetSpec {
    ...
    protected int getStructuralQueryTokenId() throws IOException, TerminologyException {
        return RefsetAuxiliary.Concept.REL_LOGICAL_QUANTIFIER_IS_KIND_OF.localize().getNid();
    }
