    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            outputFilePropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            outputFilePropName
                .setDisplayName("<html><font color='green'>Report file property:");
            outputFilePropName
                .setShortDescription("Name of the property containing the report file. ");

            pathUuidPropName =
                    new PropertyDescriptor("pathUuidPropName",
                        ImportRefsetSpecTask.class);
            pathUuidPropName.setBound(true);
            pathUuidPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            pathUuidPropName
                .setDisplayName("<html><font color='green'>Alternate path UUID property:");
            pathUuidPropName
                .setShortDescription("Name of the property containing the alternative path to import on. ");
            PropertyDescriptor rv[] =
                    { inputFilePropName, outputFilePropName, pathUuidPropName };
            return rv;
