    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            descriptionTypeTermEntry =
                    new PropertyDescriptor("descriptionTypeTermEntry", getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] =
                    { outputFilePropName, descriptionTypeTermEntry, maxLineCount, refsetSpecUuidPropName };
            return rv;
