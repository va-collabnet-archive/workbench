 ...
 */
public class GetRefreshRefsetSpecParamsPanelDataTaskBeanInfo extends
        SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            editorInboxPropName =
                    new PropertyDescriptor("editorInboxPropName",
                        getBeanDescriptor().getBeanClass());
            editorInboxPropName.setBound(true);
            editorInboxPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            editorInboxPropName
                .setDisplayName("<html><font color='blue'>editor inbox prop name:");
            editorInboxPropName
                .setShortDescription("[OUT] The property to put the editor's inbox address into.");
            ...
            commentsPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            commentsPropName
                .setDisplayName("<html><font color='blue'>comments prop name:");
            commentsPropName
                .setShortDescription("[OUT] The property to put the comments into.");
            ...
            refsetUuidPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            refsetUuidPropName
                .setDisplayName("<html><font color='blue'>member refset UUID prop:");
            refsetUuidPropName
                .setShortDescription("[OUT] The property to put the member refset UUID into.");
            ...
            editorUuidPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            editorUuidPropName
                .setDisplayName("<html><font color='blue'>editor UUID prop name:");
            editorUuidPropName
                .setShortDescription("[OUT] The property to put the editor UUID into.");
            ...
            ownerUuidPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            ownerUuidPropName
                .setDisplayName("<html><font color='blue'>owner UUID prop name:");
            ownerUuidPropName
                .setShortDescription("[OUT] The property to put the owner uuid into.");
            ...
            fileAttachmentsPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            fileAttachmentsPropName
                .setDisplayName("<html><font color='blue'>file attachments prop name:");
            fileAttachmentsPropName
                .setShortDescription("[OUT] The property to put the file attachments into.");

            PropertyDescriptor ownerInboxPropName;
            ownerInboxPropName =
                    new PropertyDescriptor("ownerInboxPropName",
                        getBeanDescriptor().getBeanClass());
            ownerInboxPropName.setBound(true);
            ownerInboxPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            ownerInboxPropName
                .setDisplayName("<html><font color='blue'>owner inbox prop name:");
            ownerInboxPropName
                .setShortDescription("[OUT] The property to put the owner's inbox address into.");

            PropertyDescriptor rv[] =
                    { profilePropName, editorInboxPropName, commentsPropName,
                     refsetUuidPropName, editorUuidPropName, ownerUuidPropName,
                     fileAttachmentsPropName, ownerInboxPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    GetRefreshRefsetSpecParamsPanelDataTask.class);
        bd
            .setDisplayName("<html><font color='green'><center>Get Refresh Refset Spec<br>Params panel data<br>from WFD Sheet");
        return bd;
    }
