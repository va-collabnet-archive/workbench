...
public class RemoveAllConceptsFromRefsetBeanInfo extends SimpleBeanInfo {
        ...
        try {
            componentPropName =
                    new PropertyDescriptor("componentPropName",
                        RemoveAllConceptsFromRefset.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(RemoveAllConceptsFromRefset.class);
        bd
            .setDisplayName("<html><font color='green'><center>Retire all<br>refset members");
        return bd;
    }
}
