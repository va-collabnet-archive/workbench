...
public class SetWDFSheetToRefsetVersionPanelTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor refsetVersionPropName =
                    new PropertyDescriptor("refsetVersionPropName",
                        getBeanDescriptor().getBeanClass());
            refsetVersionPropName.setBound(true);
            refsetVersionPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            refsetVersionPropName
                .setDisplayName("<html><font color='blue'>Refset position set prop:");
            refsetVersionPropName
                .setShortDescription("[OUT] The property that will contain the Refset version.");
            ...
            refsetUuidPropName
                .setShortDescription("[IN] The property to put the member refset UUID into.");

            PropertyDescriptor rv[] =
                    { profilePropName, refsetVersionPropName,
                     refsetUuidPropName };
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(SetWDFSheetToRefsetVersionPanelTask.class);
        bd
            .setDisplayName("<html><font color='green'><center>Set WFD Sheet to<br>Refset Version panel");
        return bd;
    }
