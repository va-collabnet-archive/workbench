...
/**
 * The RefreshRefsetSpecCompareTaskBeanInfo class describes the visible elements
 * of the
...
public class RefreshRefsetSpecCompareTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor reviewCountPropName = new PropertyDescriptor("reviewCountPropName",
                getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor reviewIndexPropName = new PropertyDescriptor("reviewIndexPropName",
                getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] = { profilePropName, refsetPositionSetPropName, refsetUuidPropName,
                                       snomedPositionSetPropName, uuidListListPropName, reviewCountPropName,
                                       reviewIndexPropName };
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd.setDisplayName("<html><font color='green'><center>" + "Compare Refset to SNOMED<br>and List Differences");
        return bd;
    }
