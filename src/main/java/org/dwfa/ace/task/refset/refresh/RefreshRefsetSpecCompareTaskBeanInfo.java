...
public class RefreshRefsetSpecCompareTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            profilePropName
                .setShortDescription("[IN] The property that contains the current profile.");

            PropertyDescriptor refsetPositionSetPropName =
                    new PropertyDescriptor("refsetPositionSetPropName",
                        getBeanDescriptor().getBeanClass());
            refsetPositionSetPropName.setBound(true);
            refsetPositionSetPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            refsetPositionSetPropName
                .setDisplayName("<html><font color='green'>refset position set prop:");
            refsetPositionSetPropName
                .setShortDescription("[IN] The property that contains the Refset position set.");
            ...
            refsetUuidPropName
                .setShortDescription("[IN] The property that contains the Refset UUID.");

            PropertyDescriptor snomedPositionSetPropName =
                    new PropertyDescriptor("snomedPositionSetPropName",
                        getBeanDescriptor().getBeanClass());
            snomedPositionSetPropName.setBound(true);
            snomedPositionSetPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            snomedPositionSetPropName
                .setDisplayName("<html><font color='green'>SNOMED position set prop:");
            snomedPositionSetPropName
                .setShortDescription("[IN] The property that contains the SNOMED position set.");
            ...
            uuidListListPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            uuidListListPropName
                .setDisplayName("<html><font color='blue'>List of changes:");
            uuidListListPropName
                .setShortDescription("[OUT] The property that will contain the list of observed changes.");

            PropertyDescriptor reviewCountPropName =
                    new PropertyDescriptor("reviewCountPropName",
                        getBeanDescriptor().getBeanClass());
            reviewCountPropName.setBound(true);
            reviewCountPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            reviewCountPropName
                .setDisplayName("<html><font color='blue'>review count prop:");
            reviewCountPropName
                .setShortDescription("[OUT] The property that will contain the number of items to be reviewed.");

            PropertyDescriptor reviewIndexPropName =
                    new PropertyDescriptor("reviewIndexPropName",
                        getBeanDescriptor().getBeanClass());
            reviewIndexPropName.setBound(true);
            reviewIndexPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            reviewIndexPropName
                .setDisplayName("<html><font color='blue'>review index prop:");
            reviewIndexPropName
                .setShortDescription("[OUT] The property that will contain the index of the item currently being reviewed.");

            PropertyDescriptor rv[] =
                    { profilePropName, refsetPositionSetPropName,
                     refsetUuidPropName, snomedPositionSetPropName,
                     uuidListListPropName, reviewCountPropName,
                     reviewIndexPropName };
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(RefreshRefsetSpecCompareTask.class);
