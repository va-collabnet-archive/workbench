...
/**
 * The GetRefsetVersionPanelDataTaskBeanInfo class describes the visible elements of the 
 * Workflow task GetRefsetVersionPanelDataTask so that it can be displayed in the 
 * Process Builder. 
 * 
 * @author  Perry Reid
...
public class GetRefsetVersionPanelDataTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            positionSetPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            positionSetPropName
                .setDisplayName("<html><font color='blue'>Refset position set prop:");
            positionSetPropName
                .setShortDescription("[OUT] The property that will contain the Refset position set.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(GetRefsetVersionPanelDataTask.class);
        bd
            .setDisplayName("<html><font color='green'><center>Get Refset Spec Version<br>panel data from<br>WFD Sheet");
        return bd;
    }
}
