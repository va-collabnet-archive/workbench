...
public class AddConceptToRefsetBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			...
			PropertyDescriptor refsetConceptPropName = 
				new PropertyDescriptor("refsetConceptPropName", AddConceptToRefset.class);
			...
			PropertyDescriptor memberConceptPropName = 
				new PropertyDescriptor("memberConceptPropName", AddConceptToRefset.class);
	...
	public BeanDescriptor getBeanDescriptor() {
		...
		bd.setDisplayName("<html><font color='green'><center>Add concept to refset");
		return bd;
	}
