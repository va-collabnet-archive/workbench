...
public class SnoDL implements Serializable {
    ...
    public final static String BLACK_BULLET_STR = new String(String
            .valueOf('\u2022'));
    // white bullet
    public final static String WHITE_BULLET_STR = new String(String
            .valueOf('\u25E6'));
    // equivalence aka limit
    public final static String EQUIVALENCE_STR = new String(String
            .valueOf("\u2250"));
    // alternately " [ "
    public final static String LEFT_INCLUSION_STR = new String(String
            .valueOf("\u2291"));
    // alternately " ] "
    public final static String RIGHT_INCLUSION_STR = new String(String
            .valueOf("\u2292"));
    // conjunction
    public final static String CONJUNCTION_STR = new String(String
            .valueOf("\u2293"));
    // epsilon
    public final static String EPSILON_STR = new String(String
            .valueOf("\u03F5"));
    ...
    public String toStringHtml() {
        return "<html><font face='Dialog' size='3' color='blue'>"
                + toStringDl()
    ...
    public String toStringDl() {
        ...
        try {
            if (lhs.size() == 0) {
                ...
                s = new StringBuilder("\""
                        + tf.getConcept(lhs.get(0).id).getInitialText() + "\" "
                        + LEFT_INCLUSION_STR + " \""
                        + tf.getConcept(rhs.id).getInitialText() + "\"");
            } else if (lhs.size() == 2) {
                ...
                for (i = 0; i < lhs.size() - 1; i++) {
                    s.append("\"" + tf.getConcept(i).getInitialText() + "\" "
                            + WHITE_BULLET_STR + " ");
                }
                s.append("\"" + tf.getConcept(i).getInitialText() + "\" "
                        + LEFT_INCLUSION_STR + " \""
