...
public class SetSignpostHtml extends AbstractTask {

	private static final long serialVersionUID = 1;

	private static final int dataVersion = 1;

	private String htmlPropName = ProcessAttachmentKeys.SIGNPOST_HTML
			.getAttachmentKey();
		...
		try {
			...
			SwingUtilities.invokeAndWait(new Runnable() {
				...
				public void run() {
					...
					JScrollPane scroll_pane = new JScrollPane(new JLabel(
							htmlStr));
					signpostPanel.add(scroll_pane, c);
					//
