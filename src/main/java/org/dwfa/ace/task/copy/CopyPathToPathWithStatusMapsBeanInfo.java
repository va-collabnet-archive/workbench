   ...
   public PropertyDescriptor[] getPropertyDescriptors() {
       try {  
         ...
         PropertyDescriptor conceptStatusMapPropName =
            new PropertyDescriptor("conceptStatusMapPropName", getBeanDescriptor().getBeanClass());
         ...
         PropertyDescriptor elementStatusMapPropName =
            new PropertyDescriptor("elementStatusMapPropName", getBeanDescriptor().getBeanClass());
         ...
         elementStatusMapPropName.setShortDescription("Name of the property holding the mapping for the new element status values. ");
           ...
           PropertyDescriptor rv[] =
               { profilePropName, toPathPropName, conceptPropName, conceptStatusMapPropName, elementStatusMapPropName };
           return rv;
