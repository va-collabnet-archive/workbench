...
public class GetAddressesAndPositionsAndChangeStatusFromConceptStatusChangesBeanInfo extends SimpleBeanInfo {
   ...
   public PropertyDescriptor[] getPropertyDescriptors() {
      try {
         PropertyDescriptor positionListPropName = new PropertyDescriptor("positionListPropName", getBeanDescriptor()
               .getBeanClass());
         ...
         PropertyDescriptor statusValuePropName = new PropertyDescriptor("statusValuePropName", getBeanDescriptor()
               .getBeanClass());
         ...
         PropertyDescriptor rv[] = { activeConceptPropName, profilePropName, addressListPropName, positionListPropName, statusValuePropName };
         return rv;
