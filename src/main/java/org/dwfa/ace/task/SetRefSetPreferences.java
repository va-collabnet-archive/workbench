...
public class SetRefSetPreferences extends AbstractTask {
    ...
    public Condition evaluate( I_EncodeBusinessProcess process, final I_Work worker ) throws TaskFailedException {
        try {
        	...
        	/*
        	 * Create an option pane to be used for user input, and a panel to layout
        	...
        	SwingUtilities.invokeAndWait( new Runnable() { public void run() {
        		/*
        		 * Add and label a checkbox for each refset type, for a selected toggle to the panel.
        		 * Inital value should be set to the toggles refset type value.
        		 */
        		for( I_HostConceptPlugins.REFSET_TYPES refSetTypes : I_HostConceptPlugins.REFSET_TYPES.values() ){
        			...
        			cb.setSelected( config.isRefsetInToggleVisible( I_HostConceptPlugins.REFSET_TYPES.valueOf( refSetTypes.toString() ), toggle ) );
                    c.gridy += 1;
        		...
        		/*
        		 * Create an object array to be added to the option pane dialog.
        		 * This needs to have hvae an entry for the text to be dispalyed and one for the checkboxes (panel)
        		 */
        		 ...
        		 */
       		    ...
       		    /*
       		     * Create a frame object to be used as the parent frame for the option pane.
       		    ...
       		    /*
       		     * Determine what action the user took and perform appropriate processing.
       		     */
       		    ...
       		    if (value == null || !(value instanceof Integer)) {
       		    	...
       		    	if (i == JOptionPane.OK_OPTION) {
       		    		/*
       		    		 * User clicked ok. Now need to apply selections to preferences.
       		    		 */
       		    		for(Component comp : optionsPanel.getComponents()){
       		    			System.out.println("comp == " +((JCheckBox)comp).getText()+ " " + ((JCheckBox)comp).isSelected() );
				    		/*
				        	 * Toggle the desired refset display to true/false.
				        	 * If true, set to false. If false, set to true.
				        	 */ 
				    		config.setRefsetInToggleVisible( I_HostConceptPlugins.REFSET_TYPES.valueOf( ((JCheckBox)comp).getText() )
				    										, TOGGLES.valueOf(toggle.toString())
        		 ...
        		 * For some reason, without the fireCommit, the process worked 
        		 * on the initial execution but not on subsequent executions, unless the viewer was restarted.
