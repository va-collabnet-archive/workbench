...
public class WriteAttachmentToChosenFileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
              try {
                PropertyDescriptor filePropName =
                     new PropertyDescriptor("filePropName", WriteAttachmentToChosenFile.class);
                ...
                PropertyDescriptor htmlDataPropName =
                     new PropertyDescriptor("htmlDataPropName", WriteAttachmentToChosenFile.class);
