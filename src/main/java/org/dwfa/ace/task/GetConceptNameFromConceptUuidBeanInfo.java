...
public class GetConceptNameFromConceptUuidBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            conceptPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            conceptPropName
                .setDisplayName("<html><font color='green'>Concept Name:");
            conceptPropName.setShortDescription("Concept");

            PropertyDescriptor rv[] =
                    { uuidPropName, conceptPropName, profilePropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(GetConceptNameFromConceptUuid.class);
        bd
            .setDisplayName("<html><font color='green'><center>Get Concept Name <br> From Uuid");
        return bd;
    }
