...
public enum ProcessAttachmentKeys {
    ...
    HTML_DETAIL, HTML_INSTRUCTION, ROOT_CONCEPT, PARENT_PATH, FROM_PATH_CONCEPT, TO_PATH_CONCEPT, ADDRESS_LIST, PATH_LIST_LIST, TERM_ENTRY_MAP, CON_STATUS_MAP, ELEM_STATUS_MAP;
