...
public enum ProcessAttachmentKeys {
    ...
    ALT_ASSIGNEE, PROCESS_NAME, PROCESS_SUBJECT, SIGNPOST_HTML, UUID_LIST_FILENAME, UUID_LIST_LIST, PROCESS_FILENAME, INSTRUCTION_FILENAME,
    HTML_DETAIL, HTML_INSTRUCTION, ROOT_CONCEPT, PARENT_PATH;
