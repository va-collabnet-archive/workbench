...
public class NewEditPathForUserFromPropertyBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {  
            ...
            PropertyDescriptor parentPathPropertyName =
                new PropertyDescriptor("parentPathPropertyName", getBeanDescriptor().getBeanClass());
            parentPathPropertyName.setBound(true);
            parentPathPropertyName.setPropertyEditorClass(PropertyNameLabelEditor.class);
            parentPathPropertyName.setDisplayName("<html><font color='green'>path parent property:");
            parentPathPropertyName.setShortDescription("The property contianing the parent for the new editing path.");
            ...
            PropertyDescriptor rv[] =
                { profilePropName, parentPathPropertyName, userPropName, originTime };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(NewEditPathForUserFromProperty.class);
        bd.setDisplayName("<html><font color='green'><center>new edit path<br>for user<br>from property");
        return bd;
    }
}
