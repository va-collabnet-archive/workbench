...
public class NewDefaultProfile extends AbstractTask {
   ...
   public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
      try {
         ...
         I_ConfigAceFrame newProfile = newProfile(username, password, adminUsername, adminPassword);
   ...
   public static I_ConfigAceFrame newProfile(String username, String password, String adminUsername,
      ...
      // roots.add(tf.uuid
      // roots.add(tf.uuidToNative(Concept.DESCRIPTION_TYPE.getUid
   ...
   private static void addIfNotNull(I_IntList roots, I_ConceptualizeUniversally concept, I_TermFactory tf)
         throws TerminologyException, IOException {
      try {
         roots.add(tf.uuidToNative(concept.getUids()));
      } catch (NoMappingException e) {
