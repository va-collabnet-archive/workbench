...
public class AddRootToProfileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {  
            ...
            rootEntry.setDisplayName("<html><font color='green'>view path:");
            rootEntry.setShortDescription("The property that contains the concept that identifies the view path.");
