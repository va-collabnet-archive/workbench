...
public class SetViewToPositionOnEditPathSetBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = { profilePropName, positionStr };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(SetViewToPositionOnEditPathSet.class);
        bd
            .setDisplayName("<html><font color='green'><center>set view to position<br>on edit path set");
        return bd;
    }
}
