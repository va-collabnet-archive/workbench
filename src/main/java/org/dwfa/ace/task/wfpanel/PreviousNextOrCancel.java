...
public abstract class PreviousNextOrCancel extends AbstractTask {
	...
	protected void setupPreviousNextOrCancelButtons(final JPanel workflowPanel,
		...
		c.gridx++;
		JButton cancelButton = new JButton(new ImageIcon(InstructAndWait.class
				.getResource(getCancelImage())));
	...
	protected void setup(I_EncodeBusinessProcess process)
