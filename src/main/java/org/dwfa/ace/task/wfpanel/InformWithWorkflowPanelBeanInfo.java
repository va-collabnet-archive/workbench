...
public class InformWithWorkflowPanelBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor information =
                    new PropertyDescriptor("information", getBeanDescriptor()
                        .getBeanClass());
            information.setBound(true);
            information.setPropertyEditorClass(JTextFieldEditor.class);
            information
                .setDisplayName("<html><font color='green'>Information:");
            information
                .setShortDescription("Information to present to the user in the workflow panel. ");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(InformWithWorkflowPanel.class);
