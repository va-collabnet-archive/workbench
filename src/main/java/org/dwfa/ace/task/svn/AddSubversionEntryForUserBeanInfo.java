...
public class AddSubversionEntryForUserBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            prompt
                .setShortDescription("The prompt to tell the user what type of subversion entry they are making.");

            PropertyDescriptor keyName =
                    new PropertyDescriptor("keyName", getBeanDescriptor()
                        .getBeanClass());
            ...
            PropertyDescriptor usernameProperty =
                    new PropertyDescriptor("usernameProperty",
                        getBeanDescriptor().getBeanClass());
            usernameProperty.setBound(true);
            usernameProperty
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            usernameProperty
                .setDisplayName("<html><font color='green'>username key:");
            usernameProperty.setShortDescription("The key for the username.");

            PropertyDescriptor rv[] =
                    { prompt, keyName, repoUrl, workingCopy, usernameProperty };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(AddSubversionEntryForUser.class);
        bd
            .setDisplayName("<html><font color='green'><center>add subversion entry<br>for user");
        return bd;
    }
}
