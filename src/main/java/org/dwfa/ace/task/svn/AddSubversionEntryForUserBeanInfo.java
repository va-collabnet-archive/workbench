...
public class AddSubversionEntryForUserBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {  
            ...
            PropertyDescriptor usernameProperty =
                new PropertyDescriptor("usernameProperty", getBeanDescriptor().getBeanClass());
            usernameProperty.setBound(true);
            usernameProperty.setPropertyEditorClass(PropertyNameLabelEditor.class);
            usernameProperty.setDisplayName("<html><font color='green'>username key:");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd.setDisplayName("<html><font color='green'><center>add subversion entry<br>for user");
        return bd;
    }
}
