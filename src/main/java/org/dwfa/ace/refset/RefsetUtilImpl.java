...
public final class RefsetUtilImpl implements RefsetUtil {
    ...
    public int getMarkedParentIsARelationshipTarget(final I_TermFactory termFactory, I_GetConceptData memberRefset)
            throws Exception {
        ...
        allowedType.add(termFactory.getConcept(RefsetAuxiliary.Concept.MARKED_PARENT_IS_A_TYPE.getUids())
            .getConceptId());
