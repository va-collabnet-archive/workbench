...
public class MarkedParentRefsetHelper extends RefsetHelper {
	...
	public void removeParentMembers(Integer ... conceptIds) throws Exception {
		...
		// For each ancestor, check immediate children for a member of either refset (member or marked parent)
		// that is not in the existing ancestor set. This means we've found a lineage that should not be modified.
