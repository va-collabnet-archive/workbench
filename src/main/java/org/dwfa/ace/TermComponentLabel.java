...
public class TermComponentLabel extends JLabel implements FocusListener, I_ContainTermComponent, ClipboardOwner {
	...
	private class DragGestureListenerWithImage implements DragGestureListener {
		...
		public void dragGestureRecognized(DragGestureEvent dge) {
			...
			dge.startDrag(DragSource.DefaultCopyDrop, dragImage, imageOffset, 
					new ConceptTransferable((I_GetConceptData) termComponent), dsl);
		}
	}
	/**
	 * 
	...
	public TermComponentLabel() throws TerminologyException, IOException {
		this(LocalVersionedTerminology.get().getActiveAceFrameConfig());
	}
	...
	public TermComponentLabel(I_ConfigAceFrame config) {
		...
		setTransferHandler(LocalVersionedTerminology.get().makeTerminologyTransferHandler(this));
	...
	private static final Border hasFocusBorder = UIManager
			.getBorder("List.focusCellHighlightBorder");

	private static final Border noFocusBorder = BorderFactory
