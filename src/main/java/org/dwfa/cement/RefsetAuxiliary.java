		...
		REFSET_AUXILIARY(new String[] { "Refset Auxiliary Concept", "Refset Auxiliary Concept"}),
			REFSET_SPEC(new String[] { "refset specification concept", "refset spec"}, REFSET_AUXILIARY),
            	...
            	SPEC_QUERY_TOKEN(new String[] { "Refset specification token", "Refset specification token"}, REFSET_SPEC),
            		...
            		CONCEPT_STATUS_IS_CHILD_OF(new String[] { "CONCEPT STATUS IS CHILD OF", "concept status is child of"}, SPEC_QUERY_TOKEN),
                    CONCEPT_STATUS_IS_DESCENDENT_OF(new String[] { "CONCEPT STATUS IS DESCENDENT OF", "concept status is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		DESC_IS(new String[] {"DESC IS", "desc is"}, SPEC_QUERY_TOKEN),
            		...
            		DESC_STATUS_IS_CHILD_OF(new String[] { "DESC STATUS IS CHILD OF", "desc status is child of"}, SPEC_QUERY_TOKEN),
            		DESC_STATUS_IS_DESCENDENT_OF(new String[] { "DESC STATUS IS DESCENDENT OF", "desc status is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		DESC_TYPE_IS_CHILD_OF(new String[] { "DESC TYPE IS CHILD OF", "desc type is child of"}, SPEC_QUERY_TOKEN),
            		DESC_TYPE_IS_DESCENDENT_OF(new String[] { "DESC TYPE IS DESCENDENT OF", "desc type is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		REL_IS(new String[] { "REL IS", "rel is" }, SPEC_QUERY_TOKEN),
            		REL_RESTRICTION_IS(new String[] { "REL RESTRICTION IS", "rel restriction is" }, SPEC_QUERY_TOKEN),
            		...
            		REL_STATUS_IS_CHILD_OF(new String[] { "REL STATUS IS CHILD OF", "rel status is child of"}, SPEC_QUERY_TOKEN),
            		REL_STATUS_IS_DESCENDENT_OF(new String[] { "REL STATUS IS DESCENDENT OF", "rel status is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		REL_TYPE_IS_CHILD_OF(new String[] { "REL TYPE IS CHILD OF", "rel type is child of"}, SPEC_QUERY_TOKEN),
            		REL_TYPE_IS_DESCENDENT_OF(new String[] { "REL TYPE IS DESCENDENT OF", "rel type is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		REL_LOGICAL_QUANTIFIER_IS_CHILD_OF(new String[] { "REL LOGICAL QUANTIFIER IS CHILD OF", "rel logical quantifier is child of"}, SPEC_QUERY_TOKEN),
            		REL_LOGICAL_QUANTIFIER_IS_DESCENDENT_OF(new String[] { "REL LOGICAL QUANTIFIER IS DESCENDENT OF", "rel logical quantifier is descendent of"}, SPEC_QUERY_TOKEN),
            		...
            		REL_CHARACTERISTIC_IS_CHILD_OF(new String[] { "REL CHARACTERISTIC IS CHILD OF", "rel characteristic is child of"}, SPEC_QUERY_TOKEN),
            		REL_CHARACTERISTIC_IS_DESCENDENT_OF(new String[] { "REL CHARACTERISTIC IS DESCENDENT OF", "rel characteristic is descendent of"}, SPEC_QUERY_TOKEN),
            		REL_REFINABILITY_IS(new String[] { "REL REFINABILITY IS", "rel refinability is"}, SPEC_QUERY_TOKEN),
            		REL_REFINABILITY_IS_CHILD_OF(new String[] { "REL REFINABILITY IS CHILD OF", "rel refinability is child of"}, SPEC_QUERY_TOKEN),
            		REL_REFINABILITY_IS_DESCENDENT_OF(new String[] { "REL REFINABILITY IS DESCENDENT OF", "rel refinability is descendent of"}, SPEC_QUERY_TOKEN),
            		REL_REFINABILITY_IS_KIND_OF(new String[] { "REL REFINABILITY IS KIND OF", "rel refinability is kind of"}, SPEC_QUERY_TOKEN),
            		DIFFERENCE_QUERY(new String[] { "Difference Query", "difference query"}, SPEC_QUERY_TOKEN),
    					DIFFERENCE_CONFIGURATION(new String[] { "DIFFERENCE CONFIGURATION", "difference configuration"}, DIFFERENCE_QUERY),
    					DIFFERENCE_STATISTICS(new String[] { "DIFFERENCE STATISTICS", "difference statistics"}, DIFFERENCE_QUERY),
        				...
        				CHANGED_CONCEPT_STATUS(new String[] { "CHANGED CONCEPT STATUS", "changed concept status"}, DIFFERENCE_QUERY),
        				CHANGED_DEFINED(new String[] { "CHANGED DEFINED", "changed defined"}, DIFFERENCE_QUERY),
        				ADDED_DESCRIPTION(new String[] { "ADDED DESCRIPTION", "added description"}, DIFFERENCE_QUERY),
        				DELETED_DESCRIPTION(new String[] { "DELETED DESCRIPTION", "deleted description"}, DIFFERENCE_QUERY),
        				CHANGED_DESCRIPTION_STATUS(new String[] { "CHANGED DESCRIPTION STATUS", "changed description status"}, DIFFERENCE_QUERY),
        				CHANGED_DESCRIPTION_TERM(new String[] { "CHANGED DESCRIPTION TERM", "changed description term"}, DIFFERENCE_QUERY),
        				CHANGED_DESCRIPTION_TYPE(new String[] { "CHANGED DESCRIPTION TYPE", "changed description type"}, DIFFERENCE_QUERY),
        				CHANGED_DESCRIPTION_LANGUAGE(new String[] { "CHANGED DESCRIPTION LANGUAGE", "changed description language"}, DIFFERENCE_QUERY),
        				CHANGED_DESCRIPTION_CASE(new String[] { "CHANGED DESCRIPTION CASE", "changed description case"}, DIFFERENCE_QUERY),
        				ADDED_RELATIONSHIP(new String[] { "ADDED RELATIONSHIP", "added relationship"}, DIFFERENCE_QUERY),
        				DELETED_RELATIONSHIP(new String[] { "DELETED RELATIONSHIP", "deleted relationship"}, DIFFERENCE_QUERY),
        				CHANGED_RELATIONSHIP_STATUS(new String[] { "CHANGED RELATIONSHIP STATUS", "changed relationship status"}, DIFFERENCE_QUERY),
        				CHANGED_RELATIONSHIP_CHARACTERISTIC(new String[] { "CHANGED RELATIONSHIP CHARACTERISTIC", "changed relationship characteristic"}, DIFFERENCE_QUERY),
        				CHANGED_RELATIONSHIP_TYPE(new String[] { "CHANGED RELATIONSHIP TYPE", "changed relationship type"}, DIFFERENCE_QUERY),
        				CHANGED_RELATIONSHIP_REFINABILITY(new String[] { "CHANGED RELATIONSHIP REFINABILITY", "changed relationship language"}, DIFFERENCE_QUERY),
        				CHANGED_RELATIONSHIP_GROUP(new String[] { "CHANGED RELATIONSHIP GROUP", "changed relationship group"}, DIFFERENCE_QUERY),
			...
			MEMBER_TYPE(new String[] { "member type", "member type"},
					new I_ConceptualizeUniversally[] { REFSET_AUXILIARY },
					UUID.fromString("fa28e447-d635-49b1-9b55-86254a7a2f97")),
		          MARKED_PARENT(new String[] { "marked parent member", "marked parent member"},
		                		new I_ConceptualizeUniversally[] { MEMBER_TYPE },
		                		UUID.fromString("125f3d04-de17-490e-afec-1431c2a39e29")),
	              NORMAL_MEMBER(new String[] { "normal member", "normal member"},
	                		new I_ConceptualizeUniversally[] { MEMBER_TYPE },
			...
			REFSET_PURPOSE(new String[] { "refset purpose", "refset purpose"}, REFSET_AUXILIARY),
                ANNOTATION_PURPOSE(new String[] { "annotation", "annotation"}, REFSET_PURPOSE),
                	ENUMERATED_ANNOTATION_PURPOSE(new String[] { "enumerated annotation", "enumerated annotation"}, ANNOTATION_PURPOSE),
                	STRING_ANNOTATION_PURPOSE(new String[] { "string annotation", "string annotation"}, ANNOTATION_PURPOSE),
                ATTRIBUTE_VALUE(new String[] { "attribute value", "attribute value"}, REFSET_PURPOSE),
                	ENUMERATED_ATTRIBUTE_VALUE_PURPOSE(new String[] { "enumerated attribute value", "enumerated attribute value"}, ATTRIBUTE_VALUE),
                	STRING_ATTRIBUTE_VALUE_PURPOSE(new String[] { "string attribute value", "string attribute value"}, ATTRIBUTE_VALUE),
                NAVIGATION(new String[] { "navigation", "navigation"}, REFSET_PURPOSE),
                	RELATIONSHIP_ORDER(new String[] { "relationship order", "relationship order"}, NAVIGATION),
                	TYPED_NAVIGATION(new String[] { "typed navigation", "typed navigation"}, NAVIGATION),
                SPECIFICATION(new String[] { "specification", "specification"}, REFSET_PURPOSE),
                	REFSET_SPECIFICATION(new String[] { "refset specification", "refset specification"}, SPECIFICATION),
                    INCLUSION_SPECIFICATION(new String[] { "inclusion specification", "inclusion specification"}, SPECIFICATION),
                ...
                DIALECT(new String[] { "dialect", "dialect"}, REFSET_PURPOSE),
                QUERY_SPECIFICATION(new String[] { "query specification", "query specification"}, REFSET_PURPOSE),
                MAPPING_PURPOSE(new String[] { "mapping purpose", "mapping purpose"}, REFSET_PURPOSE),
                	SIMPLE_MAP_PURPOSE(new String[] { "simple mapping purpose", "simple mapping purpose"}, REFSET_PURPOSE),
                    ALTERNATE_MAP_PURPOSE(new String[] { "alternate mapping purpose", "alternate mapping purpose"}, REFSET_PURPOSE),
                    TYPED_MAP_PURPOSE(new String[] { "typed mapping purpose", "typed mapping purpose"}, REFSET_PURPOSE),
                SIMPLE_COMPONENT(new String[] { "simple component", "simple component"}, REFSET_PURPOSE),
                	 LANGUAGE_PURPOSE(new String[] { "language purpose", "language purpose"}, REFSET_PURPOSE),
                	 	DESCRIPTION_TYPE_PURPOSE(new String[] { "description type purpose", "desc type purpose"}, REFSET_PURPOSE),
                     MEASUREMENT_ASSOCIATION(new String[] { "measurement association", "measurement association"}, SIMPLE_COMPONENT),
                		INT_MEASUREMENT_ASSOCIATION(new String[] { "integer measurement association", "integer measurement association"}, MEASUREMENT_ASSOCIATION),
                		FLOAT_MEASUREMENT_ASSOCIATION(new String[] { "float measurement association", "float measurement association"}, MEASUREMENT_ASSOCIATION),
                REFSET_MEMBER_PURPOSE(new String[] { "refset membership", "refset membership"},
                		new I_ConceptualizeUniversally[] { REFSET_PURPOSE },
                		UUID.fromString("090a41ac-3299-54b4-a287-4f279b85d059")),
                REFSET_PARENT_MEMBER_PURPOSE(new String[] { "marked parent membership", "marked parent membership"},
                		new I_ConceptualizeUniversally[] { REFSET_PURPOSE },
			...
			REFSET_RELATIONSHIP(new String[] { "refset relationship", "refset relationship" },
				...
				MARKED_PARENT_IS_A_TYPE(new String[] { "marked parent is-a type", "marked parent is-a type"},
						REFSET_RELATIONSHIP),
				PROMOTION_REL(new String[] { "promotion rel", "promotion rel"},
                        REFSET_RELATIONSHIP),
                COMMENTS_REL(new String[] { "comments rel", "comments rel"},
                        REFSET_RELATIONSHIP),

			SUPPORTING_REFSETS(new String[] { "supporting refsets",
                        "supporting refsets" }, REFSET_AUXILIARY),

			REFSET_IDENTITY(new String[] { "refset identity", "refset"}, REFSET_AUXILIARY),

			    CAB(new String[] { "CAB","CAB",
                ...
                CAB_SNOMED_FULL(new String[] { "SNOMED Full","SNOMED Full",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { CAB,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                       REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                CAB_SNOMED_LITE(new String[] { "SNOMED Lite","SNOMED Lite",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { CAB,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                       REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                CAB_OTHER(new String[] { "CAB Other","CAB Other",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { CAB,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                ...
                DSP_CLINICAL(new String[] { "DSP Clinical","DSP Clinical",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                ...
                DSP_PHARMACY(new String[] { "DSP Pharmacy","DSP Pharmacy",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                       REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                DSP_PHARMACY_EPRESCRIBING(new String[] { "DSP ePrescribing","DSP ePrescribing",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { DSP_PHARMACY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                       REFSET_PURPOSE_REL, REFSET_TYPE_REL}),

                SSERP(new String[] { "SSERP","SSERP",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                ...
                LONDON_IT(new String[] { "London IT Programme","London IT Programme",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                ...
                CLINICAL_MESSAGING(new String[] { "Clinical Messaging","Clinical Messaging",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                ...
                SCG(new String[] { "SCG","SCG",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                       REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                SCG_RELIGIONS(new String[] { "SCG Religions","SCG Religions",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                ...
                TECHNICAL(new String[] { "Technical","Technical",
                       "ORG_DWFA_CTV3_CROSS_MAP"},
                       new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                        ANCILLARY_DATA, CROSS_MAP_EXTENSION},
                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
