...
public class QueueType implements I_AddToMemoryTermServer {
	public enum Concept implements I_ConceptEnumeration,I_ConceptualizeUniversally {
		QUEUE_TYPE("Queue Type"),
			...
			COMPUTE_QUEUE("compute queue", QUEUE_TYPE),
			INBOX_QUEUE("inbox queue", QUEUE_TYPE),
			LAUNCHER_QUEUE("launcher queue", QUEUE_TYPE),
			OUTBOX_QUEUE("outbox queue", QUEUE_TYPE),
			SYNCHRONIZATION_QUEUE("synchronization queue", QUEUE_TYPE),
			WEB_QUEUE("web queue", QUEUE_TYPE),
				;
