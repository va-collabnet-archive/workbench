    ...
    public enum Concept implements I_ConceptEnumeration,I_ConceptualizeUniversally {
      ...
      LANGUAGE_CONCEPT("language concept",
              ...
              DESCRIPTION_TYPE("description type",
                 ...
                 ICD10_CODE_PLUS_RUBRIC_DESCRIPTION_TYPE(PrimordialId.FULLY_SPECIFIED_DESCRIPTION_TYPE_ID,
                                new String[] {"ICD10 Code plus Rubric", "ICD10 Code plus Rubric"}, null,
                                new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }), 
                 ICD10_EXCLUSION_DESCRIPTION_TYPE(PrimordialId.FULLY_SPECIFIED_DESCRIPTION_TYPE_ID,
                                        new String[] {"ICD10 Exclusion", "ICD10 Exclusion"}, null,
                                        new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),                  
                 ICD10_INCLUSION_DESCRIPTION_TYPE(PrimordialId.FULLY_SPECIFIED_DESCRIPTION_TYPE_ID,
                                                new String[] {"ICD10 Inclusion)", "ICD10 Inclusion"}, null,
                                                new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),  
                 ICD10_PREFERRED_DESCRIPTION_TYPE(PrimordialId.FULLY_SPECIFIED_DESCRIPTION_TYPE_ID,
                                                        new String[] {"ICD10 Preferred Description", "ICD10 Preferred"}, null,
                                                        new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),                               
