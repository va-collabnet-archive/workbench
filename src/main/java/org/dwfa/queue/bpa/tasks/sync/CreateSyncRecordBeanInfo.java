        ...
        try {
            ...
            PropertyDescriptor localPropertyName =
                    new PropertyDescriptor("localPropName",
                        CreateSyncRecord.class);
            localPropertyName.setBound(true);
            localPropertyName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            localPropertyName
                .setDisplayName("<html><font color='blue'>Sync property");
            localPropertyName
                .setShortDescription("Name of the local property to hold the syncronization record. ");
