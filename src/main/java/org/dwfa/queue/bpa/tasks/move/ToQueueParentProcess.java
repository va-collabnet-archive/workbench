...
/**
 * Moves the parent process to the first queue that matches the selected queue type. 
 * @author kec
 *
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/queue tasks/move-to", type = BeanType.TASK_BEAN)})
public class ToQueueParentProcess extends AbstractTask {
    ...
    public void complete(I_EncodeBusinessProcess process, I_Work worker)
        ...
        try {
            ...
            q.write(parentProcess, worker.getActiveTransaction());
        } catch (Exception e) {
