...
public class ConceptConstants {
	...
	public static final ConceptSpec RELATIONSHIP_REFINABILITY_EXTENSION = new ConceptSpec("Relationship refinability reference set", "a69353f3-fcb2-488f-ad00-84152672ef49");;
	public static final ConceptSpec STATUS_REASON_EXTENSION = new ConceptSpec("Status reason reference set", "e61d012e-0a7d-4991-a81c-aafa287aedec");;
	public static final ConceptSpec DEFINITION_TYPE_EXTENSION = new ConceptSpec("Definition status reference set", "6e88ee62-3fa0-495f-945f-809723a78c4b");;
