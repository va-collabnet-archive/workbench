 ...
 * 
 * From http://java.sun.com/docs/books/tutorial/uiswing/layout/examples/SpringUtilities.java
 * 
 */
    ...
    public static void makeCompactGrid(Container parent, int rows, int cols,
        ...
        for (int c = 0; c < cols; c++) {
            ...
            for (int r = 0; r < rows; r++) {
                width =
                        Spring.max(width, getConstraintsForCell(r, c, parent,
                            cols).getWidth());
            }
            for (int r = 0; r < rows; r++) {
        ...
        for (int r = 0; r < rows; r++) {
            ...
            for (int c = 0; c < cols; c++) {
                height =
                        Spring.max(height, getConstraintsForCell(r, c, parent,
                            cols).getHeight());
            }
            for (int c = 0; c < cols; c++) {
                SpringLayout.Constraints constraints =
