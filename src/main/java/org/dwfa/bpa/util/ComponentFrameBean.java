...
public class ComponentFrameBean implements ActionListener,
  ...
  public ComponentFrameBean(String[] args, LifeCycle lc, JFrame frame,
      I_InitComponentMenus compMenuIniter, boolean hiddenFrame)
      throws Exception {
    this(args, lc, frame, compMenuIniter, new JMenuBar(), hiddenFrame);
  }

  public ComponentFrameBean(String[] args, LifeCycle lc, JFrame frame,
      I_InitComponentMenus compMenuIniter) throws Exception {
    this(args, lc, frame, compMenuIniter, new JMenuBar());
  }

  public ComponentFrameBean(String[] args, LifeCycle lc, JFrame frame,
      I_InitComponentMenus compMenuIniter, JMenuBar mainMenuBar)
      throws Exception {
  ...
  public ComponentFrameBean(String[] args, LifeCycle lc, JFrame frame,
    ...
    this.config = ConfigurationProvider.getInstance(args,
  ...
  private void setupPrefs() {
    ...
    lookAndFeelList.setRenderer(new DefaultListCellRenderer() {
      ...
      public Component getListCellRendererComponent(JList list, Object value,
        ...
        super.getListCellRendererComponent(list, lafValue.getName(), index,
  ...
  private void addFramesToWindowMenu() {
    if (logger.isLoggable(Level.FINER)) {
      logger.log(Level.FINER, "Changing window menu for: "
          + this.frame.getTitle());
    }
    ...
    synchronized (newWindowMenuItems) {
      ...
      for (JMenuItem newWindowMenu : newWindowMenuItems) {
        if (newWindowMenu != null) {
          ...
          logger.log(Level.FINEST, "Adding new window item: "
              + newWindowMenu.getText());
        }
      }
    }
  ...
  public final void preferences() {
    ...
    prefs.setLocation((int) this.frame.getLocation().getX() + 22,
