...
public class TaskInfo implements Serializable {
	 ...
	 * @param process TODO
	 */
	public TaskInfo(I_DefineTask task, List<Branch> branches,
			List<ExecutionRecord> executionRecords, Rectangle bounds) {
		super();
		this.task = task;
	...
	public int getTaskIdForCondition(Condition condition)
