    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor newNameProp =
                    new PropertyDescriptor("newNameProp",
                        SetProcessNameFromProp.class);
            newNameProp.setBound(true);
            newNameProp.setPropertyEditorClass(PropertyNameLabelEditor.class);
            newNameProp
                .setDisplayName("<html><font color='green'>new name prop:");
            newNameProp
                .setShortDescription("Name of the property containing the new process name. ");
