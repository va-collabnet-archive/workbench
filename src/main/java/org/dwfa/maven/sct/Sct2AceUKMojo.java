...
/**
 * Sct2AceUKMojo converts SNOMED text release files to ACE text import files.
 * 
 * @goal sct2aceuk
...
public class Sct2AceUKMojo extends AbstractMojo {
	/**
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			String sctArfOut = "/classes/net/nhs/sct/sct-arf";
	...
	protected void processConceptsFiles(String bDir, String sctPath)
		...
		// Setup output file
		String outFileName = bDir + "/classes/net/nhs/sct/sct-arf/concepts.txt"; // :EDIT:
		BufferedWriter bw;
		...
		while (i < (children.length + 2)) {
			...
			if (i < children.length) {
				...
				// HANDLE UK CONCEPT EXTENSIONS
				if (i == children.length) {
					fName2 = bDir + "/generated-source/net/nhs/uktc/ukde"
							+ "/sct_concepts_uk_drug_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
					...
					fName2 = bDir + "/generated-source/net/nhs/uktc/uke"
							+ "/sct_concepts_uk_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
						u = Type5UuidFactory.get(Type5UuidFactory.PATH_ID_FROM_FS_DESC,
	...
	protected void processDescriptionsFiles(String bDir, String sctPath)
		...
		String erFileName = bDir
				+ "/classes/net/nhs/sct/sct-arf/descriptions_report.txt";
		BufferedWriter er;
		...
		String outFileName = bDir
				+ "/classes/net/nhs/sct/sct-arf/descriptions.txt";
		BufferedWriter bw;
		getLog().info("sct-arf OUTPUT: " + outFileName);
		bw = new BufferedWriter(new FileWriter(outFileName));
...
//			}
		...
		while (i < (children.length + 2)) {
			...
			if (i < children.length) {
				...
				// HANDLE UK DESCRIPTIONS EXTENSIONS
				if (i == children.length) {
					fName2 = bDir + "/generated-source/net/nhs/uktc/ukde"
							+ "/sct_descriptions_uk_drug_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
						u = Type5UuidFactory.get(Type5UuidFactory.PATH_ID_FROM_FS_DESC,
					...
					fName2 = bDir + "/generated-source/net/nhs/uktc/uke"
							+ "/sct_descriptions_uk_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
						u = Type5UuidFactory.get(Type5UuidFactory.PATH_ID_FROM_FS_DESC,
	...
	protected void processRelationshipsFiles(String bDir, String sctPath)
		...
		// Setup exception report
		String erFileName = bDir
				+ "/classes/net/nhs/sct/sct-arf/relationships_report.txt";
		BufferedWriter er;
		er = new BufferedWriter(new FileWriter(erFileName));
		getLog().info("exceptions report OUTPUT: " + erFileName);
		...
		// Setup output file
		String outFileName = bDir
				+ "/classes/net/nhs/sct/sct-arf/relationships.txt";
		BufferedWriter bw;
		getLog().info("sct-arf OUTPUT: " + outFileName);
		bw = new BufferedWriter(new FileWriter(outFileName));
		bw.write("concept uuid\tstatus uuid\tprimitive\t"
...
//			}
		...
		while (i < (children.length + 2)) {
			...
			if (i < children.length) {
				...
				// HANDLE UK RELATIONSHIPS EXTENSIONS
				if (i == children.length) {
					fName2 = bDir + "/generated-source/net/nhs/uktc/ukde"
							+ "/sct_relationships_uk_drug_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
						u = Type5UuidFactory.get(Type5UuidFactory.PATH_ID_FROM_FS_DESC,
					...
					fName2 = bDir + "/generated-source/net/nhs/uktc/uke"
							+ "/sct_relationships_uk_20090401.txt";
					revDate = "20090401 00:00:00";
					UUID u;
					try {
						u = Type5UuidFactory.get(Type5UuidFactory.PATH_ID_FROM_FS_DESC,
