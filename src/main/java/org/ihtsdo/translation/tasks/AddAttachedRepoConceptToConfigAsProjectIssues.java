...
public class AddAttachedRepoConceptToConfigAsProjectIssues extends AbstractTask {
	 ...
	 */
	public AddAttachedRepoConceptToConfigAsProjectIssues() throws MalformedURLException {
		super();
	}
		...
		try {
			...
			if (repoConcept == null) {
				JOptionPane.showMessageDialog(null,
						"Problem getting the Issue Repository Concept.",
						"Error",
			...
			translationConfig.setProjectIssuesRepositoryIds(repoConcept.getUids());
			
			LanguageUtil.setTranslationConfig(config, translationConfig);
