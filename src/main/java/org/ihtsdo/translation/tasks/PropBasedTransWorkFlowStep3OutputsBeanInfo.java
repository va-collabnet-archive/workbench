 ...
 */
public class PropBasedTransWorkFlowStep3OutputsBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new translation work flow step bean info.
	 */
	public PropBasedTransWorkFlowStep3OutputsBeanInfo() {
		super();
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			...
			{profilePropName, stepRole, exit1PropName, exit1Label, exit1NextStatus, 
					exit2PropName, exit2Label, exit2NextStatus, exit3PropName, exit3Label, exit3NextStatus, todoStatus};
			return rv;
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(PropBasedTransWorkFlowStep3Outputs.class);
		bd.setDisplayName("<html><font color='green'><center>Translation WF<br>step by Props<br>3 outputs");
		return bd;
	}
