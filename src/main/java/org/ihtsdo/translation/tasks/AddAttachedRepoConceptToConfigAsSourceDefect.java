...
public class AddAttachedRepoConceptToConfigAsSourceDefect extends AbstractTask {
	 ...
	 */
	public AddAttachedRepoConceptToConfigAsSourceDefect() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			translationConfig.setSourceIssuesRepositoryIds(repoConcept.getUids());
