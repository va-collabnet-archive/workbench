 ...
 */
public class SearchLangCodeAndStringOverConceptSearchInfo extends AbstractSeachTestSearchInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SearchLangCodeAndStringOverConcept.class);
        bd.setDisplayName("other descrips match langcode string");
        return bd;
    }
}
