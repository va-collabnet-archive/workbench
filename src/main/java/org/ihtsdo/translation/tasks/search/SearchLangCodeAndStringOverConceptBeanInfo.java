 ...
 */
public class SearchLangCodeAndStringOverConceptBeanInfo extends AbstractSearchTestBeanInfo {
    
    /** The search info. */
    private static  SearchLangCodeAndStringOverConceptSearchInfo searchInfo = new SearchLangCodeAndStringOverConceptSearchInfo();
