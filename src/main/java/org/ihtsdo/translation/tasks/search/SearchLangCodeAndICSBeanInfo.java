 ...
 */
public class SearchLangCodeAndICSBeanInfo extends AbstractSearchTestBeanInfo {
    
    /** The search info. */
    private static  SearchLangCodeAndICSSearchInfo searchInfo = new SearchLangCodeAndICSSearchInfo();
