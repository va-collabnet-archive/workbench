...
public class DisplayLinguisticGuidelinesForSelectedConceptInConsoleBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(DisplayLinguisticGuidelinesForSelectedConceptInConsole.class);
		bd.setDisplayName("<html><font color='green'><center>Display Linguistic<br>Guidelines");
		return bd;
	}
