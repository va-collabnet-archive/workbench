 ...
 */
public class TranslationWorkFlowStep4OutputsBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new translation work flow step bean info.
	 */
	public TranslationWorkFlowStep4OutputsBeanInfo() {
		super();
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			...
			PropertyDescriptor exit4Label = new PropertyDescriptor("exit4LabelAndDestination", getBeanDescriptor().getBeanClass());
			exit4Label.setBound(true);
			exit4Label.setPropertyEditorClass(JTextFieldEditorOneLine.class);
			exit4Label.setDisplayName("<html><font color='green'>Label & Destination for exit 4:");
			exit4Label.setShortDescription("Label & Destination for exit 4 button");
			...
			{uiPanelName, stepRole, exit1Label, exit1NextStatus, exit2Label, exit2NextStatus
					, exit3Label, exit3NextStatus, exit4Label, exit4NextStatus};
			return rv;
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(TranslationWorkFlowStep4Outputs.class);
		bd.setDisplayName("<html><font color='green'><center>Translation WF<br>step<br>4 Outputs");
		return bd;
	}
