...
public class OpenTranslationModuleConfiguration extends AbstractTask {
	 ...
	 */
	public OpenTranslationModuleConfiguration() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			ConfigDialog panle = new ConfigDialog(config,confTrans,false, null);

			ConfigTranslationModule newConfTrans = panle.showModalDialog();
			if(newConfTrans != null){
				LanguageUtil.setTranslationConfig(config, newConfTrans);
			}
