...
public class IsSynonymMemberTypeOfEvaluatorDefinition implements EvaluatorDefinition {
    ...
    public static class IsSynonymMemberTypeOfEvaluator extends BaseEvaluator {
        ...
        public IsSynonymMemberTypeOfEvaluator(final ValueType type, final boolean isNegated) {
            super(type,
                    isNegated ? IsSynonymMemberTypeOfEvaluatorDefinition.NOT_IS_SYNONYM_MEMBER_TYPE_OF : IsSynonymMemberTypeOfEvaluatorDefinition.IS_SYNONYM_MEMBER_TYPE_OF);
        }
    ...
    public static Operator IS_SYNONYM_MEMBER_TYPE_OF = null;
    ...
    private static synchronized void init() {
        if (IS_SYNONYM_MEMBER_TYPE_OF == null) {
            ...
            SUPPORTED_IDS = new String[]{IS_SYNONYM_MEMBER_TYPE_OF.getOperatorString()};
        }
    }
    ...
    public Evaluator getEvaluator(ValueType type, String operatorId,
        ...
        if (evaluator[index] == null) {
            evaluator[index] = new IsSynonymMemberTypeOfEvaluator(type, isNegated);
        }
