...
/**
 * The Class AddWorklistMemberAsAttach.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class AddWorklistMemberAsAttach extends AbstractTask {

	/** The issue concept Name. */
	private TermEntry conceptName;
	...
	ClassNotFoundException {
		...
		if (objDataVersion == 1) {
//			try{
			conceptName=(TermEntry)in.readObject();
//			}catch(Exception e){
//				e.printStackTrace();
//			}
//			
