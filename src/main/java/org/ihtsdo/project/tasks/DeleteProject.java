...
public class DeleteProject extends AbstractTask {
	 ...
	 */
	public DeleteProject() throws MalformedURLException {
		super();
	}
		...
		try {
			...
			for (I_TerminologyProject project : projects) {
				if (project.getName().equals(projectName)) {
					found = true;
					TerminologyProjectDAO.retireConcept(project.getConcept(), config);
				}
			}
			if (!found) {
				throw new TaskFailedException("No project found with that name...");
			}
