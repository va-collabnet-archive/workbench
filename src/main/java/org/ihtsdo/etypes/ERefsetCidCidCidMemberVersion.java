...
public class ERefsetCidCidCidMemberVersion extends EVersion {

	private UUID c1Uuid;
	private UUID c2Uuid;
	private UUID c3Uuid;

	public ERefsetCidCidCidMemberVersion(ObjectInput in) throws IOException,
			ClassNotFoundException {
		super();
		readExternal(in);
	}

	public ERefsetCidCidCidMemberVersion(
