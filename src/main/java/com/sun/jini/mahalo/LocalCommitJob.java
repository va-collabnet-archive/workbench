 ...
 */
public class LocalCommitJob extends LocalJob implements TransactionConstants {
     ...
     * @see net.jini.core.transaction.server.TransactionParticipant
     */
    public LocalCommitJob(Transaction tr, TaskManager pool, WakeupManager wm,
    ...
    Object doWork(TaskManager.Task who, Object param) {
        ...
        if (logger.isLoggable(Level.FINEST)) {
            logger.log(Level.FINEST, "CommitJob:doWork committing handle: {0}",
                handle);
        }
        ...
        if (response != null) {
            ...
            try {
                log.write(new LocalParticipantCommitRecord(handle));
