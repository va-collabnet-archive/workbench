...
public class FileIOTest extends TestCase {
    ...
    public void testGetRelativePath() {
        ...
        assertEquals("sub" + File.separator + "subfile", FileIO
            .getRelativePath(subDirFile));
        ...
        assertEquals(".." + File.separator + "superfile", FileIO
            .getRelativePath(superDirFile));
        ...
        assertEquals(".." + File.separator + ".." + File.separator
            + "superSuperfile", FileIO.getRelativePath(superSuperDirFile));
