 ...
 */
public class TranslationWorkFlowStep2OutputsBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new translation work flow step bean info.
	 */
	public TranslationWorkFlowStep2OutputsBeanInfo() {
		super();
	}
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(TranslationWorkFlowStep2Outputs.class);
		bd.setDisplayName("<html><font color='green'><center>Translation WF<br>step<br>2 outputs");
		return bd;
	}
