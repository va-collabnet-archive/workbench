...
public class CreateTargetLangMembershipRefset extends AbstractTask {
	...
	throws TaskFailedException {
		...
		try{
			...
			process.writeAttachment("TargetRefsetUUID", LangMemberRefset.getRefsetConcept().getUids().iterator().next().toString());
