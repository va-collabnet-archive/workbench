 ...
 */
public class PropBasedTransWorkFlowStep2OutputsBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new translation work flow step bean info.
	 */
	public PropBasedTransWorkFlowStep2OutputsBeanInfo() {
		super();
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			...
			{profilePropName, stepRole, exit1PropName, exit1Label, exit1NextStatus, 
					exit2PropName, exit2Label, exit2NextStatus, todoStatus};
			return rv;
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(PropBasedTransWorkFlowStep2Outputs.class);
		bd.setDisplayName("<html><font color='green'><center>Translation WF<br>step by Props<br>2 outputs");
		return bd;
	}
