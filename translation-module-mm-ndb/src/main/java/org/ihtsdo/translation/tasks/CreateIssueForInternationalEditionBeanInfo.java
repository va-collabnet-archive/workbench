...
public class CreateIssueForInternationalEditionBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(CreateIssueForInternationalEdition.class);
		bd.setDisplayName("<html><font color='green'><center>Create Issue<br>for selected<br>intl concept");
		return bd;
	}
