...
public class ContextualizeAllDescriptionsBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(ContextualizeAllDescriptions.class);
		bd.setDisplayName("<html><font color='red'><center>Contextualize All<br>Descriptions<br>(Dev tool!)");
		return bd;
	}
