...
public class PutPathsInListView extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            String csFileName = (String) process.readProperty(inputFilePropName);

            if (csFileName.startsWith(ProcessAttachmentKeys.getAttachmentPrefix())) {
                csFileName = (String) process.readAttachement(csFileName.split(ProcessAttachmentKeys.getAttachmentPrefix())[1]);
            }
