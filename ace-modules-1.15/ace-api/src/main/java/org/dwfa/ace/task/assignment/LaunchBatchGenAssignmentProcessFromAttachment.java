    ...
    */
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            ...
            ArrayList<Collection<UUID>> temporaryListList = (ArrayList<Collection<UUID>>) process.readProperty(uuidListListPropName);
    ...
    private void launchAssignment(I_EncodeBusinessProcess process, I_Work worker, String assignmentProcessFileNameStr,
            String assignee, ArrayList<Collection<UUID>> uuidListList) throws IntrospectionException,
            IllegalAccessException, InvocationTargetException, TaskFailedException, PropertyVetoException,
            TerminologyException, IOException, ClassNotFoundException {
