    ...
    PROJECTS_ROOT_HIERARCHY("Terminology Project Auxiliary concept",
	    ...
	    PROJECT_MANAGER_ROLE("project manager role",
				...
				PROJECT_DELETE_PERMISSION("project delete permission",
						new I_ConceptualizeUniversally[] { PROJECT_MANAGER_ROLE }),
				VIEW_PROJECT_REPORTS_PERMISSION("batching plan create permission",
	    	    		new I_ConceptualizeUniversally[] { PROJECT_MANAGER_ROLE }),
		WORKSET_MANAGER_ROLE("workset manager role",
				...
				WORKSET_SYNC_PERMISSION("workset sync permission",
						new I_ConceptualizeUniversally[] { WORKSET_MANAGER_ROLE }),
		BATCHING_MANAGER_ROLE("batching plan manager role",
	    		new I_ConceptualizeUniversally[] { USER_ROLE }),
	    		BATCHING_CREATE_PERMISSION("batching plan create permission",
	    	    		new I_ConceptualizeUniversally[] { BATCHING_MANAGER_ROLE }),
	    		BATCHING_VIEW_PERMISSION("batching plan view permission",
	    				new I_ConceptualizeUniversally[] { BATCHING_MANAGER_ROLE }),
				BATCHING_UPDATE_PERMISSION("batching plan update permission",
						new I_ConceptualizeUniversally[] { BATCHING_MANAGER_ROLE }),
				BATCHING_DELETE_PERMISSION("batching plan delete permission",
						new I_ConceptualizeUniversally[] { BATCHING_MANAGER_ROLE }),
				BATCHING_EXECUTE_PERMISSION("batching plan execute permission",
						new I_ConceptualizeUniversally[] { BATCHING_MANAGER_ROLE }),
