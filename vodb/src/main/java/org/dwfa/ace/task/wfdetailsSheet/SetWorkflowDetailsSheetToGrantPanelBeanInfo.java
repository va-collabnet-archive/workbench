...
public class SetWorkflowDetailsSheetToGrantPanelBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(SetWorkflowDetailsSheetToGrantPanel.class);
        bd
            .setDisplayName("<html><font color='green'><center>Set Workflow Details<br>Sheet to<br>Grant Panel");
        return bd;
    }
}
