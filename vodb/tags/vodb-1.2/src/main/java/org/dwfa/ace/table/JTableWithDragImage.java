...
public class JTableWithDragImage extends JTable {
    ...
    private class DragGestureListenerWithImage implements DragGestureListener {
        ...
        private Transferable transferableFromSWExtT(Object obj, int column) {
            ...
            REFSET_FIELDS field =
                    (REFSET_FIELDS) getColumnModel().getColumn(column)
                        .getIdentifier();
            switch (field) {
            // All extensions
            case REFSET_ID:
            ...
            case CONCEPT_ID:
                return new ConceptTransferable(
                    ConceptBean.get(((ThinExtByRefPartConcept) swextt
                        .getTuple().getPart()).getConceptId()));
            case INTEGER_VALUE:
                return new StringSelection(swextt.getCellText());
            case ACCEPTABILITY:
                return new ConceptTransferable(ConceptBean
                    .get(((ThinExtByRefPartLanguage) swextt.getTuple()
            ...
            case TAG:
                return new ConceptTransferable(ConceptBean
                    .get(((ThinExtByRefPartLanguageScoped) swextt.getTuple()
                        .getPart()).getTagId()));
            case SCOPE:
                return new ConceptTransferable(ConceptBean
                    .get(((ThinExtByRefPartLanguageScoped) swextt.getTuple()
            ...
            case MEASUREMENT_UNITS_ID:
                return new ConceptTransferable(ConceptBean
                    .get(((ThinExtByRefPartMeasurement) swextt.getTuple()
