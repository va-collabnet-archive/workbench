...
/**
 * Test class that tests the concrete methods of the ConflictResolutionStrategy abstract class
 * 
 * @author Dion
 */
public class ConflictManagementStrategyTest {
	...
	class TestConflictResolutionStrategy extends ConflictManagementStrategy {
		...
		public List<I_ConceptAttributePart> resolveConceptAttributeParts(
				List<I_ConceptAttributePart> parts) {
			throw new UnsupportedOperationException();
		}

		public List<I_ConceptAttributeTuple> resolveConceptAttributeTuples(
				List<I_ConceptAttributeTuple> tuples) {
			throw new UnsupportedOperationException();
		}

		public List<I_DescriptionPart> resolveDescriptionParts(
				List<I_DescriptionPart> parts) {
			throw new UnsupportedOperationException();
		}

		public List<I_DescriptionTuple> resolveDescriptionTuples(
				List<I_DescriptionTuple> tuples) {
			throw new UnsupportedOperationException();
		}

		public List<I_ThinExtByRefPart> resolveExtByRefPart(
				List<I_ThinExtByRefPart> parts) {
			throw new UnsupportedOperationException();
		}

		public List<I_ThinExtByRefTuple> resolveExtByRefTuples(
		...
		@Override
		protected <T extends I_AmPart> boolean doesConflictExist(
				List<T> versions) {
			throw new UnsupportedOperationException();
		}
	...
	public void testDescriptionConflict() throws Exception {
		Assert.assertTrue(conflictResloutionStrategy.isInConflict(getMockConcept(false, true, false, false, false, false), true));
		Assert.assertFalse(conflictResloutionStrategy.isInConflict(getMockConcept(false, true, false, false, false, false), false));
	}

	private I_GetConceptData getMockConcept(boolean conceptConflict,
			boolean descriptionConflict, boolean replationshipConflict,
			boolean extensionConflict, boolean imageConflict, boolean idConflict)
			throws IOException, TerminologyException {
		initialise();
		...
		expect(concept.getDescriptions())
	...
	public void testExtensionConflict() throws Exception {
		Assert.assertTrue(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, true, false, false), true));
		Assert.assertFalse(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, true, false, false), false));
	}

	@Test
	public void testRelationshipConflict() throws Exception {
		Assert.assertTrue(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, true, false, false, false), true));
		Assert.assertFalse(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, true, false, false, false), false));
	}

	@Test
	public void testIdConflict() throws Exception {
		Assert.assertTrue(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, false, false, true), true));
		Assert.assertFalse(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, false, false, true), false));
	}

	@Test
	public void testImageConflict() throws Exception {
		Assert.assertTrue(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, false, true, false), true));
		Assert.assertFalse(conflictResloutionStrategy.isInConflict(getMockConcept(false, false, false, false, true, false), false));
	}
}
