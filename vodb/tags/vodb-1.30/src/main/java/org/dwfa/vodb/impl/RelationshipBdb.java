...
public class RelationshipBdb implements I_StoreInBdb, I_StoreRelationships {
	...
	private class RelationshipIterator implements
			Iterator<I_RelVersioned> {
		...
		private void getNext() {
			try {
				...
				if (hasNext) {
					desc = (I_RelVersioned) relBinding
	...
	public RelationshipBdb(Environment env, DatabaseConfig dbConfig)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.dwfa.vodb.impl.I_StoreRelationships#writeRel(org.dwfa.ace.api.I_RelVersioned)
	 */
