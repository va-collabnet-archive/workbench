...
public class TermLabelMaker {
    ...
    public static I_ImplementActiveLabel newLabel(
        ...
        LabelForTuple ldt =
                new LabelForConceptAttributeTuple(conAttribute, showLongForm,
                    showStatus);
    ...
    public static I_ImplementActiveLabel newLabel(I_DescriptionTuple desc,
        ...
        LabelForTuple ldt =
                new LabelForDescriptionTuple(desc, showLongForm, showStatus);
        return makeLabel(ldt, labelHtml, toolTipHtml);
    }
    ...
    public static I_ImplementActiveLabel newLabel(I_RelTuple rel,
        ...
        ConceptBean characteristicBean =
                ConceptBean.get(rel.getCharacteristicId());
        ...
        String labelHtml = labelBuff.toString();
        String toolTipHtml = toolTipBuff.toString();
        LabelForRelationshipTuple lrt =
                new LabelForRelationshipTuple(rel, showLongForm, showStatus);
    ...
    private static TransparencyFilter transparentFilter =
