...
public class SvnPrompter implements PromptUserPassword3 {
    ...
    public String askQuestion(String realm, String question,
        ...
        int action =
                JOptionPane.showOptionDialog(parentContainer, promptPane,
    ...
    public int askTrustSSLServer(String info, boolean allowPermanently) {
        ...
        return JOptionPane.showOptionDialog(parentContainer, info,
            "Trust SSL Server", optionType, JOptionPane.QUESTION_MESSAGE, null,
            options, options[0]);
    }
    ...
    public String askQuestion(String realm, String question,
        ...
        return (String) JOptionPane.showInputDialog(parentContainer, question,
            realm, JOptionPane.PLAIN_MESSAGE, null, null, defaultAnswer);
    }
    ...
    public boolean askYesNo(String realm, String question, boolean yesIsDefault) {
        ...
        int n =
                JOptionPane.showOptionDialog(parentContainer, question, realm,
