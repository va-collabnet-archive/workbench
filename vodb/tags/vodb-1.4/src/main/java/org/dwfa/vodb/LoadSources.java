...
public class LoadSources {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            loadConstants =
                    new ProcessAceFormatSourcesBerkeley(AceConfig.getVodb());
            ...
            if (args.length > 2) {
                ProcessSnomedBerkeley loadSnomed =
                        new ProcessSnomedBerkeley(AceConfig.getVodb(),
                            loadConstants.getConstantToIntMap(),
                            releaseDates[0]);
                AceLog.getAppLog().info(
                    "(2) Starting to process SNOMED: " + args[2]);
