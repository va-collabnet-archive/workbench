...
public class DescCoreBdb implements I_StoreInBdb {
	...
	public DescCoreBdb(Environment env, DatabaseConfig dbConfig)
		...
		while (partCursor.getNext(foundKey, foundData, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
			...
			ThinDescPartCore descPartCore = (ThinDescPartCore) descPartCoreBinding
	...
	public int getDescPartCoreId(I_DescriptionPart descPart)
	throws DatabaseException {
	 ...
	 */
	public int getDescPartCoreId(ThinDescPartCore descPartCore)
			throws DatabaseException {
	 ...
	 */
	public ThinDescPartCore getDescPartCore(int partId)
			throws DatabaseException {
