...
public class SetWorkflowDetailsSheetToCriterionPanelBeanInfo extends
        SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    SetWorkflowDetailsSheetToCriterionPanel.class);
        bd
            .setDisplayName("<html><font color='green'><center>Set Workflow Details<br>Sheet to<br>Criterion Panel");
        return bd;
    }
}
