...
public class WriteRelationshipJob implements Runnable {
	public class WriteRelationshipData {
		...
		public WriteRelationshipData(CountDownLatch latch, Date statusDate,
				Object relID, Object statusId, Object conceptOneID,
		...
		public String toString() {
			return "WriteRelationshipData [characteristic=" + characteristic
					+ ", conceptOneID=" + conceptOneID + ", conceptTwoID="
					+ conceptTwoID + ", group=" + group + ", latch=" + latch
					+ ", pathId=" + pathId + ", refinability=" + refinability
					+ ", relID=" + relID + ", relationshipTypeConceptID="
					+ relationshipTypeConceptID + ", statusDate=" + statusDate
					+ ", statusId=" + statusId + "]";
		}
	...
	public void addTask(CountDownLatch latch, Date statusDate,
			Object relID, Object statusId, Object conceptOneID,
			Object relationshipTypeConceptID, Object conceptTwoID,
			Object characteristic, Object refinability, int group, Object pathId) {
		batch.add(new WriteRelationshipData(latch, statusDate,
				relID, statusId, conceptOneID, relationshipTypeConceptID,
	...
	public void run() {
		for (WriteRelationshipData data : batch) {
			try {
				processor.writeRelationship(data.latch, data.statusDate,
						data.relID, Arrays.asList(new Object[] { data.statusId}), data.conceptOneID,
						data.relationshipTypeConceptID, data.conceptTwoID,
						data.characteristic, data.refinability, data.group,
