...
/**
 * Simple Mojo that ssentially greps a file and writes the result to another
 * file.
...
public class FileFilterMojo extends AbstractMojo {
    ...
    /**
     * indicates if the output file should be appended to or overwritten -
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            throw new MojoExecutionException("Mojo failed due to IO failure, input file was " + inputFile
                + " output file was " + outputFile + " and the expression was " + expression, e);
        }
    }

    private void writeLine(BufferedWriter writer, String inputLine) throws IOException {
