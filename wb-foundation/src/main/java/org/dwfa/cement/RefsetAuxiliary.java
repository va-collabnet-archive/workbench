...
public class RefsetAuxiliary implements I_AddToMemoryTermServer {
   ...
   REFSET_AUXILIARY(new String[]{"Refset Auxiliary Concept", 
    ...
    "compute time rel"}, REFSET_RELATIONSHIP),
        ...
        SEMANTIC_HIERARCHY(new String[]{"semantic area hierarchy workflow refset", "semantic area hierarchy workflow refset"}, WORKFLOW),
        SEMANTIC_TAGS(new String[]{"semantic area search workflow refset", "semantic area search workflow refset"}, WORKFLOW),
