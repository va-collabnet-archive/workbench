...
public class RefsetAuxiliary implements I_AddToMemoryTermServer {
   ...
   REFSET_AUXILIARY(new String[]{"Refset Auxiliary Concept", 
       "Refset Auxiliary Concept"}),
     REFSET_SPEC(new String[]{"refset specification concept", 
         "refset spec"}, REFSET_AUXILIARY),
        SPEC_GROUPING(new String[]{"Refset specification grouping", 
            "Refset specification grouping"}, REFSET_SPEC),
            REFSET_AND_GROUPING(new String[]{"AND", "AND"}, SPEC_GROUPING),
            REFSET_OR_GROUPING(new String[]{"OR", "OR"}, SPEC_GROUPING),
            CONCEPT_CONTAINS_REL_GROUPING(new String[]{"CONCEPT-CONTAINS-REL", 
                "CONCEPT-CONTAINS-REL"}, SPEC_GROUPING),
            CONCEPT_CONTAINS_DESC_GROUPING(new String[]{"CONCEPT-CONTAINS-DESC", 
                "CONCEPT-CONTAINS-DESC"}, SPEC_GROUPING),
        SPEC_QUERY_TOKEN(new String[]{"Refset specification token", 
            "Refset specification token"}, REFSET_SPEC),
            AUTHOR_IS(new String[]{"AUTHOR IS", "author is"}, SPEC_QUERY_TOKEN), 
            AUTHOR_IS_CHILD_OF(new String[]{"AUTHOR IS CHILD OF",
                "author is child of"}, SPEC_QUERY_TOKEN), 
            AUTHOR_IS_DESCENDENT_OF(new String[]{
            ...
            PATH_IS(new String[]{"PATH IS", "path is"}, SPEC_QUERY_TOKEN), 
            PATH_IS_CHILD_OF(new String[]{"PATH IS CHILD OF",
                "path is child of"}, SPEC_QUERY_TOKEN), 
            PATH_IS_DESCENDENT_OF(new String[]{
                "PATH IS DESCENDENT OF", "path is descendent of"}, SPEC_QUERY_TOKEN), 
            PATH_IS_KIND_OF(new String[]{
               "PATH IS KIND OF", "path is kind of"}, SPEC_QUERY_TOKEN), 
            PATH_IS_MEMBER_OF(new String[]{
               "PATH IS MEMBER OF", "path is member of"}, SPEC_QUERY_TOKEN), 
            ...
            CONCEPT_STATUS_IS(new String[]{"CONCEPT STATUS IS", 
                "concept status is"}, SPEC_QUERY_TOKEN),
            CONCEPT_STATUS_IS_KIND_OF(new String[]{"CONCEPT STATUS IS KIND OF", 
                "concept status is kind of"}, SPEC_QUERY_TOKEN),
            CONCEPT_STATUS_IS_CHILD_OF(new String[]{"CONCEPT STATUS IS CHILD OF", 
                "concept status is child of"}, SPEC_QUERY_TOKEN),
            CONCEPT_STATUS_IS_DESCENDENT_OF(new String[]{
                "CONCEPT STATUS IS DESCENDENT OF", 
                "concept status is descendent of"}, SPEC_QUERY_TOKEN),
            CONCEPT_IS(new String[]{"CONCEPT IS", "concept is"}, SPEC_QUERY_TOKEN), 
            CONCEPT_IS_CHILD_OF(new String[]{"CONCEPT IS CHILD OF",
                "concept is child of"}, SPEC_QUERY_TOKEN), 
            CONCEPT_IS_DESCENDENT_OF(new String[]{
                "CONCEPT IS DESCENDENT OF", "concept is descendent of"}, SPEC_QUERY_TOKEN), 
            CONCEPT_IS_KIND_OF(new String[]{
                "CONCEPT IS KIND OF", "concept is kind of"}, SPEC_QUERY_TOKEN), 
            DESC_IS(new String[]{"DESC IS",
                "desc is"}, SPEC_QUERY_TOKEN), 
            DESC_IS_MEMBER_OF(new String[]{"DESC IS MEMBER OF", "desc is member of"}, SPEC_QUERY_TOKEN), 
            DESC_STATUS_IS(new String[]{
                "DESC STATUS IS", "desc status is"}, SPEC_QUERY_TOKEN), 
            DESC_STATUS_IS_KIND_OF(new String[]{
                "DESC STATUS IS KIND OF", "desc status is kind of"}, SPEC_QUERY_TOKEN), 
            DESC_STATUS_IS_CHILD_OF(new String[]{
                "DESC STATUS IS CHILD OF", "desc status is child of"}, SPEC_QUERY_TOKEN), 
            DESC_STATUS_IS_DESCENDENT_OF(new String[]{
                "DESC STATUS IS DESCENDENT OF", "desc status is descendent of"}, SPEC_QUERY_TOKEN), 
            DESC_TYPE_IS(new String[]{
                "DESC TYPE IS", "desc type is"}, SPEC_QUERY_TOKEN), 
            DESC_TYPE_IS_KIND_OF(new String[]{
                "DESC TYPE IS KIND OF", "desc type is kind of"}, SPEC_QUERY_TOKEN), 
            DESC_TYPE_IS_CHILD_OF(new String[]{
                "DESC TYPE IS CHILD OF", "desc type is child of"}, SPEC_QUERY_TOKEN), 
            DESC_TYPE_IS_DESCENDENT_OF(new String[]{
                "DESC TYPE IS DESCENDENT OF", "desc type is descendent of"}, 
                    SPEC_QUERY_TOKEN), 
            DESC_REGEX_MATCH(new String[]{
                "DESC REGEX MATCH", "desc regex match"}, SPEC_QUERY_TOKEN), 
            DESC_LUCENE_MATCH(new String[]{
                "DESC LUCENE MATCH", "desc lucene match"}, SPEC_QUERY_TOKEN), 
            REL_IS(new String[]{"REL IS", "rel is"}, SPEC_QUERY_TOKEN), 
            REL_RESTRICTION_IS(new String[]{
                "REL RESTRICTION IS", "rel restriction is"}, SPEC_QUERY_TOKEN), 
            REL_IS_MEMBER_OF(new String[]{
                "REL IS MEMBER OF", "rel is member of"}, SPEC_QUERY_TOKEN), 
            REL_STATUS_IS(new String[]{"REL STATUS IS",
                "rel status is"}, SPEC_QUERY_TOKEN), 
            REL_STATUS_IS_KIND_OF(new String[]{"REL STATUS IS KIND OF",
                "rel status is kind of"}, SPEC_QUERY_TOKEN), 
            REL_STATUS_IS_CHILD_OF(new String[]{
                "REL STATUS IS CHILD OF", "rel status is child of"}, 
                    SPEC_QUERY_TOKEN), 
            REL_STATUS_IS_DESCENDENT_OF(new String[]{
                "REL STATUS IS DESCENDENT OF", "rel status is descendent of"},
                    SPEC_QUERY_TOKEN), 
            REL_TYPE_IS(new String[]{
                "REL TYPE IS", "rel type is"}, SPEC_QUERY_TOKEN), 
            REL_TYPE_IS_KIND_OF(new String[]{
                "REL TYPE IS KIND OF", "rel type is kind of"}, SPEC_QUERY_TOKEN), 
            REL_TYPE_IS_CHILD_OF(new String[]{
                "REL TYPE IS CHILD OF", "rel type is child of"}, SPEC_QUERY_TOKEN), 
            REL_TYPE_IS_DESCENDENT_OF(new String[]{
                "REL TYPE IS DESCENDENT OF", "rel type is descendent of"}, 
                    SPEC_QUERY_TOKEN), 
            REL_LOGICAL_QUANTIFIER_IS(new String[]{
                "REL LOGICAL QUANTIFIER IS", "rel logical quantifier is"}, 
                    SPEC_QUERY_TOKEN), 
            REL_LOGICAL_QUANTIFIER_IS_KIND_OF(new String[]{
                "REL LOGICAL QUANTIFIER IS KIND OF", 
                "rel logical quantifier is kind of"}, SPEC_QUERY_TOKEN), 
            REL_LOGICAL_QUANTIFIER_IS_CHILD_OF(new String[]{
                "REL LOGICAL QUANTIFIER IS CHILD OF", 
                "rel logical quantifier is child of"}, SPEC_QUERY_TOKEN), 
            REL_LOGICAL_QUANTIFIER_IS_DESCENDENT_OF(new String[]{
                "REL LOGICAL QUANTIFIER IS DESCENDENT OF", 
                "rel logical quantifier is descendent of"}, SPEC_QUERY_TOKEN), 
            REL_CHARACTERISTIC_IS(new String[]{
                "REL CHARACTERISTIC IS", "rel characteristic is"}, SPEC_QUERY_TOKEN), 
            REL_CHARACTERISTIC_IS_KIND_OF(new String[]{
                "REL CHARACTERISTIC IS KIND OF", 
                "rel characteristic is kind of"}, SPEC_QUERY_TOKEN), 
            REL_CHARACTERISTIC_IS_CHILD_OF(new String[]{
                "REL CHARACTERISTIC IS CHILD OF", 
                "rel characteristic is child of"}, SPEC_QUERY_TOKEN), 
            REL_CHARACTERISTIC_IS_DESCENDENT_OF(new String[]{
                "REL CHARACTERISTIC IS DESCENDENT OF", 
                "rel characteristic is descendent of"}, SPEC_QUERY_TOKEN), 
            REL_REFINABILITY_IS(new String[]{
                "REL REFINABILITY IS", "rel refinability is"}, SPEC_QUERY_TOKEN), 
            REL_REFINABILITY_IS_CHILD_OF(new String[]{
                "REL REFINABILITY IS CHILD OF", 
                "rel refinability is child of"}, SPEC_QUERY_TOKEN), 
            REL_REFINABILITY_IS_DESCENDENT_OF(new String[]{
                "REL REFINABILITY IS DESCENDENT OF", 
                "rel refinability is descendent of"}, SPEC_QUERY_TOKEN), 
            REL_REFINABILITY_IS_KIND_OF(new String[]{
                "REL REFINABILITY IS KIND OF", 
                "rel refinability is kind of"}, SPEC_QUERY_TOKEN),
    ...
    "rules context metadata refset"}, RULES_AUXILIARY),
        ...
        new I_ConceptualizeUniversally[]{EN_TEXT_WITH_DIALECT_VARIANTS}),
        SYNONYMY(new String[]{"Degree of Synonymy", "Degree of Synonymy"},
        new I_ConceptualizeUniversally[]{REFSET_IDENTITY}),
        INTERNATIONAL_RELEASE(new String[]{"International Release Refsets", "International Release Refsets"},
        new I_ConceptualizeUniversally[]{REFSET_IDENTITY}),
        REFSET_DESCRIPTOR_REFSET(new String[]{"Refset descriptor refset", "Refset descriptor refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        MODULE_DEPENDENCY_REFSETY(new String[]{"Module dependency refset", "Module dependency refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        DESC_TYPE_REFSET(new String[]{"Description type refset", "Description type refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        EN_US_LANGUAGE_REFSET(new String[]{"en-US language refset", "en-US language refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        EN_GB_LANGUAGE_REFSET(new String[]{"en-GB language refset", "en-GB language refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        HISTORICAL_ASSOC_REFSET(new String[]{"Historical association refset", "Historical association refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        REFERENCES_REFSET(new String[]{"References refset", "References refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        CONCEPT_INACTIVATION_REFSET(new String[]{"Concept inactivation refset", "Concept inactivation refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        DESC_INACTIVATION_REFSET(new String[]{"Description inactivation refset", "Description inactivation refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        REFINABILITY_REFSET(new String[]{"Refinability refset", "Refinability refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        VTM_REFSET(new String[]{"VTM refset", "VTM refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        VMP_REFSET(new String[]{"VMP refset", "VMP refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        NON_HUMAN_REFSET(new String[]{"Non-Human refset", "Non-Human refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        SNOMEDID_REFSET(new String[]{"SNOMEDID refset", "SNOMEDID refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        CTV3ID_REFSET(new String[]{"CTV3ID refset", "CTV3ID refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),
        ICD_03_REFSET(new String[]{"ICD-O3 Refset", "ICD-O3 Refset"},
        new I_ConceptualizeUniversally[]{INTERNATIONAL_RELEASE}),;
