...
public class ArchitectonicAuxiliary implements I_AddToMemoryTermServer {
	...
	SEMTAGS_ROOT("semantic tags",
		...
		TRANSLATION_STATUS("translation status",
	            ...
	            WORKFLOW_EMPTY_NO_WFHX_STATE(new String[] {"Initial without history workflow state", "Concept without history prior"}, null, new I_ConceptualizeUniversally[] { WORKFLOW_STATES }), 
	            WORKFLOW_EMPTY_NOT_EXISTING_STATE(new String[] {"Initial creating concept workflow state", "Concept not previously existing"}, null, new I_ConceptualizeUniversally[] { WORKFLOW_STATES }), 
