...
public class NewWindowGenerator implements I_InitComponentMenus {
    ...
    public class NewFrame implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                Constructor<?> c = classToMake.getConstructor(new Class[] { String[].class });
    ...
    public NewWindowGenerator(String[] args, Properties props) {
        super();
        throw new UnsupportedOperationException("Not yet reimplemented");
////        this.title = props.getProperty(this.getClass().getName(), "frameName");
