...
public class CoreServices extends ArrayList<ServiceConfigOption> {
    ...
    "VHelp.addLibVersion(\"activation\") + \"${path.separator}\" + " + 
    "VHelp.addLibVersion(\"mail\")";
    ...
    public static ServiceConfigOption CO_PhantomFrame = new ServiceConfigOption(
            PHANTOM_FRAME, "config${/}newWindowGenerator.policy", "config${/}newWindowGeneratorSecure.policy",
            PHANTOM_FRAME_PROP,
            "Ensures there is a window menu even if all windows have been closed. ",
            true, "", null, dwaPath,
            "org.dwfa.bpa.util.PhantomFrame",
            new String[] { "config${/}phantomFrame.config" }, 
            new String[] { "config${/}phantomFrameSecure.config" }, 
            false, false, false, "");
    
    public static ServiceConfigOption CO_LogViewer = new ServiceConfigOption(
            LOG_VIEWER, "config${/}logViewer.policy", "config${/}logViewerSecure.policy",
            LOG_VIEWER_PROP,
            ...
            new String[] { "config${/}logViewer.config" }, 
            new String[] { "config${/}logViewerSecure.config" }, 
            true, false, false, "");
    
    public static ServiceConfigOption CO_LogViewerNewFrame = new ServiceConfigOption(
            LOG_VIEWER_NEW_FRAME, "config${/}newWindowGenerator.policy", "config${/}newWindowGeneratorSecure.policy",
    ...
    public static ServiceConfigOption CO_ClassServer = new ServiceConfigOption(
            JINI_CLASS_SERVER, "config${/}classServer.policy", "config${/}classServerSecure.policy", JINI_CLASS_SERVER_PROP,
    ...
    public static ServiceConfigOption CO_ServiceBrowser = new ServiceConfigOption(
            ...
            new String[] { "config${/}browser.config" }, 
            new String[] { "config${/}browserSecure.config" }, 
            true, false, false, "");
    
    public static ServiceConfigOption CO_ServiceBrowserNewFrame = new ServiceConfigOption(
            JINI_SERVICE_BROWSER_NEW_FRAME, "config${/}newWindowGenerator.policy", "config${/}newWindowGeneratorSecure.policy",
            JINI_SERVICE_BROWSER_NEW_FRAME_PROP,
            "Menu option to create a window to allow browsing Jini services on the network. ",
            true, // enabled by default
            "", // codebase 
            null, //jardir
            dwaPath, // classpath
            ...
            new String[] { "config${/}newBrowserFrameSecure.config" }, // secure args
            true, // optional
            false, // alert if selected
            false, // alert if deselected
            ""); //alert string
    
    public static ServiceConfigOption CO_ServiceRegistrar = new ServiceConfigOption(
    ...
    public static ServiceConfigOption CO_TransactionManager = new ServiceConfigOption(
    ...
    public static ServiceConfigOption CO_JavaSpace = new ServiceConfigOption(
            ...
            new String[] { "config${/}transient-outriggerSecure.config" },
            true,
            false, false, "");
    
    public static ServiceConfigOption CO_TransactionAggregator = new ServiceConfigOption(
            TRANSACTION_AGGREGATOR, "config${/}transactionAggregator.policy", 
            "config${/}transactionAggregatorSecure.policy", TRANSACTION_AGGREGATOR_PROP,
            "There must be one on each JVM to participate in Jini Transactions. ",
            true,
            "", null,
            dwaPath,
            "org.dwfa.jini.TransactionParticipantAggregator",
            new String[] { "config${/}transactionAggregator.config" },
            new String[] { "config${/}transactionAggregatorSecure.config" },
            false, false, false, "");
    
    public static ServiceConfigOption CO_GenericWorkerManager = new ServiceConfigOption(
            GENERIC_WORKER_MANAGER, "config${/}genericWorkerManager.policy", 
            "config${/}genericWorkerManagerSecure.policy", GENERIC_WORKER_MANAGER_PROP,
            "Starts generic workers that participate in grid-based workflow activities. ",
            false, "", null, dwaPath,
            "org.dwfa.bpa.worker.GenericWorkerManager",
            new String[] { "config${/}genericWorkerManager.config" },
            new String[] { "config${/}genericWorkerManagerSecure.config" },
            true, false, false, "");
    
    public static ServiceConfigOption CO_GenericWorkerManagerNewFrame = new ServiceConfigOption(
            GENERIC_WORKER_MANAGER_NEW_FRAME, "config${/}newWindowGenerator.policy", "config${/}newWindowGeneratorSecure.policy",
            GENERIC_WORKER_MANAGER_NEW_FRAME_PROP,
            "Menu option to start generic workers that participate in grid-based workflow activities. ",
            true, // enabled by default
            "", // codebase 
            null, //jardir
            dwaPath, // classpath
            ...
            new String[] { "config${/}newGenericWorkerManagerFrameSecure.config" }, // secure args
            true, // optional
            false, // alert if selected
            false, // alert if deselected
            "");
    
    public static ServiceConfigOption CO_Tunnel = new ServiceConfigOption(
    ...
    public static ServiceConfigOption CO_Inbox = new ServiceConfigOption(INBOX_QUEUE, "config${/}queueInbox.policy", 
            ...
            new String[] { "config${/}queueInboxSecure.config" }, 
            true, false, true, 
    ...
    public static ServiceConfigOption CO_WebQueue = new ServiceConfigOption(WEB_QUEUE, 
            "config${/}queueWeb.policy", 
    ...
    public static ServiceConfigOption CO_SequenceAuthorityVerhoeff = new ServiceConfigOption(
            ...
            new String[] { "config${/}assignmentAuthorityLongVerhoeffSecure.config" },
            true, false, false, "");
    
    public static ServiceConfigOption CO_SequenceAuthorityOidUuid = new ServiceConfigOption(
            OID_UUID_AUTHORITY, "config${/}assignmentAuthorityOidUuid.policy", 
            ...
            new String[] { "config${/}assignmentAuthorityOidUuidSecure.config" },
            true, false, false, "");
    
    public static ServiceConfigOption CO_SequenceAuthorityUuid = new ServiceConfigOption(
    ...
    public static ServiceConfigOption CO_QueueViewer = new ServiceConfigOption(QUEUE_VIEWER, "config${/}queueViewer.policy", "config${/}queueViewerSecure.policy", QUEUE_VIEWER_PROP,
            "Allows examination of local and remote queue contents. ",
            true, "", null, 
            dwaPath, "org.dwfa.queue.gui.QueueViewerFrame",
            new String[] { "config${/}queueViewer.config" },
            new String[] { "config${/}queueViewerSecure.config" },
            true, false, false,
            "");
    
    public static ServiceConfigOption CO_ProcessBuilder = new ServiceConfigOption(
            PROCESS_BUILDER, "config${/}processBuilder.policy", "config${/}processBuilderSecure.policy", PROCESS_BUILDER_PROP,
            "Allows building processes and examination/editing of existing processes. ",
            true, "", null, dwaPath,
            "org.dwfa.bpa.gui.ProcessBuilderFrame",
            new String[] { "config${/}processBuilder.config" },
            new String[] { "config${/}processBuilderSecure.config" },
            true,
            false, false, "");
    ...
    public static ServiceConfigOption CO_Timer = new ServiceConfigOption(TIMER, "config${/}timeServer.policy", 
    		"config${/}timeServerSecure.policy", TIMER_PROP,
            "Starts a time server for workflow. ", true, "", "lib",
            dwaPath, "org.dwfa.clock.TimeServer",
            new String[] { "config${/}timeServer.config" }, 
            new String[] { "config${/}timeServerSecure.config" }, 
            true, false, false,
            "");
    ...
    public static ServiceConfigOption CO_WebServer = new ServiceConfigOption(WEB_SERVER, "config${/}webServer.policy", "config${/}webServerSecure.policy", WEB_SERVER_PROP,
            "Starts a web server for workflow. ", true, "", "lib",
            dwaPath, "org.dwfa.web.DwfaWebServer",
            new String[] { "config${/}webServer.config" }, 
            new String[] { "config${/}webServerSecure.config" }, 
            true, false, false,
            "");
