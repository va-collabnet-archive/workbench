...
public class RegistrationLandlordBean implements Landlord {
	...
	public RegistrationLandlordBean(Configuration config) throws LoginException, RemoteException, PrivilegedActionException, ConfigurationException  {
		this.config = config;
	...
	public EventRegistration addEventReg(Uuid cookie, long eventType,
			MarshalledObject data, RemoteEventListener listener, Object source,
			long duration) {
		...
		EventRegistration evtreg = new EventRegistration(eventType, source,
				lease, 0);
