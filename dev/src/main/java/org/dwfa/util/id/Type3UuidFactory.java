...
public class Type3UuidFactory {
    ...
    public static Collection<UUID> forExtension(I_Manifest component, I_ConceptualizeUniversally extType, I_ConceptualizeUniversally extIdentity) throws Exception {
