...
public class SetRemotePropertyBeanInfo  extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {  
            PropertyDescriptor remotePropertyName =
                new PropertyDescriptor("remotePropName", SetRemoteProperty.class);
            ...
            PropertyDescriptor localPropertyName =
                new PropertyDescriptor("localPropName", SetRemoteProperty.class);
            ...
            PropertyDescriptor process =
                new PropertyDescriptor("processDataId", SetRemoteProperty.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
           ...
           bd.setDisplayName("<html>Set <font color='green'>Remote</font> Property");
        return bd;
    }
