...
public class RelativeTimeEditor extends PropertyEditorSupport implements ChangeListener {
    ...
    private static String[] unitValues = new String[] { "minute(s)", "hour(s)",
            "day(s)", "week(s)", "month(s)", "year(s)" };

    private static int[] unitWeights = new int[] { MIN_IN_MIN, MIN_IN_HOUR,
            MIN_IN_DAY, MIN_IN_WEEK, MIN_IN_MONTH, MIN_IN_YEAR };
	...
	public void setValue(Object value) {
        ...
        this.numberSpinner = new SpinnerNumberModel(relativeTimeInMins.intValue()
