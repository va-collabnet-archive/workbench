...
public class ConfigureCryptBreakerWorkspace extends AbstractTask {
    ...
    public static final String INPUT = "Input paramaters";
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
        ...
        try {
            if (worker.isWorkspaceActive(WORKSPACE_ID) == false) {
                ...
                buff.append(" the master task uses the following user-specified input paramaters: ");
                ...
                buff.append(" initiated, but a master task could manage these paramaters dynamically based on performance of the grid. ");
                ...
                buff.append(" input with the following user-specified input paramaters: ");
                ...
                buff.append("<p>When you have input the desired paramaters, press the \"complete\" button on the \"Input paramaters\" window to initiate the ");
