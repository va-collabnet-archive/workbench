...
public class ProcessBuilderPanel extends JPanel implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                FileDialog f = new FileDialog((Frame) ProcessBuilderPanel.this
                        .getTopLevelAncestor(), "Save Process (.xml)", FileDialog.SAVE);
                ...
                if (f.getFile() != null) {
                	...
                	if (fileName.endsWith(".xml") == false) {
                      ...
                      encoder.setPersistenceDelegate(Date.class, 
                              new DefaultPersistenceDelegate(new String[] {"time"}));
    ...
    private class SaveProcessActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                // Create a file dialog box to prompt for a new file to display
                FileDialog f = new FileDialog((Frame) ProcessBuilderPanel.this
                        .getTopLevelAncestor(), "Save Process (.bp)", FileDialog.SAVE);
                f.setDirectory(System.getProperty("user.dir")
                        + System.getProperty("file.separator") + "processes");
                f.setVisible(true); // Display dialog and wait for response
                if (f.getFile() != null) {
    ...
    private class SaveProcessForLauncherActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                // Create a file dialog box to prompt for a new file to display
                FileDialog f = new FileDialog((Frame) ProcessBuilderPanel.this
                        .getTopLevelAncestor(), "Save Process for Launcher Queue", FileDialog.SAVE);
                f.setDirectory(System.getProperty("user.dir")
                        + System.getProperty("file.separator") + "processes");
                f.setFile(processPanel.getProcess().getProcessID() + "." + UUID.randomUUID()
                        + ".bp");
                f.setVisible(true); // Display dialog and wait for response
                if (f.getFile() != null) {
    ...
    private class ExecuteProcessActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            statusMessage.setText("<html><font color='red'>Executing process: " + 
            		"<font color='blue'>" + processPanel.getProcess().getName());
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run() {
                            ...
                            if (exceptionMessage.equals("")) {
                                ...
                                statusMessage
                                .setText("<html><font color='blue'>Process complete: <font color='red'>" + exceptionMessage);
                            }
                        }
                    });
                }
    ...
    public ProcessBuilderPanel(Configuration jiniConfig, I_Work worker)
        ...
        executeProcessActionListener = new ExecuteProcessActionListener(
                jiniConfig, UUID.randomUUID(), worker);
    ...
    private void setupPropertiesPane() throws RemoteException, IOException,
        ...
        int dividerLocation = splitPane.getDividerLocation();
        propertiesPane = new JTable(new PropertyTableModel(processPanel
                .getProcess()));
    ...
    private JScrollPane setupDataPanel(I_Work worker) throws RemoteException,
