...
public abstract class FixedTerminologyTransferable implements Transferable {
    ...
    public static DataFlavor universalFixedConceptFlavor = new DataFlavor("application/x-java-jvm-local-objectref; class=" +
    ...
    public static DataFlavor universalFixedDescInterfaceFlavor = new DataFlavor("application/x-java-jvm-local-objectref; class=" +
    ...
    public static DataFlavor universalFixedRelInterfaceFlavor = new DataFlavor("application/x-java-jvm-local-objectref; class=" +
