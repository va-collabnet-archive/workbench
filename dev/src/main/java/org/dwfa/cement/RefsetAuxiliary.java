...
public class RefsetAuxiliary implements I_AddToMemoryTermServer {
	...
	public enum Concept implements I_ConceptualizeUniversally {
		REFSET_AUXILIARY(new String[] { "Refset Auxiliary Concept", "Refset Auxiliary Concept"}),
            ...
            TEMPLATE_VALUE_TYPE(new String[] { "template value type", "template value type"}, REFSET_AUXILIARY),
            ...
            TEMPLATE_ATTRIBUTE_DISPLAY_STATUS(new String[] { "template attribute display status", "template attribute display status"}, REFSET_AUXILIARY),
                TEMPLATE_ATTRIBUTE_DISPLAYED(new String[] { "template attribute displayed", "template attribute displayed"}, TEMPLATE_ATTRIBUTE_DISPLAY_STATUS),
                TEMPLATE_ATTRIBUTE_HIDDEN(new String[] { "template attribute hidden", "template attribute hidden"}, TEMPLATE_ATTRIBUTE_DISPLAY_STATUS),
                TEMPLATE_ATTRIBUTE_UNSPECIFIED(new String[] { "template attribute unspecified", "template attribute unspecified"}, TEMPLATE_ATTRIBUTE_DISPLAY_STATUS),
	           ...
	           CTV3_PARTIAL_WORD_KEYS(new String[] { "Clinical Terms Version 3 Partial Word Key","CTV3 parital word key",
	            ...
	            CTV3_TEMPLATE_CARDINALITY(new String[] { "Clinical Terms Version 3 Template Cardinality","template cardinality",
                  ...
                  CTV3_TEMPLATE_SEMANTIC_STATUS(new String[] { "Clinical Terms Version 3 Template Semantic Status","template semantic status",
                                                        ...
                                                        new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                                                                                            REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                  CTV3_TEMPLATE_BROWSE_ATTRIBUTE(new String[] { "Clinical Terms Version 3 Template Browse Attribute","template browse attribute",
                                                                                            "ORG_DWFA_CTV3_TEMPLATE_BROWSE_ATTRIBUTE"}, 
                                                         new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                                                                                             ANCILLARY_DATA, INT_EXTENSION}, 
                                                         new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                                                                                             REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                  CTV3_TEMPLATE_BROWSE_VALUE(new String[] { "Clinical Terms Version 3 Template Browse Value","template browse value",
                                                                                             "ORG_DWFA_CTV3_TEMPLATE_BROWSE_VALUE"}, 
                                                          new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                                                                                              ANCILLARY_DATA, INT_EXTENSION}, 
                                                          new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                                                                                              REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                 CTV3_TEMPLATE_NOTES_SCREEN(new String[] { "Clinical Terms Version 3 Template Notes Screen","template notes screen",
                                                                                              "ORG_DWFA_CTV3_TEMPLATE_NOTES_SCREEN"}, 
                                                           new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                                                                                               ANCILLARY_DATA, INT_EXTENSION}, 
                                                           new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                                                                                               REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                 CTV3_TEMPLATE_DISPLAY_STATUS(new String[] { "Clinical Terms Version 3 Template Display Status","template display status",
                                                                                               "ORG_DWFA_CTV3_TEMPLATE_DISPLAY_STATUS"}, 
                                                            new I_ConceptualizeUniversally [] { REFSET_IDENTITY,
                                                                                                ANCILLARY_DATA, CONCEPT_EXTENSION}, 
                                                            new I_ConceptualizeUniversally [] { ArchitectonicAuxiliary.Concept.IS_A_REL,
                                                                                                REFSET_PURPOSE_REL, REFSET_TYPE_REL}),
                 CTV3_TEMPLATE_CHARACTERISTIC_STATUS(new String[] { "Clinical Terms Version 3 Template Notes Screen","template notes screen",
