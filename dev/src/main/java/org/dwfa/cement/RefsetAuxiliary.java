...
public class RefsetAuxiliary implements I_AddToMemoryTermServer {
	...
	public enum Concept implements I_ConceptualizeUniversally {
		REFSET_AUXILIARY(new String[] { "Refset Auxiliary Concept", "Refset Auxiliary Concept"}),
            ...
            BOOLEAN_CIRCLE_ICONS(new String[] { "boolean with circle icons", "boolean with circle"}, REFSET_AUXILIARY),
            ...
            BOOLEAN_CHECK_CROSS_ICONS(new String[] { "boolean with check and cross icons", "boolean with check and cross"}, REFSET_AUXILIARY),
                BOOLEAN_CHECK_CROSS_ICONS_TRUE(new String[] { "true with check icon", "true with check"}, BOOLEAN_CHECK_CROSS_ICONS),
                BOOLEAN_CHECK_CROSS_ICONS_FALSE(new String[] { "false with cross icon", "false with focrossrbidden"}, BOOLEAN_CHECK_CROSS_ICONS),
