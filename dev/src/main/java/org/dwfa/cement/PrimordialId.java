...
public enum PrimordialId {
	...
	private static int sequenceTest = 0;
	...
	private PrimordialId(int sequenceRelativeId, Collection<UUID> uids) {
		...
		this.uids = uids;
		if (this.sequenceRelativeId != PrimordialId.sequenceTest) {
			throw new IllegalArgumentException("Ids out of sequence: " + 
					this.sequenceRelativeId + " " + 
					PrimordialId.sequenceTest);
		}
		PrimordialId.sequenceTest++;
	}
