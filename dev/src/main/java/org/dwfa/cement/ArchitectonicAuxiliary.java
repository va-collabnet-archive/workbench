        ...
        STATUS("status",
            ...
            ACTIVE("active",
                    ...
                    FLAGGED_FOR_REVIEW("flagged",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    FLAGGED_FOR_DUAL_REVIEW("flagged for dual review",
                                    new I_ConceptualizeUniversally[] { ACTIVE }),
                    DUAL_REVIEWED("dual reviewed",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    RESOLVED_IN_DUAL("resolved in dual",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
               ...
               REASSIGNED("reassigned",
                    ...
                    PROCESSED("processed",
                     ...
                     RESOLVED_IN_DUAL_AND_PROCESSED("resolved in dual and processed",
                           new I_ConceptualizeUniversally[] { PROCESSED }),
                     ADJUDICATED_AND_PROCESSED("adjudicated and processed",
                           new I_ConceptualizeUniversally[] { PROCESSED }),
                    DUPLICATE_PENDING_RETIREMENT("duplicate-pending retirement",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    INTERNAL_USE_ONLY("internal use only",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    DO_NOT_EDIT_INTERNAL_USE("do not edit, for internal use",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    DO_NOT_EDIT_FOR_RELEASE("do not edit, for release",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    FLAGGED_POTENTIAL_DUPLICATE("dup flag",
                            new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
                    FLAGGED_POTENTIAL_REL_ERROR("rel err flag",
                            new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
                    CURRENT_UNREVIEWED("unreviewed",
                                new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
                    CURRENT_TEMP_INTERNAL_USE("temp, internal use only",
                            new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
                    FLAGGED_POTENTIAL_DESC_STYLE_ERROR("desc style flag",
                            new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
            INACTIVE("inactive",
                    new I_ConceptualizeUniversally[] { STATUS }),
