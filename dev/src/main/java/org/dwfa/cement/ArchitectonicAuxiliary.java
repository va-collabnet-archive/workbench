...
public class ArchitectonicAuxiliary implements I_AddToMemoryTermServer {
	...
	public enum Concept implements I_ConceptualizeUniversally {
		...
		RELATIONSHIP("relationship",
			...
			IS_POT_DUP_REL(PrimordialId.IS_A_REL_ID, new String[] {"is-a potential duplicate rel (terminology constant)"},
					new I_ConceptualizeUniversally[] { RELATIONSHIP }),
			IS_NOT_A_DUP_REL(PrimordialId.IS_A_REL_ID, new String[] {"is NOT a dup rel (terminology constant)"},
					new I_ConceptualizeUniversally[] { RELATIONSHIP }),
			IS_A_DUP_REL(PrimordialId.IS_A_REL_ID, new String[] {"is-a dup rel (terminology constant)"},
					new I_ConceptualizeUniversally[] { RELATIONSHIP }),
