...
public class LoadSetLaunchProcessFromAttachmentWithPropBeanInfo extends SimpleBeanInfo {

    /**
     * @see java.beans.BeanInfo#getBeanDescriptor()
     */
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(LoadSetLaunchProcessFromAttachmentWithProp.class);
        bd.setDisplayName("<html><center><font color='blue'>Load, Set, Launch<br>Process From Attachment<br>"
                + " With Prop and Destination");
        return bd;
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor otherPropName = new PropertyDescriptor("otherPropName",
                getBeanDescriptor().getBeanClass());
            otherPropName.setBound(true);
            otherPropName.setPropertyEditorClass(PropertyNameLabelEditor.class);
            otherPropName.setDisplayName("add prop");
            otherPropName.setShortDescription("Include property with process to be launched");
            ...
            PropertyDescriptor rv[] = { processPropName, otherPropName, dataCheckingSuppressed };
            return rv;
