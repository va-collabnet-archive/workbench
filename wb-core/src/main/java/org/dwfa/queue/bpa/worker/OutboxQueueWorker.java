 ...
 * 
 */
public class OutboxQueueWorker extends Worker implements I_GetWorkFromQueue, Runnable {
     ...
     * @throws IOException
     */
    public OutboxQueueWorker(Configuration config, UUID id, String desc, I_SelectProcesses selector)
