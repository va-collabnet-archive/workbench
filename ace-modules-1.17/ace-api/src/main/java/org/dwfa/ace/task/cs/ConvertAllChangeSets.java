...
public class ConvertAllChangeSets extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        ...
        if (rootDirStr.startsWith(ProcessAttachmentKeys.getAttachmentPrefix())) {
            rootDirStr = (String) process.readAttachement(rootDirStr.split(ProcessAttachmentKeys.getAttachmentPrefix())[1]);
        }
