...
public class AddGetWorkFromSelectedQueuePlugin extends AbstractTask {
  ...
  public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
    ...
    try {
      ...
      ServiceItem service = (ServiceItem) worker.selectFromList(services, 
          "Select queue", 
          "Select the queue you want to get work from.");
      if (service == null) {
      ...
      GetWorkFromQueuePlugin getWorkPlugin = new GetWorkFromQueuePlugin(workerToModify, (I_QueueProcesses) service.service,
          new SelectAll());
