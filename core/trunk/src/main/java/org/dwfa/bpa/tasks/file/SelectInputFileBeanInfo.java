...
public class SelectInputFileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            inputFilePropName
                .setDisplayName("<html><font color='blue'>inputFilePropName:");
            inputFilePropName
                .setShortDescription("Name of the property to write the input file name to... ");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Specify<br>Input File");
        return bd;
    }
