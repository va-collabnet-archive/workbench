    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor relativeTimeProp =
                    new PropertyDescriptor("relativeTimeInMins",
                        RemoveFailsafe.class);
            ...
            relativeTimeProp
                .setShortDescription("The deadline by which the failsafe should have removed the failsafe (relative time).");

            PropertyDescriptor failsafeDataId =
                    new PropertyDescriptor("failsafeDataId",
                        RemoveFailsafe.class);
