...
public class ProbabilityEditor implements PropertyEditor, ChangeListener {
	...
	private class EditorComponent extends JPanel {
		...
		public EditorComponent() {
	        ...
	        ProbabilityEditor.this.numberSpinner = new SpinnerNumberModel(0, //initial value
	                0, //min
	                100, //max
	                1); //step
	        ProbabilityEditor.this.numberSpinner.addChangeListener(ProbabilityEditor.this);
	        this.add(new JSpinner(ProbabilityEditor.this.numberSpinner));
		}
	...
	public Integer getValue() {
		return (Integer) this.numberSpinner.getValue();
	}
	...
	public void setValue(Object value) {
        ...
        this.numberSpinner.setValue(intVal);
        this.firePropertyChange();
	}
