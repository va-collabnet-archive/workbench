...
public class CreateEntryRecordTwoCriterionBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor queueTypeTwo =
                    new PropertyDescriptor("queueTypeTwo",
            ...
            queueTypeTwo
                .setShortDescription("The first criterion for the queue to generate the entry record for.");

            PropertyDescriptor queueTypeOne =
                    new PropertyDescriptor("queueTypeOne",
                        CreateEntryRecordTwoCriterion.class);
            ...
            queueTypeOne
                .setShortDescription("The second criterion for the queue to generate the entry record for.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(CreateEntryRecordTwoCriterion.class);
        bd
            .setDisplayName("<html><font color='green'><center>Create Entry Record<br>Two Criterion");
        return bd;
    }
}
