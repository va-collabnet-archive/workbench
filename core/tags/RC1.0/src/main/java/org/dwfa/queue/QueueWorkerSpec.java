...
public class QueueWorkerSpec {
    ...
    public I_GetWorkFromQueue create(Configuration config)
        ...
        if (this.specifiedConfigArgs == null) {
            constructorArgs =
                    new Object[] { config, this.workerId, this.workerName,
                                  this.selector };
        } else {
            Configuration specifiedConfig =
                    ConfigurationProvider.getInstance(this.specifiedConfigArgs);
            constructorArgs =
                    new Object[] { specifiedConfig, this.workerId,
                                  this.workerName, this.selector };
        }
