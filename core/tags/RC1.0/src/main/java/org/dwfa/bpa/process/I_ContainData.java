 ...
 *  
 */
public interface I_ContainData extends I_ManageVetoableProperties,
        I_ManageProperties, Serializable {
    /**
    ...
    public I_SupportDragAndDrop getDragAndDropSupport(String prefix,
