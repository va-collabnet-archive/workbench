...
public interface I_ManageUserTransactions {
    ...
    public void removeUncommittedComponentsListener(
            PropertyChangeListener listener);

    public void commitActiveTransaction() throws TransactionException,
            RemoteException;

    public Transaction getActiveTransaction() throws TransactionException,
            LeaseDeniedException, RemoteException, InterruptedException,
    ...
    public void abortActiveTransaction() throws TransactionException,
            RemoteException;
}
