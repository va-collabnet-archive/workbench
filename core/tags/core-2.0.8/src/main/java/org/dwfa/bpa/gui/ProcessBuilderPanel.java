...
public class ProcessBuilderPanel extends JPanel implements ActionListener {
    ...
    public class SaveProcessForXmlActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                FileDialog f =
                        new FileDialog((Frame) ProcessBuilderPanel.this
                            .getTopLevelAncestor(), "Save Process (.xml)",
                            FileDialog.SAVE);
                ...
                if (f.getFile() != null) {
                    ...
                    XMLEncoder encoder =
                            new XMLEncoder(new BufferedOutputStream(
                                new FileOutputStream(processXmlFile)));
                    encoder.setPersistenceDelegate(BusinessProcess.class,
                        new BusinessProcessPersistenceDelegate());
                    encoder.setPersistenceDelegate(Condition.class,
                        new ConditionPersistenceDelegate());
                    encoder.setPersistenceDelegate(TaskInfo.class,
                        new TaskInfoPersistenceDelegate());
                    encoder
                        .setPersistenceDelegate(Date.class,
    ...
    private static Logger logger =
            Logger.getLogger(ProcessBuilderPanel.class.getName());
    private static LogWithAlerts logWithAlerts =
            new LogWithAlerts(ProcessBuilderPanel.class.getName());
    ...
    private class SaveProcessActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                FileDialog f =
                        new FileDialog((Frame) ProcessBuilderPanel.this
                            .getTopLevelAncestor(), "Save Process (.bp)",
                            FileDialog.SAVE);
                f.setDirectory(System.getProperty("user.dir")
                    + System.getProperty("file.separator") + "processes");
                f.setVisible(true); // Display dialog and wait for response
                if (f.getFile() != null) {
                    ...
                    File processBinaryFile =
                            new File(f.getDirectory(), fileName);
                    FileOutputStream fos =
                            new FileOutputStream(processBinaryFile);
    ...
    private class SaveProcessForLauncherActionListener implements
            ActionListener {
        /**
         * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
         */
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                f.setDirectory(System.getProperty("user.dir")
                    + System.getProperty("file.separator") + "processes");
                f.setFile(processPanel.getProcess().getProcessID() + "."
                    + UUID.randomUUID() + ".bp");
                f.setVisible(true); // Display dialog and wait for response
                if (f.getFile() != null) {
                    File processBinaryFile =
                            new File(f.getDirectory(), f.getFile());
                    FileOutputStream fos =
                            new FileOutputStream(processBinaryFile);
                    BufferedOutputStream bos = new BufferedOutputStream(fos);
                    ObjectOutputStream oos = new ObjectOutputStream(bos);
    ...
    private class ReadProcessActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            FileDialog f =
                    new FileDialog((Frame) ProcessBuilderPanel.this
                        .getTopLevelAncestor(), "Open Process", FileDialog.LOAD);
            f.setDirectory(System.getProperty("user.dir")
                + System.getProperty("file.separator") + "processes");
                ...
                if (f.getFile() != null) {
                    ...
                    if (f.getFile().endsWith(".xml")) {
                        ...
                        I_EncodeBusinessProcess process =
                                (I_EncodeBusinessProcess) d.readObject();
                        d.close();
                        setProcess(process);
                    } else {
                        ...
                        logger
                            .info("Read object: " + obj.getClass().toString());
                        if (MarshalledObject.class.isAssignableFrom(obj
                            .getClass())) {
                            MarshalledObject mo = (MarshalledObject) obj;
                            obj = mo.get();
                        }
                        I_EncodeBusinessProcess process =
                                (I_EncodeBusinessProcess) obj;
                        ois.close();
                        setProcess(process);
    ...
    private class TakeProcessNoTranActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                FileDialog f =
                        new FileDialog((Frame) ProcessBuilderPanel.this
                            .getTopLevelAncestor(), "Open Process",
                            FileDialog.LOAD);
                f.setDirectory(System.getProperty("user.dir")
                    + System.getProperty("file.separator") + "processes");
                f.setFilenameFilter(new FilenameFilter() {
    ...
    private class ExecuteProcessActionListener implements ActionListener {
        ...
        public ExecuteProcessActionListener(Configuration config, UUID id,
                I_Work worker, boolean launchOnly) {
            super();
            this.config = config;
            this.id = id;
            this.worker = worker;
    ...
    private NewProcessActionListener newProcessActionListener =
            new NewProcessActionListener();

    private SaveProcessActionListener saveProcessActionListener =
            new SaveProcessActionListener();

    private ReadProcessActionListener openProcessActionListener =
            new ReadProcessActionListener();

    private TakeProcessNoTranActionListener takeProcessNoTranActionListener =
            new TakeProcessNoTranActionListener();

    private SaveProcessForLauncherActionListener saveProcessForLauncherQueueActionListener =
            new SaveProcessForLauncherActionListener();

    private SaveProcessForXmlActionListener saveProcessForXmlActionListener =
            new SaveProcessForXmlActionListener();
    ...
    private JButton execute =
            new JButton("<html><font color='#006400'>execute");
    ...
    private JLabel statusMessage =
            new JLabel("<HTML><font color='blue'>Process Builder ready...");
    ...
    public ProcessBuilderPanel(Configuration jiniConfig, I_Work worker)
        ...
        taskSplitPane =
                new JSplitPane(JSplitPane.VERTICAL_SPLIT, createTaskTree(),
                    taskScroller);
        taskSplitPane.setDividerLocation(200);

        splitPane =
                new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, taskSplitPane,
                    processPanel);
        ...
        this.statusPanel =
                makeStatusPanel(this.statusMessage, execute, cancel, launch);
        c.weighty = 0;
        c.gridy = 1;
        c.fill = GridBagConstraints.HORIZONTAL;
        this.add(this.statusPanel, c);
        execute.addActionListener(new ExecuteProcessActionListener(jiniConfig,
            UUID.randomUUID(), worker, false));
        launch.addActionListener(new ExecuteProcessActionListener(jiniConfig,
            UUID.randomUUID(), worker, true));
    ...
    private void newProcess() {
        try {
            ...
            BusinessProcess newProcess =
                    new BusinessProcess(processName, Condition.CONTINUE);
     ...
     * @throws IntrospectionException
     */
    private void setupPropertiesPane() throws RemoteException, IOException,
            IntrospectionException {
        int dividerLocation = splitPane.getDividerLocation();
        propertiesPane =
                new JTable(new PropertyTableModel(processPanel.getProcess()));
    ...
    private void updatePropertiesPane() throws RemoteException, IOException,
            IntrospectionException {
        if (this.propertiesPane != null) {
            this.propertiesPane.setModel(new PropertyTableModel(processPanel
                .getProcess()));
        }
    ...
    private JScrollPane createTaskTree() {
        ...
        DefaultMutableTreeNode top =
                new DefaultMutableTreeNode(new FileWrapper(new File(System
                    .getProperty("user.dir"), "tasks")));
        createNodes(top);
        DefaultMutableTreeNode processesNode =
                new DefaultMutableTreeNode(new FileWrapper(new File(System
        ...
        if (children != null) {
            for (int i = 0; i < children.length; i++) {
                DefaultMutableTreeNode childNode =
                        new DefaultMutableTreeNode(new FileWrapper(children[i]));
                top.add(childNode);
    ...
    private void setProcess(I_EncodeBusinessProcess process)
        ...
        // " + process.getName());
        this.statusMessage
            .setText("<html><font color='blue'>Process Builder ready...");
    ...
    private JPanel makeStatusPanel(JLabel statusMessage, JButton execute,
            JButton cancel2, JButton launch2) {
    ...
    private class ActionListenerAdaptor implements ActionListener {
        ChangeToTaskActionListener changeToTask =
                new ChangeToTaskActionListener();

        ChangeToDataActionListener changeToData =
                new ChangeToDataActionListener();

        ChangeToPropActionListener changeToProp =
                new ChangeToPropActionListener();
     ...
     * @throws InvocationTargetException
     */
    private JScrollPane setupTaskPanel() throws ClassNotFoundException,
            IntrospectionException, InvocationTargetException,
     ...
     * @throws IllegalAccessException
     */
    private void createTaskPanelAndAdd(JPanel tasksPanel, GridBagConstraints c,
            I_DefineTask task, File source) throws ClassNotFoundException,
            IntrospectionException, InvocationTargetException,
            IllegalAccessException {
    ...
    private void createDataPanelAndAdd(I_Work worker, JPanel dataPanel,
            GridBagConstraints c, DataContainer container)
            throws PropertyVetoException, Exception {
