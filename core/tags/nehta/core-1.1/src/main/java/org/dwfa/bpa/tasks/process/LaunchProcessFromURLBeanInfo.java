...
public class LaunchProcessFromURLBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><center><font color='blue'>Launch Process<br>From URL");
        return bd;
    }
