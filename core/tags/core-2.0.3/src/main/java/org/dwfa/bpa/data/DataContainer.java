...
public abstract class DataContainer implements I_ContainData {
     ...
     * @param data
     */
    public DataContainer(int id, String description, Serializable data,
            Class elementClass) {
        super();
        this.id = id;
    ...
    public void setDescription(String description) throws PropertyVetoException {
        ...
        this.vetoSupport.fireVetoableChange("description", oldDescription,
            description);
        this.description = description;
        this.changeSupport.firePropertyChange("description", oldDescription,
            this.description);
    }
    ...
    public boolean isCollection() {
        if ((this.data == null)
            || ((Collection.class.isAssignableFrom(this.data.getClass())) == false)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return this.description + " id: " + this.id + " class: "
            + this.elementClass + " data: " + data /* + " bounds: " + bounds */;
    }

    public abstract I_SupportDragAndDrop getDragAndDropSupport(String prefix,
            I_DoDragAndDrop dndComponent, boolean allowDrop, boolean allowDrag)
            throws ClassNotFoundException;
