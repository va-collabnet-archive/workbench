...
public class SpecifyOutputFileCancelOrContinueBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SpecifyOutputFileCancelOrContinue.class);
        bd.setDisplayName("<html><font color='green'><center>Specify<br>Output File<br>with cancel/continue");
        return bd;
    }
