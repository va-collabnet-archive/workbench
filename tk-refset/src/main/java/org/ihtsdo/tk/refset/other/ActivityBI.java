 ...
 */
package org.ihtsdo.tk.refset.other;
...
//TODO: determine what should remain when implementing

public interface ActivityBI extends ActionListener {
    ...
    public void addShowActivityListener(ActivityBI listener);

    public void removeShowActivityListener(ActivityBI listener);
