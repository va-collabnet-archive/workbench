...
public class PlatformWebBrowser {
    ...
    private static class OpenMacWebBrowser implements I_OpenURL {
        ...
        public OpenMacWebBrowser() throws Exception {
            ...
            fileManagerObj =
                    fileManagerClass.getConstructor(new Class[] {})
                        .newInstance();
            openUrlMethod =
                    fileManagerClass.getDeclaredMethod("openURL", defArgs);
    ...
    private static class DesktopOpener implements I_OpenURL {
        ...
        public DesktopOpener() throws ClassNotFoundException,
            ...
            Method getDesktopMethod =
                    desktopClass.getMethod("getDesktop", new Class[] {});
            desktopObject = getDesktopMethod.invoke(null);

            browseMethod =
                    desktopObject.getClass().getMethod("browse",
        ...
        public boolean openURL(URL url) {
            ...
            try {
                browseMethod
                    .invoke(desktopObject, new Object[] { url.toURI() });
                return true;
            } catch (Exception e) {
