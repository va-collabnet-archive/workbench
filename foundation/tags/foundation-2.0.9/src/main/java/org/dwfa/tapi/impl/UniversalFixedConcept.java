...
public class UniversalFixedConcept implements I_ConceptualizeUniversally {
	...
	public Collection<I_ConceptualizeUniversally> getDestRelConcepts(I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
	...
	public Collection<I_ConceptualizeUniversally> getDestRelConcepts(Collection<I_ConceptualizeUniversally> types, I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
		Collection<I_ConceptualizeUniversally> results = new ArrayList<I_ConceptualizeUniversally>();
	...
	public Collection<I_RelateConceptsUniversally> getDestRels(Collection<I_ConceptualizeUniversally> types, I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
	...
	public Collection<I_RelateConceptsUniversally> getSourceRels(Collection<I_ConceptualizeUniversally> types, I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
	...
	public Collection<I_ConceptualizeUniversally> getSrcRelConcepts(I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
		Collection<I_ConceptualizeUniversally> results = new ArrayList<I_ConceptualizeUniversally>();
	...
	public Collection<I_ConceptualizeUniversally> getSrcRelConcepts(Collection<I_ConceptualizeUniversally> types, I_StoreUniversalFixedTerminology termStore) throws IOException, TerminologyException {
		Collection<I_ConceptualizeUniversally> results = new ArrayList<I_ConceptualizeUniversally>();
		for (I_RelateConceptsUniversally r: termStore.getDestRels(this)) {
			if (types.contains(r.getRelType())) {
				results.add(r.getC1());
