...
public class Type5UuidFactory {
    ...
    public static UUID PATH_ID_FROM_FS_DESC =
            UUID.fromString("5a2e7786-3e41-11dc-8314-0800200c9a66");

    public static UUID OPCS_CONCEPT_ID =
            UUID.fromString("26854022-8bd0-11dc-8314-0800200c9a66");
    public static UUID OPCS_DESC_ID =
            UUID.fromString("26854023-8bd0-11dc-8314-0800200c9a66");
    public static UUID OPCS_REL_ID =
            UUID.fromString("26854024-8bd0-11dc-8314-0800200c9a66");
    ...
    public static UUID ICD10AM_CONCEPT_ID =
            UUID.fromString("fc5b4274-98a2-11dc-b260-b51f56d89593");
    public static UUID ICD10AM_DESC_ID =
            UUID.fromString("fc5b4275-98a2-11dc-b260-b51f56d89593");
    public static UUID ICD10AM_REL_ID =
            UUID.fromString("fc5b4276-98a2-11dc-b260-b51f56d89593");
    ...
    public static UUID get(String name) throws NoSuchAlgorithmException,
