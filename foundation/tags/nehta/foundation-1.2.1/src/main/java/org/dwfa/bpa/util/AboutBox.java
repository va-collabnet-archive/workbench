...
public class AboutBox {
    ...
    private static JDialog _about_box;
    ...
    private static JDialog setupAbout(JFrame parent) {
        ...
        if (_about_box == null) {
            ...
            if (System.getProperty("org.dwfa.AboutBoxTitle") != null
                ...
                title =
                        removeQuotes(System
                            .getProperty("org.dwfa.AboutBoxTitle"));
            }
            ...
            if (System.getProperty("org.dwfa.AboutBoxGraphic") != null
                ...
                graphic =
                        removeQuotes(System
                            .getProperty("org.dwfa.AboutBoxGraphic"));
            }
    ...
    public static void setAboutBox(JDialog aboutBox) {
        _about_box = aboutBox;
    }
}
