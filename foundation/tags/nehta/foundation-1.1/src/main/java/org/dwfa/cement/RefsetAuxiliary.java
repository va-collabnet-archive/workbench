	...
	public enum Concept implements I_ConceptualizeUniversally {
		REFSET_AUXILIARY(new String[] { "Refset Auxiliary Concept", "Refset Auxiliary Concept"}),
			...
			REFSET_PURPOSE(new String[] { "refset purpose", "refset purpose"}, REFSET_AUXILIARY),
                ANNOTATION_PURPOSE(new String[] { "annotation purpose", "annotation purpose"}, REFSET_PURPOSE),
...
//
               ...
               CTV3_CROSS_MAP(new String[] { "Clinical Terms Version 3 Cross Map","CTV3 cross map",
                ...
                REFSET_PATH_NAMESPACE_ID(new String[] { "Path namespace identifier reference set", "Path namespace identifier reference set" }, 
                    new I_ConceptualizeUniversally[] { REFSET_IDENTITY, CONCEPT_STRING_EXTENSION }, 
                    new I_ConceptualizeUniversally[] { ArchitectonicAuxiliary.Concept.IS_A_REL, REFSET_TYPE_REL }),
