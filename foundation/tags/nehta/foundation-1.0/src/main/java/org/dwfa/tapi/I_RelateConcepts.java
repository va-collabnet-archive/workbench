...
public interface I_RelateConcepts {
    ...
    public I_Conceptualize getCharacteristic() throws IOException,
            TerminologyException;

    public I_Conceptualize getRefinability() throws IOException,
            TerminologyException;

    public I_Conceptualize getRelType() throws IOException,
            TerminologyException;
