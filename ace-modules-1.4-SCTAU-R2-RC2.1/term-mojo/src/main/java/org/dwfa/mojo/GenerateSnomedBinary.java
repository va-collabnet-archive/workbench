...
public class GenerateSnomedBinary extends ProcessSnomedSources {
    ...
    public void setup() throws IOException {
        ...
        FileOutputStream con_fos = new FileOutputStream(new File(getOutputDirectory(), "sct_concepts"));
        BufferedOutputStream con_bos = new BufferedOutputStream(con_fos);
        con_dos = new DataOutputStream(con_bos);
        FileOutputStream desc_fos = new FileOutputStream(new File(getOutputDirectory(), "sct_descriptions"));
        BufferedOutputStream desc_bos = new BufferedOutputStream(desc_fos);
        desc_dos = new DataOutputStream(desc_bos);
        FileOutputStream rel_fos = new FileOutputStream(new File(getOutputDirectory(), "sct_relationships"));
    ...
    public void writeRelationship(Date releaseDate, long relID, long conceptOneID, long relationshipTypeConceptID,
            long conceptTwoID, long characteristic, long refinability, int group) throws IOException {
    ...
    public void writeDescription(Date releaseDate, long descriptionId, int status, long conceptId, String text,
            int capStatus, int typeInt, String lang) throws IOException {
