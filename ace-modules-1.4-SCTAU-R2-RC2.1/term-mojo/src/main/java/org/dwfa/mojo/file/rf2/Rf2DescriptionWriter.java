...
public class Rf2DescriptionWriter extends GenericFileWriter<Rf2DescriptionRow> {

    public Rf2DescriptionWriter(File file) throws IOException {
        newLineChars = "\r\n";

        open(file, false);
        writeHeader(new Rf2DescriptionRow().getHeader());
    }
     ...
     */
    @Override
    protected String serialize(Rf2DescriptionRow descriptionRow) throws IOException,
