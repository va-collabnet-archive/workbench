...
/**
 * The SetPropertiesToUserInfoBeanInfo class describes the visible elements of the 
 * Workflow task SetPropertiesToUserInfo so that it can be displayed in the Process Builder. 
 * The SetPropertiesToUserInfo class takes the name of the working profile for the current 
 * process and sets the associated username and FullName attributes as properties of the 
 * current process.
 * 
 * @author  Perry Reid
...
public class SetPropertiesToUserInfoBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            profilePropName
                .setShortDescription("The property that will contain the profile.");
            ...
            usernamePropName
                .setShortDescription("The property that contains the user's username.");
