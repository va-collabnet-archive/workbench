...
public class CreateRefsetMetaDataTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            newRefsetUUIDPropName =
                    new PropertyDescriptor("newRefsetUUIDPropName",
                        getBeanDescriptor().getBeanClass());
            newRefsetUUIDPropName.setBound(true);
            newRefsetUUIDPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            newRefsetUUIDPropName
                .setDisplayName("<html><font color='green'>refset UUID:");
            newRefsetUUIDPropName
                .setShortDescription("The property to put the refset UUID into.");

            PropertyDescriptor newRefsetSpecUUIDPropName;
            newRefsetSpecUUIDPropName =
                    new PropertyDescriptor("newRefsetSpecUUIDPropName",
                        getBeanDescriptor().getBeanClass());
            newRefsetSpecUUIDPropName.setBound(true);
            newRefsetSpecUUIDPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            newRefsetSpecUUIDPropName
                .setDisplayName("<html><font color='green'>refset spec UUID:");
            newRefsetSpecUUIDPropName
                .setShortDescription("The property to put the refset spec UUID into.");
            ...
            editorUuidPropName
                .setShortDescription("The property to put the editor UUID into.");

            PropertyDescriptor rv[] =
                    { newRefsetPropName, newRefsetUUIDPropName,
                     newRefsetSpecUUIDPropName, statusTermEntry,
