    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor iconResource =
                    new PropertyDescriptor("iconResource", getBeanDescriptor()
                        .getBeanClass());
            iconResource.setBound(true);
            iconResource.setPropertyEditorClass(JTextFieldEditor.class);
            iconResource
                .setDisplayName("<html><font color='green'>Signpost toggle icon");
            iconResource
                .setShortDescription("Set the signpost toggle icon from classpath resource.<br><br>"
