...
public class AddAllowedStatusToProfileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor allowedStatus =
                    new PropertyDescriptor("allowedStatus", getBeanDescriptor()
                        .getBeanClass());
            ...
            allowedStatus
                .setShortDescription("The concept to add to the profile as an allowed status.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>add allowed status<br>to profile");
        return bd;
    }
}
