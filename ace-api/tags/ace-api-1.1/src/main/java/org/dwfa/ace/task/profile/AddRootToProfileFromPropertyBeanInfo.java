...
public class AddRootToProfileFromPropertyBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rootPropName =
                    new PropertyDescriptor("rootPropName", getBeanDescriptor()
                        .getBeanClass());
            ...
            rootPropName
                .setShortDescription("The property that contains the concept to add to the profile as a root.");

            PropertyDescriptor rv[] = { profilePropName, rootPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(AddRootToProfileFromProperty.class);
        bd
            .setDisplayName("<html><font color='green'><center>add root<br>to profile<br>from property");
        return bd;
    }
