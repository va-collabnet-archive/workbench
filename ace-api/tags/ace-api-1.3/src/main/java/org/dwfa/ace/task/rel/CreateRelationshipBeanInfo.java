...
public class CreateRelationshipBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor relParentPropName =
                    new PropertyDescriptor("relParentPropName",
                        CreateRelationship.class);
            relParentPropName.setBound(true);
            relParentPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            relParentPropName
                .setDisplayName("<html><font color='green'>Rel parent:");
            relParentPropName
                .setShortDescription("The property containing the new parent value for the relationship.");
            ...
            activeConceptPropName
                .setShortDescription("Name of the property containing the concept to add the rel to. ");
            ...
            relType
                .setShortDescription("The relationship type for the new relationship.");

            PropertyDescriptor relCharacteristic =
                    new PropertyDescriptor("relCharacteristic",
                        CreateRelationship.class);
            relCharacteristic.setBound(true);
            relCharacteristic.setPropertyEditorClass(QueueTypeEditor.class);
            relCharacteristic.setDisplayName("Rel characteristic:");
            relCharacteristic
                .setShortDescription("The characteristic for the new relationship.");

            PropertyDescriptor relRefinability =
                    new PropertyDescriptor("relRefinability",
                        CreateRelationship.class);
            relRefinability.setBound(true);
            relRefinability.setPropertyEditorClass(QueueTypeEditor.class);
            relRefinability.setDisplayName("Rel refinability:");
            relRefinability
                .setShortDescription("The refinability of the new relationship.");

            PropertyDescriptor relStatus =
                    new PropertyDescriptor("relStatus",
                        CreateRelationship.class);
            relStatus.setBound(true);
            relStatus.setPropertyEditorClass(QueueTypeEditor.class);
            relStatus.setDisplayName("Rel status:");
            relStatus
                .setShortDescription("The status of the new relationship.");

            PropertyDescriptor rv[] =
                    { relParentPropName, activeConceptPropName, relType,
                     relCharacteristic, relRefinability, relStatus };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Create Relationship<br>from Selected Parent");
        return bd;
    }
}
