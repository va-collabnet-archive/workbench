...
public class CopyConceptFromViewsInProfileToPathWithStatusBeanInfo extends
        SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    CopyConceptFromViewsInProfileToPathWithStatus.class);
        bd
            .setDisplayName("<html><font color='green'><center>copy concept to path<br>from views in profile<br>with status");
        return bd;
    }
}
