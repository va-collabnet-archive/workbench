...
public class NewDefaultProfileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            profilePropName
                .setShortDescription("The property that will contain the profile this task creates.");

            PropertyDescriptor fullNamePropName =
                    new PropertyDescriptor("fullNamePropName",
                        getBeanDescriptor().getBeanClass());
            fullNamePropName.setBound(true);
            fullNamePropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            fullNamePropName
                .setDisplayName("<html><font color='green'>full name prop:");
            fullNamePropName
                .setShortDescription("The property that contains the user's full name.");
            ...
            PropertyDescriptor adminUsernamePropName =
                    new PropertyDescriptor("adminUsernamePropName",
                        getBeanDescriptor().getBeanClass());
            adminUsernamePropName.setBound(true);
            adminUsernamePropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            adminUsernamePropName
                .setDisplayName("<html><font color='green'>admin username prop:");
            adminUsernamePropName
                .setShortDescription("The property that contains the admin username.");

            PropertyDescriptor adminPasswordPropName =
                    new PropertyDescriptor("adminPasswordPropName",
                        getBeanDescriptor().getBeanClass());
            adminPasswordPropName.setBound(true);
            adminPasswordPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            adminPasswordPropName
                .setDisplayName("<html><font color='green'>admin password prop:");
            adminPasswordPropName
                .setShortDescription("The property that contains the admin password.");

            PropertyDescriptor rv[] =
                    { profilePropName, fullNamePropName, usernamePropName,
                     passwordPropName, adminUsernamePropName,
                     adminPasswordPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>new default profile");
        return bd;
    }
}
