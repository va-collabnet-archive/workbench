...
public class AceLogWithAlerts extends LogWithAlerts {
    ...
    public void nonModalAlertAndLogException(Component parent, Throwable ex) {
        nonModalAlertAndLogException(parent, Level.SEVERE, ex
            .getLocalizedMessage(), ex);
    }

    public void nonModalAlertAndLogException(Throwable ex) {
        nonModalAlertAndLogException(null, Level.SEVERE, ex
            .getLocalizedMessage(), ex);
    }

    public void nonModalAlertAndLogException(Level level, String message,
            Throwable ex) {
        nonModalAlertAndLogException(null, level, message, ex);
    }

    public void nonModalAlertAndLogException(Component parent, Level level,
		...
		if (AceEditor.getAceFrames() != null) {
