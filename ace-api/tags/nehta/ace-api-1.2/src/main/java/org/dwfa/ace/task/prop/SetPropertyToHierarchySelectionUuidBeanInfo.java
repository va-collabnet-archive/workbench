...
public class SetPropertyToHierarchySelectionUuidBeanInfo extends SimpleBeanInfo {
        ...
        try {
            PropertyDescriptor propName =
                    new PropertyDescriptor("propName",
                        SetPropertyToHierarchySelectionUuid.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(SetPropertyToHierarchySelectionUuid.class);
        bd
            .setDisplayName("<html><font color='green'><center>Set Property<br>to Hierarchy Selection UUID");
        return bd;
    }
