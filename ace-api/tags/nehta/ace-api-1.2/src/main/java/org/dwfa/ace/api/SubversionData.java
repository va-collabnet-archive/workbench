    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj instanceof SubversionData) {
            ...
            if ((object.password.equals(this.password)
                ...
                && executeHandleNull(object.readOnlyUrlMirrors, this.readOnlyUrlMirrors, containsAll)
                && executeHandleNull(this.readOnlyUrlMirrors, object.readOnlyUrlMirrors, containsAll))) {
