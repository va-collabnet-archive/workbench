...
public class NewPathBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            profilePropName
                .setShortDescription("The property containing the profile which will be set to view and edit the newly created path. Leave blank to ignore.");
            ...
            PropertyDescriptor newConceptPropName =
                    new PropertyDescriptor("newConceptPropName",
                        getBeanDescriptor().getBeanClass());
            newConceptPropName.setBound(true);
            newConceptPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            newConceptPropName
                .setDisplayName("<html><font color='green'>new path concept property:");
            newConceptPropName
                .setShortDescription("The property which will be set to contain the new path concept");

            PropertyDescriptor rv[] =
                    { parentPathTermEntry, profilePropName, pathDescription,
                     newConceptPropName };
            return rv;
