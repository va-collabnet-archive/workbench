...
public class GetAddressesAndPositionsAndChangeStatusFromConceptStatusChangesBeanInfo
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor statusValuePropName =
                    new PropertyDescriptor("statusValuePropName",
                        getBeanDescriptor().getBeanClass());
            statusValuePropName.setBound(true);
            statusValuePropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            statusValuePropName
                .setDisplayName("<html><font color='green'>new status prop:");
            statusValuePropName
                .setShortDescription("The property name containing the new status for the concepts.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    GetAddressesAndPositionsAndChangeStatusFromConceptStatusChanges.class);
        bd
            .setDisplayName("<html><font color='green'><center>get addresses<br>and positions<br>and change status<br>from status changes");
        return bd;
    }
