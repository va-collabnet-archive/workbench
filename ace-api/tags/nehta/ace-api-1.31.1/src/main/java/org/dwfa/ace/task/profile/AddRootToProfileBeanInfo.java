...
public class AddRootToProfileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rootEntry =
                    new PropertyDescriptor("rootEntry", getBeanDescriptor()
                        .getBeanClass());
            ...
            rootEntry
                .setShortDescription("The concept to add to the profile as a root.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>add root<br>to profile");
        return bd;
    }
}
