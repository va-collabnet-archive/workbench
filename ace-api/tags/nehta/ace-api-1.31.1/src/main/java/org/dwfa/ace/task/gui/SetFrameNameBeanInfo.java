...
public class SetFrameNameBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor newFrameName =
                    new PropertyDescriptor("newFrameName", getBeanDescriptor()
                        .getBeanClass());
            ...
            newFrameName
                .setShortDescription("Enter the name for the new frame.");

            PropertyDescriptor rv[] = { profilePropName, newFrameName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Set Frame<br>Name");
        return bd;
    }
}
