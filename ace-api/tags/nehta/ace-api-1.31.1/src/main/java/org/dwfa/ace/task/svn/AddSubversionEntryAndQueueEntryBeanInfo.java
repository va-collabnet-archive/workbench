...
public class AddSubversionEntryAndQueueEntryBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(AddSubversionEntryAndQueueEntry.class);
        bd
            .setDisplayName("<html><font color='green'><center>add subversion entry<br>and queue entry<br>from selected directory");
        return bd;
    }
}
