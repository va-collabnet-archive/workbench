...
public class SetEditPathFromPropertyBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor editPathConceptPropName =
                    new PropertyDescriptor("editPathConceptPropName",
                        getBeanDescriptor().getBeanClass());
            editPathConceptPropName.setBound(true);
            editPathConceptPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            editPathConceptPropName
                .setDisplayName("<html><font color='green'>editing path prop:");
            editPathConceptPropName
                .setShortDescription("The property name that contains the editing path.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>add edit path<br>from property");
        return bd;
    }
}
