...
public interface I_PluginToConceptPanel extends Comparable<I_PluginToConceptPanel>, Serializable {
    ...
    /**
     * A plugin can have zero or more controls that it wishes to make available to the 
     * toggle bar. Each component should also have appropriate tool tips set to explain
	...
	/**
	 * @param l A listener that wants to be notified when the component should be 
	...
	/**
	 * @return true or false depending on if the component is currently shown or not.
	 */
	...
	/**
	 * 
	 * @param listener A component that responds to the current selection for the purposes
    ...
    /**
     * If two plugins have the same sequence, the sort order of the identifier will 
     * be used when comparing to ensure that two plugins with equal sequence numbers
    ...
    /**
     * 
     * @param name A name for the plugin appropriate to the developer and end-user. 
     */
