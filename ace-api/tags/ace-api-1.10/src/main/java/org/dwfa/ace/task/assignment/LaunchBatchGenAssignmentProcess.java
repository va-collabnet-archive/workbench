...
/**
 * Task which launches the batched uuid list of list to the selected assignee process to the assignment 
	...
	public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
        ...
        try {
            ...
            worker.getLogger().info("temporaryListList: " + temporaryListList);
          	...
          	launchAssignment(process, worker, processFileStr, assignmentProcessFileNameStr, assigneeStr, temporaryListList);
