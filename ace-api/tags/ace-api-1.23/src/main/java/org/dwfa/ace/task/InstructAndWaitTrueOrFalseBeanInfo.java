...
public class InstructAndWaitTrueOrFalseBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            instruction
                .setShortDescription("Question to present to the user in the workflow panel. ");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(InstructAndWaitTrueOrFalse.class);
        bd
            .setDisplayName("<html><font color='green'><center>Ask and Wait<br>True or False");
        return bd;
    }
}
