...
worker.getLogger().info("Add relationship: " + relTuple.getRelTypeId() + " " + relTuple.getC2Id());
                        rocket.addRelationship(relTuple.getC1Id(), relTuple.getRelTypeId(), relTuple.getC2Id(), relTuple.getGroup());
                    }
                }
