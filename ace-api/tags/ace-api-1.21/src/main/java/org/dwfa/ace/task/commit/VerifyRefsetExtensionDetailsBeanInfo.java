...
public class VerifyRefsetExtensionDetailsBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] =
                    { showAlertOnFailure, forCommit, profilePropName,
                     componentPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(VerifyRefsetExtensionDetails.class);
        bd
            .setDisplayName("<html><font color='green'><center>Verify<br>Refset Details");
        return bd;
    }
}//End class 
