    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor relTypeTerm =
                    new PropertyDescriptor("relTypeTerm", getBeanDescriptor()
                        .getBeanClass());
            ...
            relTypeTerm
                .setShortDescription("The concept to test for type is kind of.");

            PropertyDescriptor relRestrictionTerm =
                    new PropertyDescriptor("relRestrictionTerm",
                        getBeanDescriptor().getBeanClass());
            relRestrictionTerm.setBound(true);
            relRestrictionTerm.setPropertyEditorClass(ConceptLabelEditor.class);
            relRestrictionTerm
                .setDisplayName("<html><font color='green'>restriction kind:");
            relRestrictionTerm
                .setShortDescription("The concept to test for restriction is kind of.");
