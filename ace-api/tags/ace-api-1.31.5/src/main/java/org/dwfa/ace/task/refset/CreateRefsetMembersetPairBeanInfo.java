...
public class CreateRefsetMembersetPairBeanInfo extends SimpleBeanInfo {
        ...
        try {
            PropertyDescriptor propName =
                    new PropertyDescriptor("propName",
                        CreateRefsetMembersetPair.class);
            ...
            PropertyDescriptor altIsAUuid =
                    new PropertyDescriptor("altIsA",
                        CreateRefsetMembersetPair.class);
            altIsAUuid.setBound(true);
            altIsAUuid.setPropertyEditorClass(PropertyNameLabelEditor.class);
            altIsAUuid
                .setDisplayName("<html><font color='green'>Alt IS_A (optional):");
            altIsAUuid
                .setShortDescription("An alternate 'is a' relationship UUID (default = SNOMED 'Is a')");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Create New<br>Refset/Memberset pair");
        return bd;
    }
