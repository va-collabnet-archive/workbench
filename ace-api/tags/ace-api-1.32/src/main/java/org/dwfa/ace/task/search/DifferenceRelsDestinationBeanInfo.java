...
public class DifferenceRelsDestinationBeanInfo extends
        AbstractSearchTestBeanInfo {
    private static DifferenceRelsDestinationSearchInfo searchInfo =
            new DifferenceRelsDestinationSearchInfo();
