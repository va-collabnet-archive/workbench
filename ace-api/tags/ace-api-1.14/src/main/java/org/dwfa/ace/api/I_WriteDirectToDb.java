...
public interface I_WriteDirectToDb {
     ...
     * @throws IOException
     */
    public I_GetConceptData newConceptBypassCommit(int conceptNid)
            throws IOException;
     ...
     * @throws IOException
     */
    public I_DescriptionVersioned newDescriptionBypassCommit(
            int descriptionNid, int conceptNid) throws IOException;
