...
public class RemoveListViewConceptsFromRefsetBeanInfo extends SimpleBeanInfo {
        ...
        try {
            componentPropName =
                    new PropertyDescriptor("componentPropName",
                        RemoveListViewConceptsFromRefset.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(RemoveListViewConceptsFromRefset.class);
        bd
            .setDisplayName("<html><font color='green'><center>Retire list view concepts<br>from specified refset<br>");
        return bd;
    }
}
