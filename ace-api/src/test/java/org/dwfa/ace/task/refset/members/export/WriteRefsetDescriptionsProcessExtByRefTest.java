...
public final class WriteRefsetDescriptionsProcessExtByRefTest {
    ...
    public void shouldProcessMultipleSuppliedReferenceSets() throws Exception {
        List<I_ThinExtByRefVersioned> refsetList = Arrays.asList(mockControl.createMock(I_ThinExtByRefVersioned.class),
            mockControl.createMock(I_ThinExtByRefVersioned.class),
            mockControl.createMock(I_ThinExtByRefVersioned.class));
        ...
        for (I_ThinExtByRefVersioned refset : refsetList) {
    ...
    private void expectThatRefsetsAreWritten(final I_ThinExtByRefVersioned mockRefset, final int refsetId,
