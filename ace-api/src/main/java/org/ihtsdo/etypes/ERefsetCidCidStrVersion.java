...
public class ERefsetCidCidStrVersion extends EVersion {
    ...
    public ERefsetCidCidStrVersion(DataInput in) throws IOException, ClassNotFoundException {
        super();
        readExternal(in);
    }

    public ERefsetCidCidStrVersion(I_ThinExtByRefPartConceptConceptString part) throws TerminologyException,
            IOException {
    ...
    public boolean equals(Object obj) {
        if (obj == null)
            return false;
        if (ERefsetCidCidStrVersion.class.isAssignableFrom(obj.getClass())) {
            ERefsetCidCidStrVersion another = (ERefsetCidCidStrVersion) obj;
