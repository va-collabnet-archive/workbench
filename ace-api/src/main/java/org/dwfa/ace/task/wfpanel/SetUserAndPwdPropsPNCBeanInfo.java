...
public class SetUserAndPwdPropsPNCBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(SetUserAndPwdPropsPNC.class);
		bd
				.setDisplayName("<html><font color='green'><center>Set Props for<br>User and Pwd<br>Prev, Next, or Cancel");
		return bd;
	}
