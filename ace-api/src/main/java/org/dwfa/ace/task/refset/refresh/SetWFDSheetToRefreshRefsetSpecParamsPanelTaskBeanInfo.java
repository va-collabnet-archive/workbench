...
/**
 * The SetWFDSheetToRefreshRefsetSpecParamsPanelTaskBeanInfo class describes the
 * visible elements of the
 * Workflow task SetWFDSheetToRefreshRefsetSpecParamsPanelTask so that it can be
 * displayed in the
 * Process Builder.
 * 
 * @author Perry Reid
...
public class SetWFDSheetToRefreshRefsetSpecParamsPanelTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            editorInboxPropName = new PropertyDescriptor("editorInboxPropName", getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] = { profilePropName, editorInboxPropName, commentsPropName, refsetUuidPropName,
                                       editorUuidPropName, ownerUuidPropName, fileAttachmentsPropName };
