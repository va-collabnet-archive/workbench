...
public class LaunchBatchGenAssignmentProcessFromAttachmentBeanInfo extends
        SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor proccessToLaunchPropName =
                    new PropertyDescriptor("proccessToLaunchPropName",
                        getBeanDescriptor().getBeanClass());
            proccessToLaunchPropName.setBound(true);
            proccessToLaunchPropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            proccessToLaunchPropName
                .setDisplayName("<html><font color='green'>Process to launch:");
            proccessToLaunchPropName
                .setShortDescription("Process to launch that will generate the assignments. Process is a marshalled object stored as a process attachment or property");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(
                    LaunchBatchGenAssignmentProcessFromAttachment.class);
        bd
            .setDisplayName("<html><font color='green'><center>Launch Generate <br>Assignment Process<br>From Attachment");
        return bd;
    }
