...
public class SetTodoAddressFromUuidTaskBeanInfo extends SimpleBeanInfo {

    /**
     *
     */
    public SetTodoAddressFromUuidTaskBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetTodoAddressFromUuidTask.class);
        bd.setDisplayName("<html><font color='green'><center>Set todo addr<br>from UUID");
        return bd;
    }
