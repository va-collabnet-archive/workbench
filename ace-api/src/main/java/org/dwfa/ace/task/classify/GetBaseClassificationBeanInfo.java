...
public class GetBaseClassificationBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            fileName
                .setShortDescription("Enter the name of the file from which to load the base classification state.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Get Base Classification");
        return bd;
    }
