...
public class GetPositionSetFromWorkflowDetailsPanelBeanInfo extends
        SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(GetPositionSetFromWorkflowDetailsPanel.class);
        bd
            .setDisplayName("<html><font color='green'><center>Get Position Set<br>From Details Sheet");
        return bd;
    }
}
