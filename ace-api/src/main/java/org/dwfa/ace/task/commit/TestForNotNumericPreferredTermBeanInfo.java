...
/**
 * The <code>TestForNotNumericPreferredTermBeanInfo</code> class represents a
 * BeanInfo helper class for the {@link TestForNotNumericPreferredTerm} Task for
 * use within the Process Builder in ACE.
 * 
