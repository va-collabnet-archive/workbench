...
public class ImportRefsetFromLanguageSubsetFileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor languageSpcificationFileName =
                    new PropertyDescriptor("languageSpcificationFileName",
                        getBeanDescriptor().getBeanClass());
            languageSpcificationFileName.setBound(true);
            languageSpcificationFileName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            languageSpcificationFileName
                .setDisplayName("<html><font color='green'>File name property:");
            languageSpcificationFileName
                .setShortDescription("The property containing the name of the Language Subset file to be imported. ");

            PropertyDescriptor rv[] =
                    { refsetConceptPropName, languageSpcificationFileName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(ImportRefsetFromLanguageSubsetFile.class);
        bd
            .setDisplayName("<html><font color='green'><center>Create Refset from <br> Language Subset File");
        return bd;
    }
