...
/**
 * Task for adding a "relationship characteristic is descendent of"
...
public class RelationshipCharacteristicIsDescendentOf extends AddStructuralQueryToRefsetSpec {
    /**
	 * 
	 */
    ...
    protected int getStructuralQueryTokenId() throws IOException, TerminologyException {
        return RefsetAuxiliary.Concept.REL_CHARACTERISTIC_IS_DESCENDENT_OF.localize().getNid();
    }
