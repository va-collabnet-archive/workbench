...
/**
 * The SetWFDSheetToSnomedVersionPanelTaskBeanInfo class describes the visible
 * elements of the
 * Workflow task SetWFDSheetToSnomedVersionPanelTask so that it can be displayed
 * in the
 * Process Builder.
 * 
 * @author Perry Reid
...
public class SetWFDSheetToSnomedVersionPanelTaskBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = { profilePropName, snomedVersionPropName };
