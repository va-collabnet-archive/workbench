...
public class CreateUserPathAndQueuesBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor commitProfilePropName =
                    new PropertyDescriptor("commitProfilePropName",
                        getBeanDescriptor().getBeanClass());
            commitProfilePropName.setBound(true);
            commitProfilePropName
                .setPropertyEditorClass(PropertyNameLabelEditor.class);
            commitProfilePropName
                .setDisplayName("<html><font color='green'>commit profile prop:");
            commitProfilePropName
                .setShortDescription("The property that contains the commit profile.");
            ...
            PropertyDescriptor rv[] =
                    { commitProfilePropName, profilePropName,
                     positionSetPropName, errorsAndWarningsPropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd
            .setDisplayName("<html><font color='green'><center>Create User Path,<br>User Concept, <br>and User Queues");
        return bd;
    }
}
