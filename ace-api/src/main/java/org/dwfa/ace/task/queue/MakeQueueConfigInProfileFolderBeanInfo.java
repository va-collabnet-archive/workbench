...
public class MakeQueueConfigInProfileFolderBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            profileDir
                .setShortDescription("The profile directory to write the queue config file to.");

            PropertyDescriptor queueFolderName =
                    new PropertyDescriptor("queueFolderName",
                        getBeanDescriptor().getBeanClass());
            queueFolderName.setBound(true);
            queueFolderName
                .setPropertyEditorClass(JTextFieldEditorOneLine.class);
            queueFolderName
                .setDisplayName("<html><font color='green'>queue dir:");
            queueFolderName
                .setShortDescription("The directory name for the queue inside the user's profile dir.");
            ...
            PropertyDescriptor template =
                    new PropertyDescriptor("template", getBeanDescriptor()
                        .getBeanClass());
            ...
            template
                .setShortDescription("The template that the queue.config file will be based upon.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd =
                new BeanDescriptor(MakeQueueConfigInProfileFolder.class);
        bd
            .setDisplayName("<html><font color='green'><center>make queue config<br>in profile folder");
        return bd;
    }
}
