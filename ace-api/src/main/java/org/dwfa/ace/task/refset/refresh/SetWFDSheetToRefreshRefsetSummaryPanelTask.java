 ...
 * PanelRefreshSummary
 * panel where the user will be asked to review a number of fields before
 * proceeding.
 * 
 * @author Perry Reid
...
public class SetWFDSheetToRefreshRefsetSummaryPanelTask extends AbstractTask {
    ...
    private void doRun(final I_EncodeBusinessProcess process, final I_Work worker) {
        ...
        try {
            ...
            // ----------------------------------------------------------------------------------
            // Initialize the fields on this newPanel with the values from the
            // properties
            // ----------------------------------------------------------------------------------
            ...
            try {
                ...
                Set<UniversalAcePosition> universalPositions = (Set<UniversalAcePosition>) process.getProperty(refsetSpecVersionPropName);
            ...
            // ----------------------------------------------------------------------------------
            // Format the data retrieved above into an HTML String for display
            // in the
            // Summary panel.
            // ----------------------------------------------------------------------------------
            String summaryMessage = new String("<html>" + "<STYLE type=\"text/css\"> " + "	body { "
                + "		margin-top: 2px; " + "		margin-right: 12px; " + "		margin-bottom: 2px; " + "		margin-left: 12px; "
                + "	} " + "</STYLE> " + "<body bgcolor='rgb(255, 255, 220)'> " + "<h2>Refresh Refset Spec Summary</h2>"
                + "<p>The following parameters have been specified for this " + "business: </p>" + "<ul>"
                + "  <li><strong>Refset Spec: </strong>"
                + refsetSpecName
                + "</li>"
                + "  <li><strong>Refset Spec Version: </strong>"
                + resetSpecVersionName
                + "</li>"
                + "  <li><strong>SNOMED Version: </strong>"
                + snomedVersionName
                + "</li>"
                ...
                + editorName
                + "</li>"
                + "  <li><strong>Process Priority: </strong>"
                + processPriorityText
                + "</li>"
                + "  <li><strong>Process Deadline: </strong>"
                + processDeadlineText
                + "</li>"
                + "  <li><strong>Owner's Comments: </strong>"
                + commentsText
                + "</li>"
                + "  <li><strong>Attached Files: </strong></li>" + "      <ul>");
            ...
            summaryMessage = summaryMessage.concat("</ul>" + "</ul>" + "</body></html>");
