...
/**
 * This task takes a property as input and checks if it null or not.
 * 
 * @author Christine Hill
 * 
 */
@BeanList(specs = { @Spec(directory = "tasks/ide/prop", type = BeanType.TASK_BEAN) })
public class IsPropertyNull extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            Object obj = (Object) process.readProperty(inputPropName);
            if (obj == null) {
