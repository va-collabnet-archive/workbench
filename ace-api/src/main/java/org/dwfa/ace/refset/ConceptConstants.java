...
public class ConceptConstants {
    ...
    public static final ConceptSpec COMPONENT_TYPE = new ConceptSpec("Component type",
        "9fd7ddca-b79f-43eb-a925-c82ed036292d");
    public static final ConceptSpec REFERENCE_SET = new ConceptSpec("Reference set",
        "c4ed4440-9f67-4e0d-99a2-04bc44a1e425");
    public static final ConceptSpec ACCEPTABLE = new ConceptSpec("Acceptable (foundation metadata concept)",
