package org.dwfa.ace.xml.common;
...
public class CommonXMLStatics {
	...
	public static String REFSET_TYPE_BOOL = "Boolean";
	public static String REFSET_TYPE_CON = "Concept";
	public static String REFSET_TYPE_CONCON = "ConceptConcept";
	public static String REFSET_TYPE_CONCONSTR = "ConceptConceptString";
	public static String REFSET_TYPE_CONSTR = "ConceptString";
	public static String REFSET_TYPE_CROSS = "CrossmapForRel";
	public static String REFSET_TYPE_INT = "Integer";
