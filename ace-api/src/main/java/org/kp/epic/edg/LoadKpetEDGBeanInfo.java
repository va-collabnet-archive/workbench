...
public class LoadKpetEDGBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(LoadKpetEDG.class);
        bd.setDisplayName("<html><font color='green'><center>Load KPET EDG");
        return bd;
    }
}
