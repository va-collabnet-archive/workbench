...
public class RelationshipStatement extends RefsetSpecStatement {
    ...
    public RelationshipStatement(boolean useNotQualifier,
            I_GetConceptData queryToken, I_GetConceptData queryConstraint) {
        super(useNotQualifier, queryToken, queryConstraint);
    }

    public boolean execute(I_RelTuple relTuple) throws IOException,
    ...
    public boolean getStatementResult(I_AmTermComponent component)
        ...
        if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_IS_MEMBER_OF.getUids()))) {
            return relationshipIsMemberOf(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_STATUS_IS.getUids()))) {
            return componentStatusIs(relTuple);
        } else if (queryToken
            .equals(termFactory
                .getConcept(RefsetAuxiliary.Concept.REL_STATUS_IS_KIND_OF
                    .getUids()))) {
            return componentStatusIsKindOf(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_TYPE_IS.getUids()))) {
            return relationshipTypeIs(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_TYPE_IS_KIND_OF.getUids()))) {
            return relationshipTypeIsKindOf(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_LOGICAL_QUANTIFIER_IS
                .getUids()))) {
            return relationshipLogicalQuantifierIs(relTuple);
        } else if (queryToken
            .equals(termFactory
                .getConcept(RefsetAuxiliary.Concept.REL_LOGICAL_QUANTIFIER_IS_KIND_OF
                    .getUids()))) {
            return relationshipLogicalQuantifierIsKindOf(relTuple);
        } else if (queryToken
            .equals(termFactory
                .getConcept(RefsetAuxiliary.Concept.REL_CHARACTERISTIC_IS
                    .getUids()))) {
            return relationshipCharacteristicIs(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_CHARACTERISTIC_IS_KIND_OF
                .getUids()))) {
            return relationshipCharacteristicIsKindOf(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_REFINABILITY_IS.getUids()))) {
            return relationshipRefinabilityIs(relTuple);
        } else if (queryToken.equals(termFactory
            .getConcept(RefsetAuxiliary.Concept.REL_REFINABILITY_IS_KIND_OF
                .getUids()))) {
    ...
    private boolean relationshipIsMemberOf(I_RelTuple rel) throws IOException,
            TerminologyException {
    ...
    private boolean relationshipLogicalQuantifierIs(I_RelTuple rel)
            throws TerminologyException {
        throw new TerminologyException("Unimplemented.");
    }

    private boolean relationshipLogicalQuantifierIsKindOf(I_RelTuple rel)
            throws TerminologyException {
        throw new TerminologyException("Unimplemented.");
    }
    ...
    private boolean relationshipCharacteristicIs(I_GetConceptData charType,
            I_RelTuple rel) {
    ...
    private boolean relationshipRefinabilityIs(I_GetConceptData refinability,
            I_RelTuple rel) {
