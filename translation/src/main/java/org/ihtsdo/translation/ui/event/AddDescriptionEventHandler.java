 ...
 */
public abstract class AddDescriptionEventHandler<T> extends EventHandler<AddDescriptionEvent>{
	 ...
	 */
	public AddDescriptionEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(AddDescriptionEvent event);
}
