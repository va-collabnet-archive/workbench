 ...
 */
public abstract class DescriptionSavedEventHandler<T> extends EventHandler<DescriptionSavedEvent>{
	 ...
	 */
	public DescriptionSavedEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(DescriptionSavedEvent event);
}
