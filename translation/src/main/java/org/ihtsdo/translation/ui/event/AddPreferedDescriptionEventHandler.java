 ...
 */
public abstract class AddPreferedDescriptionEventHandler<T> extends EventHandler<AddPreferedDescriptionEvent>{
	 ...
	 */
	public AddPreferedDescriptionEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(AddPreferedDescriptionEvent event);
}
