 ...
 */
public abstract class SelectTargetTermEventHandler<T> extends EventHandler<SelectTargetTermEvent>{
	 ...
	 */
	public SelectTargetTermEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SelectTargetTermEvent event);
}
