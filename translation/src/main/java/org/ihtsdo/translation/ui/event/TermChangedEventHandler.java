 ...
 */
public abstract class TermChangedEventHandler<T> extends EventHandler<TermChangedEvent>{
	 ...
	 */
	public TermChangedEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(TermChangedEvent event);
}
