 ...
 */
public abstract class UpdateTargetDescriptionTableEventHandler<T> extends EventHandler<UpdateTargetDescriptionTableEvent>{
	 ...
	 */
	public UpdateTargetDescriptionTableEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(UpdateTargetDescriptionTableEvent event);
}
