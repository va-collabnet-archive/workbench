 ...
 */
public abstract class SearchDocumentEventHandler<T> extends EventHandler<SearchDocumentEvent>{
	 ...
	 */
	public SearchDocumentEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SearchDocumentEvent event);
}
