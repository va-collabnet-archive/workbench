 ...
 */
public abstract class SendToConceptViewerR1EventHandler<T> extends EventHandler<SendToConceptViewerR1Event>{
	 ...
	 */
	public SendToConceptViewerR1EventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SendToConceptViewerR1Event event);
}
