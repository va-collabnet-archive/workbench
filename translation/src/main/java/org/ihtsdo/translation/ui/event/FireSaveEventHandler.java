 ...
 */
public abstract class FireSaveEventHandler<T> extends EventHandler<FireSaveEvent>{
	 ...
	 */
	public FireSaveEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(FireSaveEvent event);
}
