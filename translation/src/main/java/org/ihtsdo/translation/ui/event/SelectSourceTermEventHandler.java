 ...
 */
public abstract class SelectSourceTermEventHandler<T> extends EventHandler<SelectSourceTermEvent>{
	 ...
	 */
	public SelectSourceTermEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SelectSourceTermEvent event);
}
