 ...
 */
public abstract class ClearDescriptionPanelEventHandler<T> extends EventHandler<ClearDescriptionPanelEvent>{
	 ...
	 */
	public ClearDescriptionPanelEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(ClearDescriptionPanelEvent event);
}
