 ...
 */
public abstract class SendAsAcceptableEventHandler<T> extends EventHandler<SendAsAcceptableEvent>{
	 ...
	 */
	public SendAsAcceptableEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SendAsAcceptableEvent event);
}
