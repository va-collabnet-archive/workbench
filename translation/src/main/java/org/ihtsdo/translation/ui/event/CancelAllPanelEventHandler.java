 ...
 */
public abstract class CancelAllPanelEventHandler<T> extends EventHandler<CancelAllPanelEvent>{
	 ...
	 */
	public CancelAllPanelEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(CancelAllPanelEvent event);
}
