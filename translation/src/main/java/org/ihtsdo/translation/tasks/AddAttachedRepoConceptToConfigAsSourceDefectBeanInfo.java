 ...
 */
public class AddAttachedRepoConceptToConfigAsSourceDefectBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new creates the issue repository bean info.
	 */
	public AddAttachedRepoConceptToConfigAsSourceDefectBeanInfo() {
		super();
	}
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(AddAttachedRepoConceptToConfigAsSourceDefect.class);
		bd.setDisplayName("<html><font color='green'><center>Add attached repo<br>to config<br>as source defect");
		return bd;
	}
