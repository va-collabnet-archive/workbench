...
public class DatabaseExportTest {
    ...
    //This needs to be revisited to retest the snomed database export.
    @Test
    public void thisTestWasDisabledDueToRefactoring() {
...
//
//        Field exportFlag = databaseExport.getClass().getDeclaredField("exportFlag");
//        exportFlag.setAccessible(true);
//        exportFlag.set(databaseExport, "SNOMED");
//
