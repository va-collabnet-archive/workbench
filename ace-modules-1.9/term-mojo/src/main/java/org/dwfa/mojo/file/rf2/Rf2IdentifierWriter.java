 ...
 * @author Ean Dungey
 */
public class Rf2IdentifierWriter extends GenericFileWriter<Rf2IdentifierRow> {

    public Rf2IdentifierWriter(File conceptFile) throws IOException {
        newLineChars = "\r\n";

        open(conceptFile, false);
        writeHeader(new Rf2IdentifierRow().getHeader());
    }
     ...
     */
    @Override
    protected String serialize(Rf2IdentifierRow conceptRow) throws IOException,
