 ...
 */
public class TranslationConceptEditor3old extends JPanel {
	 ...
	 *
	 */
	public TranslationConceptEditor3old() {
	...
	/**
	 * B save comm action performed.
	 */
	private void bSaveCommActionPerformed() {
		I_ConfigAceFrame config=null ;
		if (!txtComm.getText().trim().equals("")){
			try {
				config = Terms.get().getActiveAceFrameConfig();
				...
				String comment = txtComm.getText().trim();
	...
	private void saveDescActionPerformed() {
		...
		try {
			...
			if (descriptionInEditor != null ){ 
				...
				descriptionInEditor.persistChanges();
				ContextualizedDescription fsnDesc= (ContextualizedDescription) LanguageUtil.generateFSN(concept, sourceLangRefsets.iterator().next(), targetLangRefset, 
			...
			//======== splitPane3 ========
			{
				...
				//======== splitPane2 ========
				{
					...
					//======== panel8 ========
					{
						...
						((GridBagLayout)panel8.getLayout()).rowHeights = new int[] {0, 125, 0, 50, 0};
						((GridBagLayout)panel8.getLayout()).columnWeights = new double[] {1.0, 1.0E-4};
						((GridBagLayout)panel8.getLayout()).rowWeights = new double[] {0.0, 0.0, 0.0, 1.0, 1.0E-4};
						...
						//======== panel2 ========
						{
							...
							panel2.setBackground(new Color(220, 233, 249));
							panel2.setLayout(new GridBagLayout());
							((GridBagLayout)panel2.getLayout()).columnWidths = new int[] {0, 0, 0, 0, 5, 0};
							((GridBagLayout)panel2.getLayout()).rowHeights = new int[] {13, 26, 23, 23, 33, 0, 0, 0, 0, 20, 0, 0};
							...
							//======== panel7 ========
							{
								panel7.setBackground(new Color(220, 233, 249));
							...
							//======== panel5 ========
							{
								panel5.setBackground(new Color(220, 233, 249));
							...
							//======== panel4 ========
							{
								panel4.setBackground(new Color(220, 233, 249));
							...
							//======== panel14 ========
							{
								panel14.setBackground(new Color(220, 233, 249));
							...
							panel2.add(button2, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
								new Insets(0, 0, 5, 5), 0, 0));

							//======== panel3 ========
							{
								panel3.setBackground(new Color(220, 233, 249));
							...
							panel2.add(panel3, new GridBagConstraints(3, 6, 1, 1, 0.0, 0.0,
								...
								new Insets(0, 0, 5, 5), 0, 0));
							panel2.add(separator1, new GridBagConstraints(0, 7, 5, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));

							//---- label12 ----
							label12.setText("  Comment:");
							panel2.add(label12, new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							...
							//======== scrollPane8 ========
							{
								...
								//---- txtComm ----
								txtComm.setRows(2);
								scrollPane8.setViewportView(txtComm);
							}
							panel2.add(scrollPane8, new GridBagConstraints(1, 8, 3, 2, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));

							//======== panel1 ========
							{
								panel1.setBackground(new Color(220, 233, 249));
								...
								//---- bSaveComm ----
								bSaveComm.setText("Save Comment");
								bSaveComm.setMnemonic('V');
								bSaveComm.addActionListener(new ActionListener() {
									@Override
									public void actionPerformed(ActionEvent e) {
										bSaveCommActionPerformed();
									}
								});
								panel1.add(bSaveComm, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 0, 5), 0, 0));
							}
							panel2.add(panel1, new GridBagConstraints(3, 10, 1, 1, 0.0, 0.0,
				...
				//======== splitPane1 ========
				{
					...
					//======== tabbedPane2 ========
					{
						...
						tabbedPane2.setMnemonicAt(0, 'O');

						//======== scrollPane10 ========
						{
							scrollPane10.setViewportView(refTable);
						}
						tabbedPane2.addTab("Web References", scrollPane10);
		...
		try {
			...
			if (targetLangRefset!=null){
				...
				for (URL url:urls.keySet()) {
					tableModel.addRow(new Object[] {formatURL(url,"Language refset")});
				}
			}
			...
			for (URL url:urls.keySet()) {
				tableModel.addRow(new Object[] {formatURL(url,"Workflow")});
			}

			refTable.setModel(tableModel);
			TableColumnModel cmodel = refTable.getColumnModel(); 
			TextAreaRenderer textAreaRenderer = new TextAreaRenderer();
			cmodel.getColumn(0).setCellRenderer(textAreaRenderer); 
			refTable.revalidate();
			if (refTable.getRowCount()>0){
				tabbedPane2.setTitleAt(1, "<html>Web references <b><font color='red'>(" + refTable.getRowCount() + ")</font></b></html>");
			}else {
