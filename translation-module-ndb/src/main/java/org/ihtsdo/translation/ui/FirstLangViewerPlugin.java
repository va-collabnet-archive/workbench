 ...
 */
public class FirstLangViewerPlugin extends AbstractPlugin {
	 ...
	 */
	public FirstLangViewerPlugin(boolean selectedByDefault, int sequence, TOGGLES orderLangViewerPanel) {
