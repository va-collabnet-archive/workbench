...
public class ConfigTranslationModule implements Serializable {
 ...
 WORDS_LIST("Words list");
		...
		/**
		 * Instantiates a new ics generation strategy.
		 *
		 * @param name the name
		 */
 ...
 AUTHOR_PATH("Author path");
	 ...
	 *
	 * @param enableSpellChecker the new enable spell checker
	 */
	 ...
	 *
	 * @param autoOpenNextInboxItem the new auto open next inbox item
	 */
	 ...
	 *
	 * @param sourceTreeComponents the new source tree components
	 */
	 ...
	 *
	 * @param targetTreeComponents the new target tree components
	 */
	 ...
	 *
	 * @param columnsDisplayedInInbox the new columns displayed in inbox
	 */
	 ...
	 *
	 * @param selectedEditorMode the new selected editor mode
	 */
	 ...
	 *
	 * @param selectedPrefTermDefault the new selected pref term default
	 */
	 ...
	 *
	 * @param selectedFsnGenStrategy the new selected fsn gen strategy
	 */
	 ...
	 *
	 * @param selectedIcsGenerationStrategy the new selected ics generation strategy
	 */
	 ...
	 *
	 * @param projectIssuesRepositoryIds the new project issues repository ids
	 */
	 ...
	 *
	 * @param sourceIssuesRepositoryIds the new source issues repository ids
	 */
	 ...
	 *
	 * @param isProjectDefaultConfiguration the new project default configuration
	 */
	 ...
	 *
	 * @param translatorRoles the translator roles
	 */
	 ...
	 *
	 * @param defaultSimilaritySearchOption the new default similarity search option
	 */
	 ...
	 *
	 * @param editingPanelOpenMode the new editing panel open mode
	 */
