...
public class SimilarityPanelClon extends JPanel implements Serializable{
	...
	public SimilarityPanelClon() {
		...
		try {
			...
			preferred = Terms.get().getConcept(SnomedMetadataRf2.FULLY_SPECIFIED_NAME_RF2.getLenient().getNid());
		} catch (IOException e) {
			e.printStackTrace();
