...
/**
 * The Class TestSimpleTranslationConceptEditorInFrame.
 */
public class TestSimpleTranslationConceptEditorInFrame {
	...
	/**
	 * Instantiates a new test simple translation concept editor in frame.
	 * 
	 ...
	 */
	public TestSimpleTranslationConceptEditorInFrame(I_GetConceptData concept, I_ConfigAceFrame config, String langCode, 
	...
	private static void createAndShowGUI() {
		...
		SimpleTranslationConceptEditor newContentPane = new SimpleTranslationConceptEditor(sampleConcept, config, "en", "es");
