...
import org.ihtsdo.translation.ListComponentViewerPanel;
...
public class OpenListComponentViewer extends AbstractTask {
	 ...
	 */
	public OpenListComponentViewer() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			if(tp != null){
				...
				panel.add(listCompViewerPanel, BorderLayout.CENTER);
				
				tp.addTab(TranslationHelperPanel.LIST_COMPONENT_VIEWER_NAME, panel);
