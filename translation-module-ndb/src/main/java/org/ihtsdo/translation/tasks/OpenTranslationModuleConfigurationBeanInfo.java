...
public class OpenTranslationModuleConfigurationBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(OpenTranslationModuleConfiguration.class);
        bd.setDisplayName("<html><font color='green'><center>Open translation<br>configuration.");
        return bd;
    }
