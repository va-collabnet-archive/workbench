...
public class OpenTranslationForSelectedConcept extends AbstractTask {
	 ...
	 */
	public OpenTranslationForSelectedConcept() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
	        ...
	        TranslationConceptEditor uiPanel = new TranslationConceptEditor(concept, config, sourceLangCode, targetLangCode);
