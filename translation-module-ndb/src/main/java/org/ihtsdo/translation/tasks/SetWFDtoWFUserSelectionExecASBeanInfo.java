...
public class SetWFDtoWFUserSelectionExecASBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(SetWFDtoWFUserSelectionExecAS.class);
		bd.setDisplayName("<html><font color='green'><center>Setup WfDetailsSheet<br>to User selection<br>dynamic AS");
		return bd;
	}
