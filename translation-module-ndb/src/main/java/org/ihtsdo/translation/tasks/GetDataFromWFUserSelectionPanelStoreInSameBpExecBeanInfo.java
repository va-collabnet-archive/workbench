 ...
 */
public class GetDataFromWFUserSelectionPanelStoreInSameBpExecBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new gets the data from wf user selection panel store in same bp exec bean info.
     */
    public GetDataFromWFUserSelectionPanelStoreInSameBpExecBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor rv[] =
                    { profilePropName, translatorInboxPropName, fastTrackTranslatorInboxPropName,
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(GetDataFromWFUserSelectionPanelStoreInSameBpExec.class);
        bd.setDisplayName("<html><font color='green'><center>Get WF User<br>Selection Data<br>from WFD Sheet<br>store in same bp<BR>and execute");
        return bd;
    }
