...
public class CreateLangMembershipRefsetFromConcept extends AbstractTask {
	...
	ClassNotFoundException {
		...
		if (objDataVersion == 1) {
			languageCode = (TermEntry) in.readObject();
	...
	throws TaskFailedException {
		...
		try{
			...
			LanguageMembershipRefset LangMemberRefset = 
				LanguageMembershipRefset.createLanguageMembershipRefsetFromConcept(languageRefsetConcept, 
						lCode, config);
