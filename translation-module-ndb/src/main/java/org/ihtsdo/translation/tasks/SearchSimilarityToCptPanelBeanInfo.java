...
/**
 * The Class SearchSimilarityToCptPanelBeanInfo.
 */
public class SearchSimilarityToCptPanelBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new search similarity to cpt panel bean info.
	 */
	public SearchSimilarityToCptPanelBeanInfo() {
		super();
	}
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(SearchSimilarityToCptPanel.class);
		bd.setDisplayName("<html><font color='green'><center>Search Similarity<br>to Concept Panel");
		return bd;
	}
