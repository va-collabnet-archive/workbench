 ...
 */
public class SearchLangCodeAndStringBeanInfo extends AbstractSearchTestBeanInfo {
    
    /** The search info. */
    private static  SearchLangCodeAndStringSearchInfo searchInfo = new SearchLangCodeAndStringSearchInfo();
