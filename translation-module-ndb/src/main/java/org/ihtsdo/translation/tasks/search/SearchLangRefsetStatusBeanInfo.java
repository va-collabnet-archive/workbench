...
/**
 * The Class SearchLangRefsetStatusBeanInfo.
 */
public class SearchLangRefsetStatusBeanInfo extends AbstractSearchTestBeanInfo {
    
    /** The search info. */
    private static SearchLangRefsetStatusSearchInfo searchInfo = new SearchLangRefsetStatusSearchInfo();
