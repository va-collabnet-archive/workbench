...
/**
 * 
 * This MoJo exports refset content from an ACE Berkeley Database. The format
 * for export is described
 * <a href="https://mgr.cubit.aceworkspace.net/pbl/cubitci/pub/ace-mojo/site/dataimport.html"
 * > here. </a>
 * 
 ...
 */
public class ExportRefSet extends AbstractMojo implements I_ProcessConcepts, I_ProcessDescriptions,
     ...
     * are not. Only reference sets
     * whose identifying concept is exported will be exported. Only members
     * relating to components that will
    ...
    /*
     * public void addConceptInLinage(int conceptId) throws
