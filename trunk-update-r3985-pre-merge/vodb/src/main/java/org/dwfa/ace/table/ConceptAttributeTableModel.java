...
public class ConceptAttributeTableModel extends AbstractTableModel implements PropertyChangeListener {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            case CON_ID:
                return new StringWithConceptTuple(Integer.toString(conTuple.getConId()), conTuple, inConflict);
            case STATUS:
                ...
                return new StringWithConceptTuple(Integer.toString(conTuple.getConceptStatus()), conTuple, inConflict);
            case DEFINED:
