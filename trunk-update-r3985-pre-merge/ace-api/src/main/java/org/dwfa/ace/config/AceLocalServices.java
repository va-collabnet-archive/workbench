...
public class AceLocalServices extends ArrayList<ServiceConfigOption> {
    ...
    public static ServiceConfigOption CO_LocalTransactionManager = new ServiceConfigOption(LOCAL_TRANSACTION_MANAGER,
        "config${/}transactionManager.policy", "config${/}transactionManagerSecure.policy",
        LOCAL_TRANSACTION_MANAGER_PROP, "Starts a local transaction manager. ", true, "", null, CoreServices.dwaPath,
        "com.sun.jini.mahalo.LocalTransactionManager", new String[] { "config${/}transactionManager.config" },
