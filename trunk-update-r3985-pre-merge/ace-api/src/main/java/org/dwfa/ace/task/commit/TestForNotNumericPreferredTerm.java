...
/**
 * The <code>TestForNotNumericPreferredTerm</code> class represents a data
 * constraint test that is to be run on any <code>concept</code> to verify that
 * it has a 'preferred term' that is not a purely numeric value.
 * 
