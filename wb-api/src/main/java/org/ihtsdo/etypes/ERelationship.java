...
public class ERelationship extends EComponent<ERelationshipRevision> {
    ...
    public ERelationship(I_RelVersioned rel) throws TerminologyException, IOException {
        ...
        time = part.getTime();
        if (partCount > 1) {
            revisions = new ArrayList<ERelationshipRevision>(partCount - 1);
    ...
    public void writeExternal(DataOutput out) throws IOException {
        ...
        if (revisions == null) {
            ...
            for (ERelationshipRevision erv : revisions) {
    ...
    public List<ERelationshipRevision> getRevisionList() {
        return revisions;
    }
