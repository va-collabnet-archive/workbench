...
public class ModelerWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static ModelerWorkflowHistorySearchInfo searchInfo = new ModelerWorkflowHistorySearchInfo();
