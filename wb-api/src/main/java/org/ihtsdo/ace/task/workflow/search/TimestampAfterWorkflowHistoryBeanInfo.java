...
public class TimestampAfterWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static TimestampAfterWorkflowHistorySearchInfo searchInfo = new TimestampAfterWorkflowHistorySearchInfo();
