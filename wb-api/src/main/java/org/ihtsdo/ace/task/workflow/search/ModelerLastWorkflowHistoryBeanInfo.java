...
public class ModelerLastWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static ModelerLastWorkflowHistorySearchInfo searchInfo = new ModelerLastWorkflowHistorySearchInfo();
