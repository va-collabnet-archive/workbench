...
public class AbstractWorkflowHistorySearchTestBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(AbstractWorkflowHistorySearchTest.class);
