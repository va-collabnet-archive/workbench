...
public class ActionLastWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static ActionLastWorkflowHistorySearchInfo searchInfo = new ActionLastWorkflowHistorySearchInfo();
