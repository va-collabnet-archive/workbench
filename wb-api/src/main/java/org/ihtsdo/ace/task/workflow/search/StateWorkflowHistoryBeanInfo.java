...
public class StateWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static StateWorkflowHistorySearchInfo searchInfo = new StateWorkflowHistorySearchInfo();
