...
public class IdentifierSet implements I_RepresentIdSet, Serializable {
    ...
    /**
     * Needed or else the compilers can generate differing values
     */
    private static final long serialVersionUID = -683834253892112887L;
    ...
    public String toString() {
        ...
        try {
            ...
            while ((count < toStringMax) && idIterator.next()) {
                try {
                    buff.append(Terms.get()
                        .getComponent(idIterator.nid())
                        .toString());
    ...
    private class NidIterator implements I_IterateIds {
        private final DocIdSetIterator docIterator;
