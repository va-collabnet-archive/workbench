    ...
    public void setProperties(I_ExtendByRefPart part) {
        for (Entry<REFSET_PROPERTY, Object> entry : properties.entrySet()) {
            ...
            case INTEGER_VALUE:
                ...
                break;
            case LONG_VALUE:
                I_ExtendByRefPartLong longPart = (I_ExtendByRefPartLong) part;
                longPart.setLongValue((Long) entry.getValue());
                break;
            case PATH:
    ...
    public boolean validate(I_ExtendByRefPart part) {
        ...
        for (Entry<REFSET_PROPERTY, Object> entry : properties.entrySet()) {
            ...
            case INTEGER_VALUE:
                ...
                break;
            case LONG_VALUE:
                if (!I_ExtendByRefPartLong.class.isAssignableFrom(part.getClass())) {
                    return false;
                }
                I_ExtendByRefPartLong longPart = (I_ExtendByRefPartLong) part;
                if (!entry.getValue().equals(longPart.getLongValue())) {
                    return false;
                }
                break;
            case PATH:
