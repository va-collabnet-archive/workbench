...
/**
 * Sets a single UUID property based on the inputted Term Entry object.
 *
 * @author Chrissy Hill
 *
 */
@BeanList(specs = { @Spec(directory = "tasks/ide/prop", type = BeanType.TASK_BEAN) })
public class SetSingleUuidPropertyFromTermEntry extends AbstractTask {
    ...
    private String uuidPropName = ProcessAttachmentKeys.STATUS_UUID.getAttachmentKey();
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            ...
            process.setProperty(uuidPropName, termEntry.getLocalConcept().getUids().iterator().next());
