...
public abstract class RefsetSpecStatement extends RefsetSpecComponent {
    ...
    protected enum QUERY_TOKENS {
        ...
        V1_IS(RefsetAuxiliary.Concept.DIFFERENCE_V1_IS),
        V2_IS(RefsetAuxiliary.Concept.DIFFERENCE_V2_IS),
        ...
        CHANGED_CONCEPT_STATUS(RefsetAuxiliary.Concept.CHANGED_CONCEPT_STATUS),
        CHANGED_CONCEPT_DEFINED(RefsetAuxiliary.Concept.CHANGED_DEFINED),
        CHANGED_DESCRIPTION_CASE(RefsetAuxiliary.Concept.CHANGED_DESCRIPTION_CASE),
        CHANGED_DESCRIPTION_LANGUAGE(RefsetAuxiliary.Concept.CHANGED_DESCRIPTION_LANGUAGE),
        CHANGED_DESCRIPTION_STATUS(RefsetAuxiliary.Concept.CHANGED_DESCRIPTION_STATUS),
        CHANGED_DESCRIPTION_TERM(RefsetAuxiliary.Concept.CHANGED_DESCRIPTION_TERM),
        CHANGED_DESCRIPTION_TYPE(RefsetAuxiliary.Concept.CHANGED_DESCRIPTION_TYPE),
        CHANGED_RELATIONSHIP_CHARACTERISTIC(RefsetAuxiliary.Concept.CHANGED_RELATIONSHIP_CHARACTERISTIC),
        CHANGED_RELATIONSHIP_GROUP(RefsetAuxiliary.Concept.CHANGED_RELATIONSHIP_GROUP),
        CHANGED_RELATIONSHIP_REFINABILITY(RefsetAuxiliary.Concept.CHANGED_RELATIONSHIP_REFINABILITY),
        CHANGED_RELATIONSHIP_STATUS(RefsetAuxiliary.Concept.CHANGED_RELATIONSHIP_STATUS),
        CHANGED_RELATIONSHIP_TYPE(RefsetAuxiliary.Concept.CHANGED_RELATIONSHIP_TYPE);
