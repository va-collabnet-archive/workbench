...
public class CheckForConceptsInListBeanInfo extends SimpleBeanInfo {

    /**
     * 
     */
    public CheckForConceptsInListBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(CheckForConceptsInList.class);
        bd.setDisplayName("<html><font color='green'><center>Check for Concepts<br>in List View");
        return bd;
    }
}
