 ...
 * uses the {@code forCommit} flag on
 * {@link AbstractConceptTest#test(org.dwfa.ace.api.I_GetConceptData, boolean)}
 * to determine the type of {@link AlertToDataConstraintFailureFactory} to
 * return.
 * 
