...
public class CreateRefsetMembersetPair extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        ...
        try {
            ...
            if (altIsA != null) {
                String altIsAUuid = (String) process.getProperty(altIsA);
                if (altIsAUuid != null) {
            ...
            if (isValidParent()) {
                ...
                String name = (String) process.getProperty(propName) + " member reference set";
                 ...
                 */
                name = (String) process.getProperty(propName) + " specification reference set";
