    ...
    */
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            ...
            I_Path fromPath = tf.getPath(AceTaskUtil.getConceptFromObject(process.getProperty(fromPathPropName))
                .getUids());
            ...
            I_GetConceptData newStatus = AceTaskUtil.getConceptFromObject(process.getProperty(statusPropName));
