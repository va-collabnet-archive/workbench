...
public class SelectExtensionBeanInfo extends SimpleBeanInfo {

    /**
     * Constructor - calls the parent constructor
     */
    public SelectExtensionBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
        	 PropertyDescriptor relParentPropName = new PropertyDescriptor("relParentPropName", SelectExtension.class);
            ...
            PropertyDescriptor instruction = new PropertyDescriptor("instruction", SelectExtension.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SelectExtension.class);
        bd.setDisplayName("<html><font color='green'><center>Select Extension");
        return bd;
    }
}
