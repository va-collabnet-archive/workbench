 ...
 * @author kec
 */
public class RefsetIntegerContainsTextSearchInfo  extends AbstractSeachTestSearchInfo {
    ...
    protected PropertyDescriptor[] getAdditionalPropertyDescriptors() {
        try {
            ...
            relRestrictionTerm.setDisplayName("<html><font color='green'>text in integer field:");
            relRestrictionTerm.setShortDescription("The integer text to test for inclusion in refset member.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(RefsetIntegerContainsText.class);
        bd.setDisplayName("text in integer field");
        return bd;
    }
}
