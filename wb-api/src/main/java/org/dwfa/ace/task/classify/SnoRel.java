...
public class SnoRel implements Comparable<Object> {
    ...
    public String toStringC1() {
        try {
            I_TermFactory terms = Terms.get();
            if (terms.hasConcept(c1Id)) {
                return terms.getConcept(c1Id).toUserString();
            }
        } catch (TerminologyException ex) {
            // Logger.getLogger(SnoRel.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
    ...
    public String toStringType() {
        try {
            I_TermFactory terms = Terms.get();
            if (terms.hasConcept(typeId)) {
                return terms.getConcept(typeId).toUserString();
            }
        } catch (TerminologyException ex) {
            // Logger.getLogger(SnoRel.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
    ...
    public String toStringC2() {
        try {
            I_TermFactory terms = Terms.get();
            if (terms.hasConcept(c2Id)) {
                return terms.getConcept(c2Id).toUserString();
            }
        } catch (TerminologyException ex) {
            // Logger.getLogger(SnoRel.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
