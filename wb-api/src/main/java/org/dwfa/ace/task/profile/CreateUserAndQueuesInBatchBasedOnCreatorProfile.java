   ...
   private boolean setupUser(String fullname, String username, String password, String adminUsername,
      ...
      try {
         ...
         ChangeSetGeneratorBI generator =
            Ts.get()
               .createDtoChangeSetGenerator(new File(newConfig.getDbConfig().getChangeSetRoot(), newConfig
                  .getDbConfig().getChangeSetWriterFileName()), new File(newConfig.getDbConfig()
                  .getChangeSetRoot(), "#0#"
                                       + newConfig.getDbConfig()
