...
public class SetWFToCommentWithTextBeanInfo extends SimpleBeanInfo {

    /**
     *
     */
    public SetWFToCommentWithTextBeanInfo() {
        super();
    }
...
//            profilePropName.setShortDescription("The property that will contain the profile this task uses and/or modifies.");
            ...
            commentsPropName.setDisplayName("<html><font color='green'>Comments property:");
            commentsPropName.setShortDescription("The comments property.");
...
//            PropertyDescriptor rv[] = { profilePropName, commentsPropName };
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetWFToCommentWithText.class);
        bd.setDisplayName("<html><font color='green'><center>Set WF Panel to<br>comments panel<br>with text");
        return bd;
    }
