...
public class SaveNewCapProfile extends AbstractTask {
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (objDataVersion == dataVersion) {
            ...
            //System.out.println("===inside SaveNewProfile releaseDatePropName===" + releaseDatePropName );
        } else {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            ...
            String userName = releaseDate+ "_" + profileToSave.getUsername();
    ...
    public void setReleaseDatePropName(String releaseDatePropName) {
        this.releaseDatePropName = releaseDatePropName;
    }
