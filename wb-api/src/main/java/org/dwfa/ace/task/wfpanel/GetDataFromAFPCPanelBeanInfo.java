 ...
 * 
 */
public class GetDataFromAFPCPanelBeanInfo extends SimpleBeanInfo {

    public GetDataFromAFPCPanelBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        bd.setDisplayName("<html><font color='green'><center>Get parent data<br> and ask for<br>concept name");
        return bd;
    }
