...
/**
 * Shows the Modify User Role panel in the WF panel.
 * 
 * @author Chrissy Hill
 * 
 */
@BeanList(specs = { @Spec(directory = "tasks/refset/spec/wf", type = BeanType.TASK_BEAN) })
public class SetWFToSelectUserPanelTask extends AbstractTask {
    ...
    private void doRun(final I_EncodeBusinessProcess process, final I_Work worker) {
        ...
        try {
            ...
            SelectUserPanel innerPanel = new SelectUserPanel();
