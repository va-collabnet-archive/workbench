...
public class UpdateOverallSpecStatusTaskBeanInfo extends SimpleBeanInfo {

    /**
     *
     */
    public UpdateOverallSpecStatusTaskBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            statusUuidPropName.setDisplayName("<html><font color='green'>refset UUID prop:");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(UpdateOverallSpecStatusTask.class);
        bd.setDisplayName("<html><font color='green'><center>Update overall<br>spec status");
        return bd;
    }
