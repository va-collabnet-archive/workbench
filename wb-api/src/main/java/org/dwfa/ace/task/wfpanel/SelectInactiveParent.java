...
public class SelectInactiveParent extends PreviousNextOrCancel {
    ...
    private class DoSwing extends SwingWorker<Boolean> {
        ...
        protected void finished() {
            ...
            c.gridx++;
            c.gridy = 0;
            I_GetConceptData parentList[] = new I_GetConceptData[12];
            try {
            	...
            	parentList[10] = Terms.get().getConcept(ArchitectonicAuxiliary.Concept.MOVED_ELSEWHERE.getUids());
            	parentList[11] = Terms.get().getConcept(ArchitectonicAuxiliary.Concept.EXTINCT.getUids());
