...
public class TestForSelfReferencingRefsetSpec extends AbstractExtensionTest {
    ...
    private ArrayList<AlertToDataConstraintFailure> verifyRefsetSpec(RefsetSpec specHelper,
        ...
        try {
            ...
            if (nestedRefsetIds.contains(specHelper.getMemberRefsetConcept().getConceptId())) {
                alertList
            ...
            if (invalidIds.contains(specHelper.getMemberRefsetConcept().getConceptId())) {
            ...
            for (Integer nestedRefsetId : nestedRefsetIds) {
                ...
                Integer memberRefsetId = specHelper.getMemberRefsetConcept().getConceptId();
