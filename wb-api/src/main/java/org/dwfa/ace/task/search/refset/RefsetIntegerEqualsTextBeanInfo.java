 ...
 * @author kec
 */
public class RefsetIntegerEqualsTextBeanInfo extends AbstractSearchTestBeanInfo {
    private static AbstractSeachTestSearchInfo searchInfo = new RefsetIntegerEqualsTextSearchInfo();
