...
import org.dwfa.ace.task.profile.NewProfile;
...
public class NewCapDefaultProfile extends NewProfile {
    ...
    */
    ...
    public static I_ConfigAceFrame newProfile(String fullName, String username, String password, String adminUsername,
        ...
        try {
            ...
            Set<PositionBI> testSet = tf.getActiveAceFrameConfig().getViewPositionSet();
            Set<PositionBI> checkAgainstSet = tf.getActiveAceFrameConfig().getViewPositionSet();
            
            for (PositionBI testPos : testSet) {
            	boolean falseCaseFound = false;
            	for (PositionBI checkPos : checkAgainstSet) {
            		if (!testPos.isSubsequentOrEqualTo(checkPos)) {
            			falseCaseFound = true;
            			break;
            		}
            	}
