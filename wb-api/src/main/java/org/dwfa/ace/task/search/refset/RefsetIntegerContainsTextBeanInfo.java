 ...
 * @author kec
 */
public class RefsetIntegerContainsTextBeanInfo extends AbstractSearchTestBeanInfo {
    private static AbstractSeachTestSearchInfo searchInfo = new RefsetIntegerContainsTextSearchInfo();
