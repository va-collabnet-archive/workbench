...
public abstract class NewProfile extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            String fullname = (String) process.getProperty(fullNamePropName);
            String username = (String) process.getProperty(usernamePropName);
            String password = (String) process.getProperty(passwordPropName);
            String adminUsername = (String) process.getProperty(adminUsernamePropName);
            String adminPassword = (String) process.getProperty(adminPasswordPropName);
