 ...
 */
public class SetWFDSheetToNewCollabnetQueuePanelTaskBeanInfo extends SimpleBeanInfo {

    public SetWFDSheetToNewCollabnetQueuePanelTaskBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetWFDSheetToNewCollabnetQueuePanelTask.class);
        bd.setDisplayName("<html><font color='green'><center>Set WFD Sheet to<br>new Collabnet queue<br>panel");
        return bd;
    }
