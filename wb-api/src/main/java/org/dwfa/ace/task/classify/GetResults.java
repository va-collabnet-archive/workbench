...
public class GetResults extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        ...
        try {
            ...
            tf = (I_SupportClassifier) Terms.get();
    ...
    private static ThreadGroup classifierThreadGroup = new ThreadGroup("classifier threads");
    private void getClassifierResults(I_Work worker, I_SnorocketFactory rocket) throws Exception {
        ...
        ExecutorService executionService = Executors.newFixedThreadPool(15, new NamedThreadFactory(
        		classifierThreadGroup,
        		"Classifier results "));
    ...
    private static class ProcessResults implements Callable<Boolean>, I_SnorocketFactory.I_Callback {
        ...
        private I_TermFactory termFactory = Terms.get();
