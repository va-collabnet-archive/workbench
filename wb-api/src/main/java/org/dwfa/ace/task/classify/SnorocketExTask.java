...
public class SnorocketExTask extends AbstractTask implements ActionListener {
...
//            }
        ...
        s.append("\r\n::: [SnorocketExTask] compareAndWriteBack()");
    ...
    private String toStringPathPos(List<PositionBI> pathPos, String pStr) {
        // BUILD STRING
        StringBuilder s = new StringBuilder();
        s.append("\r\n::: [SnorocketExTask] PATH ID -- ").append(pStr).append("\r\n");
    ...
    private String toStringSnoRel(List<SnoRel> list, int start, int count, String comment) {
        ...
        s.append("\r\n::: [SnorocketExTask] SnoRel Listing -- ").append(comment);
    ...
    private ArrayList<SnoRel> getRoles() { // SORT BY [ROLE-C1-GROUP-C2]
        ...
        logger.log(Level.INFO, "\r\n::: [SnorocketExTask] COUNTED ROLES == {0}\r\n{1}",
