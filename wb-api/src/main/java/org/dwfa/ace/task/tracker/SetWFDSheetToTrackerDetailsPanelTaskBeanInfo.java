...
/**
 * The SetWFDSheetToTrackerDetailsPanelTaskBeanInfo class describes the visible elements of the
 * Workflow task SetWFDSheetToTrackerDetailsPanelTaskBeanInfo so that it can be displayed in the
 * Process Builder.
 */
public class SetWFDSheetToTrackerDetailsPanelTaskBeanInfo extends SimpleBeanInfo {

    public SetWFDSheetToTrackerDetailsPanelTaskBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetWFDSheetToTrackerDetailsPanelTask.class);
        bd.setDisplayName("<html><font color='green'><center>Set WFD Sheet to<br>Tracker Details<br>panel");
        return bd;
    }
