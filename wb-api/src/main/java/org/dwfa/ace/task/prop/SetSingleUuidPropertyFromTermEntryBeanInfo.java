...
public class SetSingleUuidPropertyFromTermEntryBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            uuidPropName.setDisplayName("<html><font color='green'>uuid prop:");
            uuidPropName.setShortDescription("The property that contains the uuid (single) to modify.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetSingleUuidPropertyFromTermEntry.class);
        bd.setDisplayName("<html><font color='green'><center>set single UUID property<br>from term entry");
        return bd;
    }
}
