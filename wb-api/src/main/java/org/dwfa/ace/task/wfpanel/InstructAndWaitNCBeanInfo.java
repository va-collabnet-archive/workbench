...
public class InstructAndWaitNCBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(InstructAndWaitNC.class);
        bd.setDisplayName("<html><font color='green'><center>Instruct and Wait<br>Next, or Cancel");
        return bd;
    }
}
