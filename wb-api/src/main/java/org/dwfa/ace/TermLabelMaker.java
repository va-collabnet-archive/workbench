...
public class TermLabelMaker {
    ...
    public static I_ImplementActiveLabel newLabel(I_ConceptAttributeTuple conAttribute, boolean showLongForm,
        ...
        if (conAttribute != null) {
            ...
            try {
                statusBean = Terms.get().getConcept(conAttribute.getConceptStatus());
    ...
    public static I_ImplementActiveLabel newLabel(I_DescriptionTuple desc, boolean showLongForm, boolean showStatus)
        ...
        if (desc != null) {
            text = desc.getText();
            try {
                typeBean = Terms.get().getConcept(desc.getTypeId());
                statusBean = Terms.get().getConcept(desc.getStatusId());
            } catch (TerminologyException e) {
                throw new IOException(e);
            }
        }
    ...
    public static I_ImplementActiveLabel newLabel(I_RelTuple rel, boolean showLongForm, boolean showStatus)
            throws IOException {
        try {
            I_GetConceptData typeBean = Terms.get().getConcept(rel.getTypeId());
            I_GetConceptData destBean = Terms.get().getConcept(rel.getC2Id());
            I_GetConceptData refinabilityBean = Terms.get().getConcept(rel.getRefinabilityId());
            I_GetConceptData characteristicBean = Terms.get().getConcept(rel.getCharacteristicId());
            I_GetConceptData statusBean = Terms.get().getConcept(rel.getStatusId());
