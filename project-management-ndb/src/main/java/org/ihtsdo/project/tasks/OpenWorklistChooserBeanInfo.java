 ...
 */
public class OpenWorklistChooserBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new list projects to signpost bean info.
     */
    public OpenWorklistChooserBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(OpenWorklistChooser.class);
        bd.setDisplayName("<html><font color='green'><center>Show WorkList Chooser</center></font></html>");
        return bd;
    }
