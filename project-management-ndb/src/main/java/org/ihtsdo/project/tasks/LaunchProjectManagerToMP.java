...
/**
 * The Class LaunchProjectManagerToMP.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class LaunchProjectManagerToMP extends AbstractTask {
	...
	/**
	 * Instantiates a new launch project manager to mp.
	 * 
	 * @throws MalformedURLException the malformed url exception
	 */
	public LaunchProjectManagerToMP() throws MalformedURLException {
		super();
	}
...
//				ProjectManager pmp=new ProjectManager();
//				tp.addTab(TranslationHelperPanel.PROJECT_MGR_TAB_NAME, pmp);
