 ...
 */
public class DeleteProjectBeanInfo extends SimpleBeanInfo {

	/**
	 * Instantiates a new delete project bean info.
	 */
	public DeleteProjectBeanInfo() {
		super();
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		...
		try {
			PropertyDescriptor projectName = new PropertyDescriptor("projectName", DeleteProject.class);
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(DeleteProject.class);
		bd.setDisplayName("<html><font color='green'><center>Retire Project");
		return bd;
	}
