...
/**
 * The Class GetTranslationProjectBeanInfo.
 */
public class GetTranslationProjectBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new list projects to signpost bean info.
     */
    public GetTranslationProjectBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(GetTranslationProject.class);
        bd.setDisplayName("<html><font color='green'><center>Get Single Translation<br>Project.");
        return bd;
    }
