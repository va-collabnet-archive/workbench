...
public class OpenProjectPanelToLT extends AbstractTask {
	 ...
	 */
	public OpenProjectPanelToLT() throws MalformedURLException {
		super();
	}
...
//				Worker nWorker=new MasterWorker(worker.getJiniConfig());
		        ProjectsPanel uiPanel = new ProjectsPanel(worker);
			
		        tp.addTab(TranslationHelperPanel.PROJECT_MGR_TAB_NAME, uiPanel);
