...
/**
 * The Class SaveSerializedProfile.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class SaveSerializedProfile extends AbstractTask {
	...
	/**
	 * Instantiates a new save serialized profile.
	 * 
	 * @throws MalformedURLException the malformed url exception
	 */
	public SaveSerializedProfile() throws MalformedURLException {
		super();
	}
