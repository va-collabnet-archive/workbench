...
/**
 * The Class SaveSerializedProfileBeanInfo.
 */
public class SaveSerializedProfileBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new save serialized profile bean info.
     */
    public SaveSerializedProfileBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SaveSerializedProfile.class);
        bd.setDisplayName("<html><font color='green'><center>Save Serialized Profile");
        return bd;
    }
