...
/**
 * The Class testProjectPanel.
 */
public class testProjectPanel extends javax.swing.JFrame
{
	...
	public static void main( String[] args ) throws Exception
	{
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run(){
				try {
					new testProjectPanel().setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	/**
	 * Instantiates a new test project panel.
	 * 
	 * @throws Exception the exception
	 */
	public testProjectPanel() throws Exception{
...
//		pm=new ProjectMgrPanel(termFactory,null);
//		this.getContentPane().add(pm);
//		this.addWindowListener(new AreYouSure());
	}
//	
//	/** The pm. */
//	private ProjectMgrPanel pm;
