...
import org.ihtsdo.project.panel.details.WorklistMemberStatusPanel.WorklistMembersStatusWorker;
...
public class WorklistMemberStatusPanel extends JPanel {
	...
	private void initComponents() {
		...
		// ======== panel1 ========
		{
			...
			panel1.add(button1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
		}
	...
	class WorklistMembersStatusWorker extends SwingWorker<String, String> {
		...
		protected void process(List<String> chunks) {
			for (String objects : chunks) {
				list5Model.addElement(objects.toString() + " (" + statuses.get(objects) + ")");
			}
		}
