...
/**
 * The listener interface for receiving listConceptDragSource events.
 * The class that is interested in processing a listConceptDragSource
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addListConceptDragSourceListener<code> method. When
