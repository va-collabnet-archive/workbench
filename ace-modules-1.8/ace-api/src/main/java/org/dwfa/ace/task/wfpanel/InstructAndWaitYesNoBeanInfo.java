...
public class InstructAndWaitYesNoBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(InstructAndWaitYesNo.class);
        bd.setDisplayName("<html><font color='green'><center>Instruct and Wait<br>Yes or No");
        return bd;
    }
}
