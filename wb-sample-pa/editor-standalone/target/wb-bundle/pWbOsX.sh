java \
    -Xbootclasspath/a:/Applications/jprofiler6/bin/agent.jar \
    -agentpath:/Applications/jprofiler6/bin/macos/libjprofilerti.jnilib \
    -Xms1400m \
    -Xmx1400m \
    -Xdock:name="Workbench Bundle" \
    -Xdock:icon=config/icon/bundle.gif \
