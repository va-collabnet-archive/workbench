...
public class SearchDictionary extends AbstractTask {
	...
	/**
	 * Instantiates a new search dictionary.
	 * 
	 * @throws MalformedURLException the malformed url exception
	 */
	public SearchDictionary() throws MalformedURLException {
		super();
	}
		...
		try {
			...
			if (tp!=null){
				...
				for (int i=0;i<tabCount;i++){
					if (tp.getTitleAt(i).equals(TranslationHelperPanel.SEARCH_DICT_TAB_NAME)){
				...
				panel.add(new DictionaryResultsPanel(query,null), BorderLayout.CENTER);
				
				tp.addTab(TranslationHelperPanel.SEARCH_DICT_TAB_NAME, panel);
