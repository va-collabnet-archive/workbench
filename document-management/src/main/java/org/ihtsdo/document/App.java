	...
	public static void index()
	{
		try {
			...
			IndexWriter writer = new IndexWriter(FSDirectory.open(indexDir), 
					new StandardAnalyzer(Version.LUCENE_35), true, IndexWriter.MaxFieldLength.UNLIMITED);
...
//					cd.close();
	 ...
	 */
	public static void search() throws IOException, ParseException, InvalidTokenOffsetsException
	{
