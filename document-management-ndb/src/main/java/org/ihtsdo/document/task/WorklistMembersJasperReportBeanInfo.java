...
public class WorklistMembersJasperReportBeanInfo extends SimpleBeanInfo {
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(WorklistMembersJasperReport.class);
		bd.setDisplayName("<html><font color='green'><center>Worklist member by status<BR>Jasper report");
		return bd;
	}
