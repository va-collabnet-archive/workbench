...
/**
 * The Class SearchDocumentsToSignpost.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/documents tasks", type = BeanType.TASK_BEAN)})
public class SearchDocumentsToSignpost extends AbstractTask {
	...
	/**
	 * Instantiates a new search documents to signpost.
	 * 
	 * @throws MalformedURLException the malformed url exception
	 */
	public SearchDocumentsToSignpost() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			if (tp!=null){
				...
				panel.add(new DocumentsSearchPanel(query), BorderLayout.CENTER);
