...
/**
 * QACasesReportLinesByPageRequest.java
 *
 ...
 */
            ...
            /**
            *  QACasesReportLinesByPageRequest bean class
            */
        
        public  class QACasesReportLinesByPageRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.ihtsdo.org/qadb/qadb-service/",
                "QACasesReportLinesByPageRequest",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.ihtsdo.qadb.ws.data.IntBoolKeyValue[] localSorteBy ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSorteByTracker = false ;
                           ...
                           */
                           public  org.ihtsdo.qadb.ws.data.IntBoolKeyValue[] getSorteBy(){
                               return localSorteBy;
                           }
                              ...
                              /**
                               * validate the array for SorteBy
                               */
                              protected void validateSorteBy(org.ihtsdo.qadb.ws.data.IntBoolKeyValue[] param){
                              ...
                              * @param param SorteBy
                              */
                              public void setSorteBy(org.ihtsdo.qadb.ws.data.IntBoolKeyValue[] param){
                              
                                   validateSorteBy(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localSorteByTracker = true;
                                          } else {
                                             localSorteByTracker = false;
                                                 
                                          }
                                      
                                      this.localSorteBy=param;
                              }
                             ...
                             */
                             public void addSorteBy(org.ihtsdo.qadb.ws.data.IntBoolKeyValue param){
                                   if (localSorteBy == null){
                                   localSorteBy = new org.ihtsdo.qadb.ws.data.IntBoolKeyValue[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSorteBy);
                               list.add(param);
                               this.localSorteBy =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       QACasesReportLinesByPageRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QACasesReportLinesByPageRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QACasesReportLinesByPageRequest",
                           xmlWriter);
                              ...
                              if (localSorteByTracker){
                                       if (localSorteBy!=null){
                                            for (int i = 0;i < localSorteBy.length;i++){
                                                if (localSorteBy[i] != null){
                                                 localSorteBy[i].serialize(new javax.xml.namespace.QName("","sorteBy"),
                                                           factory,xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("sorteBy cannot be null!!");
                             ...
                             if (localSorteBy!=null) {
                                 for (int i = 0;i < localSorteBy.length;i++){
                                    ...
                                    if (localSorteBy[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "sorteBy"));
                                         elementList.add(localSorteBy[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static QACasesReportLinesByPageRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QACasesReportLinesByPageRequest object =
                new QACasesReportLinesByPageRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QACasesReportLinesByPageRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QACasesReportLinesByPageRequest)org.ihtsdo.qadb.ws.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","sorteBy").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(org.ihtsdo.qadb.ws.data.IntBoolKeyValue.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","sorteBy").equals(reader.getName())){
                                                                    list3.add(org.ihtsdo.qadb.ws.data.IntBoolKeyValue.Factory.parse(reader));
                                                        ...
                                                        object.setSorteBy((org.ihtsdo.qadb.ws.data.IntBoolKeyValue[])
                                    ...
                                    // Process the array and step past its final element's end.
                                    list4.add(org.ihtsdo.qadb.ws.data.IntStrKeyValue.Factory.parse(reader));
