 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for FindingUuid
                        */

                        
                                    protected java.lang.String localFindingUuid ;
                           ...
                           */
                           public  java.lang.String getFindingUuid(){
                               return localFindingUuid;
                           }
                            ...
                            /**
                               ...
                               * @param param FindingUuid
                               */
                               public void setFindingUuid(java.lang.String param){
                            
                                            this.localFindingUuid=param;
                        ...
                        */
                                    ...
                                    protected java.lang.String localExecution ;
                           ...
                           */
                           public  java.lang.String getExecution(){
                            ...
                            /**
                               ...
                               */
                               public void setExecution(java.lang.String param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Finding.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"findingUuid", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"findingUuid");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("findingUuid");
                                    }
                                

                                          if (localFindingUuid==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("findingUuid cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localFindingUuid);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"execution", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"execution");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("execution");
                                          ...
                                          if (localExecution==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("execution cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localExecution);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localFindingUuid != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFindingUuid));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("findingUuid cannot be null!!");
                                        }
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localExecution != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localExecution));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("execution cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static Finding parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Finding object =
                new Finding();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Finding".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Finding)org.ihtsdo.qadb.ws.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","findingUuid").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setFindingUuid(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","execution").equals(reader.getName())){
