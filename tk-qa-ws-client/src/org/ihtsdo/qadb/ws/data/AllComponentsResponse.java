 ...
 */
            ...
            /**
            *  AllComponentsResponse bean class
            */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.ihtsdo.qadb.ws.data.Component[] getComponent(){
                               ...
                               */
                              protected void validateComponent(org.ihtsdo.qadb.ws.data.Component[] param){
                             ...
                             */
                             public void addComponent(org.ihtsdo.qadb.ws.data.Component param){
                                   if (localComponent == null){
                                   localComponent = new org.ihtsdo.qadb.ws.data.Component[]{};
                                   }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AllComponentsResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AllComponentsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AllComponentsResponse",
    ...
    public static class Factory{
        ...
        */
        public static AllComponentsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AllComponentsResponse object =
                new AllComponentsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AllComponentsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AllComponentsResponse)org.ihtsdo.qadb.ws.data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(org.ihtsdo.qadb.ws.data.Component.Factory.parse(reader));
                                                        ...
                                                        object.setComponent((org.ihtsdo.qadb.ws.data.Component[])
