...
public class QACaseDetailsPanel extends JPanel {
	...
	private void initComponents() {
		...
		label5 = new JLabel();
		dispositionStatus = new JComboBox();
		label6 = new JLabel();
			...
			//======== tabbedPane1 ========
			{
				...
				//======== scrollPane2 ========
				{
					...
					//======== panel3 ========
					{
						...
						((GridBagLayout)panel3.getLayout()).columnWidths = new int[] {0, 127, 0, 0, 0, 114, 0, 0, 0};
						((GridBagLayout)panel3.getLayout()).rowHeights = new int[] {25, 66, 12, 25, 30, 0, 28, 0, 0, 0};
						...
						panel3.add(label5, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 5, 5), 0, 0));
						panel3.add(dispositionStatus, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 5, 5), 0, 0));
						...
						panel3.add(annotation, new GridBagConstraints(4, 6, 4, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 5, 0), 0, 0));
						panel3.add(separator3, new GridBagConstraints(0, 7, 8, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 5, 0), 0, 0));

						//---- label7 ----
						label7.setText("Assigned to");
						panel3.add(label7, new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));
						panel3.add(assignedTo, new GridBagConstraints(1, 8, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));

						//---- label8 ----
						label8.setText("By");
						panel3.add(label8, new GridBagConstraints(3, 8, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));
						panel3.add(by, new GridBagConstraints(4, 8, 2, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));

						//---- label9 ----
						label9.setText("Date");
						panel3.add(label9, new GridBagConstraints(6, 8, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));
						panel3.add(assignedDate, new GridBagConstraints(7, 8, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				...
				tabbedPane1.addTab("Comments", panel4);
				...
				//======== panel5 ========
				{
					...
					panel5.add(textArea1, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 5, 5), 0, 0));
					...
					panel5.add(textArea2, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 5, 5), 0, 0));
					...
					panel5.add(textArea3, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 5, 5), 0, 0));
					...
					panel5.add(textArea4, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 5, 5), 0, 0));
					...
					//---- checkBox1 ----
					checkBox1.setText("Whitelist allowed");
					panel5.add(checkBox1, new GridBagConstraints(0, 5, 2, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 5, 5), 0, 0));

					//---- checkBox2 ----
					checkBox2.setText("Reset whitelist allowed");
					panel5.add(checkBox2, new GridBagConstraints(0, 6, 2, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH,
						new Insets(0, 0, 0, 5), 0, 0));
				}
				tabbedPane1.addTab("Rule details", panel5);
	...
	private JComboBox dispositionStatus;
