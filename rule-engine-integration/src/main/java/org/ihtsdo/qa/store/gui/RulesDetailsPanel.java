		...
		// ======== tabbedPane1 ========
		{
			...
			// ======== scrollBar1 ========
			{
				...
				// ======== panel1 ========
				{
					...
					panel1.add(label8, new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
					...
					panel1.add(ditaGeneratedTopicTextArea, new GridBagConstraints(1, 8, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
				}
