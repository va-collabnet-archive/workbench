...
public class UpdateAllKnowledgePackages extends AbstractTask {
	 ...
	 */
	public UpdateAllKnowledgePackages() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			UpdateAllPackagesTask updateTask = new UpdateAllPackagesTask(config);
			updateTask.execute();
