...
public class UpdateKnowledgePackagesForLinguisticGuidelines extends AbstractTask {
	 ...
	 */
	public UpdateKnowledgePackagesForLinguisticGuidelines() throws MalformedURLException {
		super();
	}
...
//					"rules/change-set.xml", true);
			config.setStatusMessage("Knowledge packages updated...");
