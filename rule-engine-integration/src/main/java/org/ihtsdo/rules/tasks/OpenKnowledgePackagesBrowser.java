...
public class OpenKnowledgePackagesBrowser extends AbstractTask {
	 ...
	 */
	public OpenKnowledgePackagesBrowser() throws MalformedURLException {
		super();
	}
	...
	throws TaskFailedException {
		try {
			...
			KnowledgeBase kbase = RulesLibrary.getKnowledgeBase(RulesLibrary.CONCEPT_MODEL_PKG);
