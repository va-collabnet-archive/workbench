...
import org.ihtsdo.qa.gui.DroolsEnumUpdatePanel;

/**
 * The Class OpenDroolsEnumUpdatePanel.
 */
@BeanList(specs = { @Spec(directory = "tasks/rules tasks", type = BeanType.TASK_BEAN) })
public class OpenDroolsEnumUpdatePanel extends AbstractTask {
	 ...
	 */
	public OpenDroolsEnumUpdatePanel() throws MalformedURLException {
		super();
	}
