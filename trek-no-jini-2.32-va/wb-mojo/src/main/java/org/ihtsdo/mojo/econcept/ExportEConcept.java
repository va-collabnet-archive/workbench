...
/**
 *
 * @goal export-econcepts
 *
 * @phase process-resources
 * @requiresDependencyResolution compile
 */
public class ExportEConcept extends AbstractMojo implements ProcessUnfetchedConceptDataBI {
   private static int conceptLimit = Integer.MAX_VALUE;

   //~--- fields --------------------------------------------------------------

   private transient int              conceptCount = 0;
   private transient DataOutputStream eConceptDOS;
   private transient NidBitSetBI      nidBitSet;
   ...
   public void execute() throws MojoExecutionException, MojoFailureException {
      try {
         File eConceptsFile = new File(outputDirectory, outputFile);
   ...
   public NidBitSetBI getNidSet() throws IOException {
      if (nidBitSet == null) {
         nidBitSet = Ts.get().getAllConceptNids();
      }
