...
public class SaveNewCapProfileBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
			...
			PropertyDescriptor rv[] = { profilePropName ,releaseDatePropName };
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SaveNewCapProfile.class);
        bd.setDisplayName("<html><font color='green'><center>Save New Int'l Profile");
        return bd;
    }
}
