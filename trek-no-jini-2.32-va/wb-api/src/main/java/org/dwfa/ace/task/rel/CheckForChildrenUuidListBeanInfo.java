...
public class CheckForChildrenUuidListBeanInfo extends SimpleBeanInfo {

    /**
     * 
     */
    public CheckForChildrenUuidListBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor uuidListListPropName = new PropertyDescriptor("uuidListListPropName",
                    CheckForChildrenUuidList.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(CheckForChildrenUuidList.class);
        bd.setDisplayName("<html><font color='green'><center>Check For Children <br>(uuid list)");
        return bd;
    }
}
