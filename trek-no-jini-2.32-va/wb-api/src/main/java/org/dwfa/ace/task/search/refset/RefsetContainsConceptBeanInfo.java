...
public class RefsetContainsConceptBeanInfo extends AbstractSearchTestBeanInfo {
    private static AbstractSeachTestSearchInfo searchInfo = new RefsetContainsConceptSearchInfo();
