...
public class GenerateConceptSpecFromRefset extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, final I_Work worker) throws TaskFailedException {
        try {
            String packageName = (String) process.getProperty(this.packageNamePropertyKey);
            String className = (String) process.getProperty(this.classNamePropertyKey);
            File outputDirectory = (File) process.getProperty(this.outputDirectoryPropertyKey);
