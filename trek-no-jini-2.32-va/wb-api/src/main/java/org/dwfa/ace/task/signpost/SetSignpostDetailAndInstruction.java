...
public class SetSignpostDetailAndInstruction extends AbstractTask {
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, final I_Work worker) throws TaskFailedException {
        try {
            ...
            final String detailHtmlStr = (String) process.getProperty(detailHtmlPropName);
            final String instructionHtmlStr = (String) process.getProperty(instructionHtmlPropName);
