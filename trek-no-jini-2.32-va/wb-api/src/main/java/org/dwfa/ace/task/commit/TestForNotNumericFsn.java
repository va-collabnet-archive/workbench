...
/**
 * The <code>TestForNotNumericFsn</code> class represents a data constraint test
 * that is to be run on any <code>concept</code> to verify that it has a 'fully
 * specified name' that is not a purely numeric value.
 * 
...
public class TestForNotNumericFsn extends AbstractConceptTest {

    private static final long serialVersionUID = 1;
    private static final int DATA_VERSION = 1;
    private static final String ALERT_MESSAGE = "<html>Non alpha-numeric value found:<br><font color='blue'>%1$s</font>"
    ...
    public List<AlertToDataConstraintFailure> test(I_GetConceptData concept, boolean forCommit)
        ...
        try {
            ...
            GetConceptDataValidationStrategy validator = new NotNumericConceptDataValidator(requiredConcept,
