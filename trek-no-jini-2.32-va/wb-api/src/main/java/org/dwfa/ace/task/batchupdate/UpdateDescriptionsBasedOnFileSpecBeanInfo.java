...
public class UpdateDescriptionsBasedOnFileSpecBeanInfo extends SimpleBeanInfo {

    /**
     * 
     */
    public UpdateDescriptionsBasedOnFileSpecBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor inputFilePropName = new PropertyDescriptor("inputFilePropName",
                UpdateDescriptionsBasedOnFileSpec.class);
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(UpdateDescriptionsBasedOnFileSpec.class);
        bd.setDisplayName("<html><font color='green'><center>Update descriptions<br>based on file");
        return bd;
    }
