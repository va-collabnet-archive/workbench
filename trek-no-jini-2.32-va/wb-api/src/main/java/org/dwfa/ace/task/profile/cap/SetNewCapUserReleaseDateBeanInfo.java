...
public class SetNewCapUserReleaseDateBeanInfo extends PreviousNextOrCancelBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = { releaseDatePropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(SetNewCapUserReleaseDate.class);
        bd.setDisplayName("<html><font color='green'><center>Set Release Date<br>for new user paths");
        return bd;
    }
