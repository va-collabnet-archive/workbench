...
public class UpdateSvnEntryBeanInfo extends SimpleBeanInfo {
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(UpdateSvnEntry.class);
        bd.setDisplayName("<html><font color='green'><center>Update Svn Entry");
        return bd;
    }
}
