...
public class NewEditPathForUserFromPropertyBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor parentPathPropertyName = new PropertyDescriptor("parentPathPropertyName",
                getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] = { profilePropName, parentPathPropertyName, userPropName, originTime };
            return rv;
