...
public class StateLastWorkflowHistorySearchInfo extends AbstractWorkflowHistorySearchTestSearchInfo {
    ...
    protected PropertyDescriptor[] getAdditionalPropertyDescriptors() {
        try {
	        ...
	        testState.setShortDescription("The concept to test has the proper last state.");
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(StateLastWorkflowHistory.class);
        bd.setDisplayName("State currently is");
        return bd;
    }
