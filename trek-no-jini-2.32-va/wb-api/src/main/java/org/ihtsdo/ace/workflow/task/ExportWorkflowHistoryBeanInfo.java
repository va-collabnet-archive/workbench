 ...
 * 
 */
public class ExportWorkflowHistoryBeanInfo extends SimpleBeanInfo {

    public ExportWorkflowHistoryBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(ExportWorkflowHistory.class);
        bd.setDisplayName("<html><font color='green'><center>Export Workflow History");
        return bd;
    }
}