...
public class LoadSetLaunchProcessFromAttachmentWithProp extends AbstractTask {
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (objDataVersion == dataVersion) {
            ...
            otherPropName = (String) in.readObject();
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker) throws TaskFailedException {
        try {
            ...
            String otherProp = (String) process.readProperty(otherPropName);
            ...
            processToLaunch.setProperty(otherPropName, otherProp);
//            Collection<String> attachmentKeys = process.getAttachmentKeys();
//            for (String attachmentKey : attachmentKeys){
//                processToLaunch.setProperty(attachmentKey, 
//                        process.readProperty(attachmentKey));
//            }
            ...
            if (process.getDestination() != null) {
                processToLaunch.setDestination(process.getDestination());
            }
            if (originator != null) {
    ...
    public void setOtherPropName(String otherPropName) {
