 ...
 */
public class SendAsAcceptableEvent extends GenericEvent {
	 ...
	 */
	public SendAsAcceptableEvent(ContextualizedDescription description) {
		super();
	...
	public EventType getAssociatedType() {
		return EventType.SEND_AS_ACCEPTABLE;
	}
