 ...
 */
public abstract class SendAsPreferredEventHandler<T> extends EventHandler<SendAsPreferredEvent>{
	 ...
	 */
	public SendAsPreferredEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SendAsPreferredEvent event);
}
