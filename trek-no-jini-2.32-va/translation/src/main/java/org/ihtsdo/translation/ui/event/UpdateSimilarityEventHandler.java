 ...
 */
public abstract class UpdateSimilarityEventHandler<T> extends EventHandler<UpdateSimilarityEvent>{
	 ...
	 */
	public UpdateSimilarityEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(UpdateSimilarityEvent event);
}
