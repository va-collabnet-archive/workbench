 ...
 */
public abstract class HistoryEventHandler<T> extends EventHandler<HistoryEvent>{
	 ...
	 */
	public HistoryEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(HistoryEvent event);
}
