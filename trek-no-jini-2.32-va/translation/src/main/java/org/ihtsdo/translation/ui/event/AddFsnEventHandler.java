 ...
 */
public abstract class AddFsnEventHandler<T> extends EventHandler<AddFsnEvent>{
	 ...
	 */
	public AddFsnEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(AddFsnEvent event);
}
