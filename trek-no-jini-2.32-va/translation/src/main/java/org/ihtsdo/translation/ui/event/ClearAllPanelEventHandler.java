 ...
 */
public abstract class ClearAllPanelEventHandler<T> extends EventHandler<ClearAllPanelEvent>{
	 ...
	 */
	public ClearAllPanelEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(ClearAllPanelEvent event);
}
