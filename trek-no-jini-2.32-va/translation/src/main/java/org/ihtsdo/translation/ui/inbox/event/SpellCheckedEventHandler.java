 ...
 */
public abstract class SpellCheckedEventHandler<T> extends EventHandler<SpellCheckedEvent>{
	
	/**
	 * Instantiates a new inbox item selected event handler.
	 *
	 * @param parent the parent
	 */
	public SpellCheckedEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SpellCheckedEvent event);
}
