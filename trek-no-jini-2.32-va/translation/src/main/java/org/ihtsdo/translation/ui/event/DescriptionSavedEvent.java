 ...
 */
public class DescriptionSavedEvent extends GenericEvent {

	private ContextualizedDescription description;
	private UUID worklist;

	/**
	 * Instantiates a new empty inbox item selected event.
	 */
	public DescriptionSavedEvent(ContextualizedDescription description, UUID worklist) {
		super();
	...
	public EventType getAssociatedType() {
		return EventType.DESCRIPTION_SAVED;
	}
	...
	public UUID getWorklist() {
		return worklist;
	}

	public void setWorklist(UUID worklist) {
