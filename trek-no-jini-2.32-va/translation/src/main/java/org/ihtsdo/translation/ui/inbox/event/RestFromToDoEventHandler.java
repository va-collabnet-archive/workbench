 ...
 */
public abstract class RestFromToDoEventHandler<T> extends EventHandler<RestFromToDoEvent>{
	 ...
	 */
	public RestFromToDoEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(RestFromToDoEvent event);
}
