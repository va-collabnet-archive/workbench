 ...
 */
public abstract class SpellcheckEventHandler<T> extends EventHandler<SpellcheckEvent>{
	 ...
	 */
	public SpellcheckEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SpellcheckEvent event);
}
