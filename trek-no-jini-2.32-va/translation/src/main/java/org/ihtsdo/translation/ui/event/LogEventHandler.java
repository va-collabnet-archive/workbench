 ...
 */
public abstract class LogEventHandler<T> extends EventHandler<LogEvent>{
	 ...
	 */
	public LogEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(LogEvent event);
}
