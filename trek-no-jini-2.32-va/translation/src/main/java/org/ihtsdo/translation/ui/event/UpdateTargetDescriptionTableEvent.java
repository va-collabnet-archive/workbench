 ...
 */
public class UpdateTargetDescriptionTableEvent extends GenericEvent {

	/**
	 * Instantiates a new empty inbox item selected event.
	 */
	public UpdateTargetDescriptionTableEvent() {
		super();
	}
	...
	public EventType getAssociatedType() {
		return EventType.UPDATE_TARGET_DESCRIPTION_TABLE;
	}
