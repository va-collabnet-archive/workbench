 ...
 */
public abstract class SaveDescriptionEventHandler<T> extends EventHandler<SaveDescriptionEvent>{
	 ...
	 */
	public SaveDescriptionEventHandler(Object parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	public abstract void handleEvent(SaveDescriptionEvent event);
}
