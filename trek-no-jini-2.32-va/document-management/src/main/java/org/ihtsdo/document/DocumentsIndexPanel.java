...
import org.ihtsdo.document.DictionaryIndexPanel.DictionaryIndexWorker;
...
public class DocumentsIndexPanel extends JPanel implements ActionListener {
	...
	private org.ihtsdo.document.DocumentsIndexPanel.DocumentIndexWorker documentIndexWorker;
	...
	public DocumentsIndexPanel() {
		...
		String results = "<html><body><font style='font-family:arial,sans-serif'>" + "Press the button to Index..." + "</font></body></html>";
	...
	public void actionPerformed(ActionEvent e) {
		if ("index".equals(e.getActionCommand())) {
			if (documentIndexWorker != null && !documentIndexWorker.isDone()) {
				documentIndexWorker.cancel(true);
				documentIndexWorker = null;
			}

			documentIndexWorker = new DocumentIndexWorker();
			documentIndexWorker.addPropertyChangeListener(new ProgressListener(progressBar));
			documentIndexWorker.execute();
		}
	}

	class DocumentIndexWorker extends SwingWorker<String, String> {
