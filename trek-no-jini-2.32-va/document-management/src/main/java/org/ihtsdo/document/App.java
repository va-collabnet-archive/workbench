...
import org.ihtsdo.lucene.LuceneManager.ShortTextSimilarity;
...
//					cd.close();
     ...
     */
    public static void search() throws IOException, InvalidTokenOffsetsException, org.apache.lucene.queryparser.classic.ParseException {
