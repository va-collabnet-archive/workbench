...
public class ExpandPathToNodeStateListener implements ChangeListener {
   ...
   public ExpandPathToNodeStateListener(JTreeWithDragImage tree, I_ConfigAceFrame config,
      ...
      List<? extends I_RelTuple> rels = focus.getSourceRelTuples(config.getAllowedStatus(),
