...
public class GetSearchCriterionFromWorkflowDetailsPanelAndSearchBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor resultSetPropName = new PropertyDescriptor("resultSetPropName",
                getBeanDescriptor().getBeanClass());
            ...
            PropertyDescriptor rv[] = { profilePropName, positionSetPropName, resultSetPropName };
            return rv;
