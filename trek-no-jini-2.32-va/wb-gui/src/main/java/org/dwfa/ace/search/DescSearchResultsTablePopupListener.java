...
public class DescSearchResultsTablePopupListener extends MouseAdapter implements ActionListener {
   ...
   private void addRefsetItems(JPopupMenu popup, boolean excludesConcept, boolean excludesDesc,
                               boolean excludesRel, boolean excludesContains, UUID descUuid)
   ...
   private void handlePopup(MouseEvent e)
      ...
      if (descTable.getCellRect(descTable.getSelectedRow(), descTable.getSelectedColumn(),
                                true).contains(e.getPoint())) {
                  ...
                  case CID_CID :
                     ...
                     Collection<? extends I_ExtendByRef> extensions =
                        Terms.get().getRefsetExtensionMembers(
                            config.getRefsetSpecInSpecEditor().getConceptNid());
