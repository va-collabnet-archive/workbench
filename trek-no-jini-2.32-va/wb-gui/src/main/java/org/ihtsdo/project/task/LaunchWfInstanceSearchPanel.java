...
/**
 * The Class LaunchWfInstanceSearchPanel.
 */
@BeanList(specs = {
    @Spec(directory = "tasks/project tasks", type = BeanType.TASK_BEAN)})
public class LaunchWfInstanceSearchPanel extends AbstractTask {
     ...
     */
    public LaunchWfInstanceSearchPanel() throws MalformedURLException {
        super();
    }
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
        ...
        try {
			...
			WfInstanceSearchPanel wfis = new WfInstanceSearchPanel();
            ...
            signpostPanel.add(wfis, BorderLayout.CENTER);
