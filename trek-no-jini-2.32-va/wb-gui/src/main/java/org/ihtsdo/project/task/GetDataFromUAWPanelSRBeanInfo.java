...
/**
 * The Class GetDataFromUAWPanelSRBeanInfo.
 */
public class GetDataFromUAWPanelSRBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new gets the data from uaw panel sr bean info.
     */
    public GetDataFromUAWPanelSRBeanInfo() {
        super();
    }
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(GetDataFromUAWPanelSR.class);
        bd.setDisplayName("<html><font color='green'><center>Get data<br>from UAW panel SR");
        return bd;
    }
}
