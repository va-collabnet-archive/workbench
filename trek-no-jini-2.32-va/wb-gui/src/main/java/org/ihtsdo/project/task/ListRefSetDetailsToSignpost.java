...
import org.ihtsdo.project.view.RefsetViewerPanel;
...
public class ListRefSetDetailsToSignpost extends AbstractTask {
     ...
     */
    public ListRefSetDetailsToSignpost() throws MalformedURLException {
        super();
    }
    ...
    public Condition evaluate(I_EncodeBusinessProcess process, I_Work worker)
        ...
        try {
            ...
            final RefsetViewerPanel refsetViewer = new RefsetViewerPanel(config);
            ...
            if (tp != null) {
                ...
                panel.add(refsetViewer, BorderLayout.CENTER);

                tp.addTab(TranslationHelperPanel.REFSET_VIEWER_NAME, panel);
