...
/**
 * The Class GenerateUAWAssignmentExecASBeanInfo.
 */
public class GenerateUAWAssignmentExecASBeanInfo extends SimpleBeanInfo {

    /**
     * Instantiates a new generate uaw assignment exec as bean info.
     */
    public GenerateUAWAssignmentExecASBeanInfo() {
        super();
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor rv[] = {profilePropName, memberPropName, processPropName, translatorInboxPropName, fastTrackTranslatorInboxPropName,
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(GenerateUAWAssignmentExecAS.class);
        bd.setDisplayName("<html><font color='green'><center>Generate UAW<br>assignment<br>for immediate exec AS");
        return bd;
    }
}
