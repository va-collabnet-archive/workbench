 ...
 * @author marc
 */
public class BatchActionTaskLogicUnionRetireUI extends javax.swing.JPanel implements I_BatchActionTask {

    BatchActionTask task;

    /**
     * Creates new form BatchActionTaskLogicUnionRetireUI
     */
    public BatchActionTaskLogicUnionRetireUI() {
        initComponents();

        // TASK
        this.task = new BatchActionTaskLogicUnionRetire();
    }
