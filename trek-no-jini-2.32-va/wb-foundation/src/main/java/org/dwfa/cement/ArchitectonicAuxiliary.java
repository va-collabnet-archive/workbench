...
public class ArchitectonicAuxiliary implements I_AddToMemoryTermServer {
    ...
    public enum Concept implements I_ConceptEnumeration,I_ConceptualizeUniversally {
        ...
        USER_ROLE("user role",
             ...
             ADMIN_ROLE("administrator role", "admin role",
                    new I_ConceptualizeUniversally[] { USER_ROLE }),
        WORKFLOW_COMMENT_TYPE("workflow comment",
        		new I_ConceptualizeUniversally[] { ARCHITECTONIC_ROOT_CONCEPT }),
        	...
        	WORKFLOW_REJECTION("rejection",
            		...
            		OTHER_REASON_REJECTION("other reason",
            				new I_ConceptualizeUniversally[] { WORKFLOW_REJECTION }),
			WORKFLOW_COMMENT_DIFF_TRANS("difficult translation", 
					new I_ConceptualizeUniversally[] { WORKFLOW_COMMENT_TYPE }),
					...
					WORKFLOW_COMMENT_AMBIGUOUS("ambiguous source fsn", 
							new I_ConceptualizeUniversally[] { WORKFLOW_COMMENT_DIFF_TRANS }),
			WORKFLOW_COMMENT_OTHER("other comment type / subtype", 
					new I_ConceptualizeUniversally[] { WORKFLOW_COMMENT_TYPE }),
        USER_PERMISSION("user permission",
              ...
              DEBORAH_KONICEK(new String[] {"Deborah Konicek", "dkonice"}, null,
                      new I_ConceptualizeUniversally[] { IHTSDO }),
              SARITA_KENI(new String[] {"Sarita Keni", "skeni"}, null,
                      new I_ConceptualizeUniversally[] { IHTSDO }),
              SAMANTHA_SPENCER(new String[] {"Samantha Spencer", "sspence"}, null,
                      new I_ConceptualizeUniversally[] { IHTSDO }),
    		  ...
    		  ALEJANDRO_RODRIGUEZ(new String[] {"Alejandro Rodriguez", "alejandro"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
    		  PENNI_HERNANDEZ(new String[] {"Penni Hernandez", "phernan"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  JEREMY_ROGERS(new String[] {"Jeremy Rogers", "jrogers"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  ED_CHEETHAME(new String[] {"Ed Cheethame", "edcheetham"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  BRUCE_GOLDBERG(new String[] {"Bruce Goldberg", "bgoldberg"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  JAMES_CASE(new String[] {"James Case", "jcase"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  CATHY_RICHARDSON(new String[] {"Cathy Richardson", "crichardson"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  KIN_WAH_FUNGA(new String[] {"Kin Wah Funga", "kfung"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  ROBERT_HAUSAM(new String[] {"Robert Hausam", "rhausam"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  SHAPOOR_SHAYEGANI(new String[] {"Shapoor Shayegani", "sshayegani"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  IAN_GREEN(new String[] {"Ian Green", "igreen"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  HERMAN_MUYS(new String[] {"Herman Muys", "hmuys"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  GERALDINE_WADE(new String[] {"Geraldine Wade", "gwade"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  JANE_HOWARTH(new String[] {"Jane Howarth", "jhowarth"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
                  PAUL_AMOS(new String[] {"Paul Amos", "pamos"}, null,
	        		  new I_ConceptualizeUniversally[] { IHTSDO }),
        ...
        MODULE_CONCEPT("module concept",
                new I_ConceptualizeUniversally[] { ARCHITECTONIC_ROOT_CONCEPT }),
                AUXILIARY_MODULE(new String[] {"terminology auxiliary module (module concept)","terminology auxiliary module"}, null,
                        new I_ConceptualizeUniversally[] { MODULE_CONCEPT }) ,
        LANGUAGE_CONCEPT("language concept",
              ...
              DESCRIPTION_TYPE("description type",
                 ...
                 FULLY_SPECIFIED_DESCRIPTION_TYPE(PrimordialId.FULLY_SPECIFIED_DESCRIPTION_TYPE_ID,
                                                        new String[] {"RF1 fully specified name (description type)", "RF1 fully specified name"}, null,
                                                        new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),
                  SYNONYM_DESCRIPTION_TYPE(new String[] {"RF1 synonym (description type)", "RF1 synonym"}, null,
                          new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),
                  TEXT_DEFINITION_TYPE("text definition (description type)",
                                  new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),
                  UNSPECIFIED_DESCRIPTION_TYPE("unspecified  (description type)",
                          new I_ConceptualizeUniversally[] { DESCRIPTION_TYPE }),
                  PREFERRED_DESCRIPTION_TYPE(PrimordialId.PREFERED_TERM_ID, new String[] {"RF1 preferred term (description type)", "RF1 preferred term"}, null,
        ...
        STATUS("status (status type)",
            ...
            ACTIVE("active (active status type)",
                    ...
                    REVIEWED_NOT_APPROVED_DELETION("reviewed and not approved deletion (active status type)",
                            new I_ConceptualizeUniversally[] { FLAGGED_FOR_REVIEW }),
                    TRIAL("trial (active status type)", "Concept is experimental in nature.  Use with caution.  May change in the future.",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
                    DISCOURAGED("discouraged (active status type)", "Concept is not recommended for current use.  New mappings should not use this concept.",
                            new I_ConceptualizeUniversally[] { ACTIVE }),
            INACTIVE("inactive (inactive status type)",
                    ...
                    EXTINCT("extinct (inactive status type)",
                            new I_ConceptualizeUniversally[] { INACTIVE }),
                    DEPRECATED("deprecated (inactive status type)", "Concept is deprecated, and should not be used.",
                            new I_ConceptualizeUniversally[] { INACTIVE }),
    ...
    ID_SOURCE("identifier source",
        ...
        CPT("CPT ID", null,
                new I_ConceptualizeUniversally[] { ID_SOURCE }),
        /* Enums for Translation module & project */        
        PROJECTS_ROOT_HIERARCHY("Terminology Project Auxiliary concept",
            ...
            WORKSETS_ROOT("worksets",
                    new I_ConceptualizeUniversally[] { PROJECTS_ROOT_HIERARCHY }),
            PROJECT_NAMESPACE_REFSET("project namespace refset",
					new I_ConceptualizeUniversally[] { PROJECTS_ROOT_HIERARCHY }),        
            ...
            PROJECT_ATTRIBUTES_ROOT("project manager attributes",
    			...
    			HAS_LANGUAGE_TARGET_REFSET_ATTRIBUTE("has language target refset",
    					new I_ConceptualizeUniversally[] { PROJECT_ATTRIBUTES_ROOT }),
				HAS_RELEASE_PATH_REFSET_ATTRIBUTE("has release path refset",
						new I_ConceptualizeUniversally[] { PROJECT_ATTRIBUTES_ROOT }),
				HAS_MODULE_ID_REFSET_ATTRIBUTE("has module id refset",
						new I_ConceptualizeUniversally[] { PROJECT_ATTRIBUTES_ROOT }),
				HAS_SOURCE_DEFECTS_ISSUE_REPO("has source defects issues repository",
						new I_ConceptualizeUniversally[] { PROJECT_ATTRIBUTES_ROOT }),
				HAS_PROJECT_ISSUE_REPO("has project issues repository",
						new I_ConceptualizeUniversally[] { PROJECT_ATTRIBUTES_ROOT }),
			PROJECT_VIEWER_ROLE("project viewer role",
    	    		new I_ConceptualizeUniversally[] { USER_ROLE }),
    	    ...
    	    CONFIGURATION_MANAGER_ROLE("configuration role",
    	    		...
    	    		MODIFY_FILE_LINK_PERMISSION("file link permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    				MODIFY_FSN_GENERATION_STRATEGY_PERMISSION("fsn generation strategy permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    				MODIFY_ICS_GENERATION_STRATEGY_PERMISSION("ics generation strategy permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    				MODIFY_INBOX_COLUMNS_DISPLAY_PERMISSION("inbox columns display permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),		
    				MODIFY_INBOX_ITEM_PERMISSION("inbox item permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    				MODIFY_SOURCE_DESCRIPTION_DISPLAY("source descriptions display permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    				MODIFY_TARGET_DESCRIPTION_DISPLAY("target descriptions display permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
    	    		MODIFY_TRANSLATION_DEFAULT_EDITOR_PERMISSION("modify default editor mode permission", 
    	    				new I_ConceptualizeUniversally[] { CONFIGURATION_MANAGER_ROLE }),
		...
		new I_ConceptualizeUniversally[] { USER_ROLE }),
			TRANSLATOR_TSP_ROLE(new String[] {"translation service provider translator role", 
			...
			TRANSLATION_TSP_REVIEWER_ROLE(new String[] {"translation service provider reviewer role",
					...
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			TRANSLATION_TPO_REVIEWER_ROLE(new String[] {"translation project owner reviewer role",
					"tpo reviewer role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			TRANSLATION_SME_ROLE(new String[] {"translation subject matter expert role",
					"translation sme role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			TRANSLATION_TPO_SME_ROLE(new String[] {"translation tpo subject matter expert role",
					"translation tpo sme role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			TRANSLATION_CV_ROLE(new String[] {"translation clinical validator role",
					"translation clinical validator role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			TRANSLATION_EDITORIAL_BOARD_ROLE(new String[] {"translation editorial board role",
					"translation editorial board role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
			RELEASE_AUTHORITY_ROLE(new String[] {"release authority role",
					"release authority role"}, null,
					new I_ConceptualizeUniversally[] { TRANSLATOR_ROLE }),
		SNOMED_LANGUAGE_ES_PATH("spanish language path",
                new I_ConceptualizeUniversally[] { RELEASE }),
        SNOMED_LANGUAGE_SE_PATH("swedish language path",
                new I_ConceptualizeUniversally[] { RELEASE }),
        SNOMED_LANGUAGE_EN_GB_PATH("gb english language path",
                new I_ConceptualizeUniversally[] { RELEASE }),
        SNOMED_LANGUAGE_DA_PATH("danish language path",
                new I_ConceptualizeUniversally[] { RELEASE }),
	    SNOMED_LANGUAGE_FR_PATH("french language path",
	            new I_ConceptualizeUniversally[] { RELEASE }),
	...
	SEMTAGS_ROOT("semantic tags",
            ...
            SEMTAG_SNOMED_ROOT("SNOMED RT+CTV3",
            		...
            		SEMTAG_METADATA_ROOT("metadata",
                     		new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT }),
                     		SEMTAG_CORE_METADATA("core metadata concept",
                     				new I_ConceptualizeUniversally[] { SEMTAG_METADATA_ROOT }),
             				SEMTAG_FOUNDATION_METADATA("foundation metadata concept",
             						new I_ConceptualizeUniversally[] { SEMTAG_METADATA_ROOT }),
					...
					SEMTAG_LINKAGE_CONCEPT("linkage concept",
							new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_CORE_METADATA }),
							SEMTAG_LINK_ASSERTION("link assertion",
									new I_ConceptualizeUniversally[] { SEMTAG_LINKAGE_CONCEPT }),
					SEMTAG_SPECIAL_CONCEPT("special concept",
							new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT }),	
							SEMTAG_NAMESPACE_CONCEPT("namespace concept",
									new I_ConceptualizeUniversally[] { SEMTAG_SPECIAL_CONCEPT, SEMTAG_CORE_METADATA }),
							SEMTAG_INACTIVE_CONCEPT("inactive concept",
									new I_ConceptualizeUniversally[] { SEMTAG_SPECIAL_CONCEPT }),
									SEMTAG_SPECIMEN("specimen",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
									...
									SEMTAG_CONTEXT_DEPENDANT_CATEGORY("context-dependent category",
											new I_ConceptualizeUniversally[] { SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_BODY_STRUCTURE("body structure",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),	
											SEMTAG_CELL_STRUCTURE("cell structure",
													new I_ConceptualizeUniversally[] { SEMTAG_BODY_STRUCTURE }),
									SEMTAG_ASSESMENT_SCALE("assessment scale",
						            		new I_ConceptualizeUniversally[] { SEMTAG_INACTIVE_CONCEPT, SEMTAG_STAGING_SCALE }),
						    		SEMTAG_ATTRIBUTE("attribute",
						    				new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_LINKAGE_CONCEPT, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_ENVIRONMENT("environment",
											new I_ConceptualizeUniversally[] { SEMTAG_ENVIRONMENT_LOCATION, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_EVENT("event",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_FINDING("finding",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_DISORDER("disorder",
													new I_ConceptualizeUniversally[] { SEMTAG_FINDING, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_GEOGRAPHIC_LOCATION("geographic location",
											new I_ConceptualizeUniversally[] { SEMTAG_ENVIRONMENT_LOCATION, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_MORPHOLOGIC_ABNORMALITY("morphologic abnormality",
											new I_ConceptualizeUniversally[] { SEMTAG_BODY_STRUCTURE, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_CELL("cell",
													new I_ConceptualizeUniversally[] { SEMTAG_BODY_STRUCTURE, SEMTAG_CELL_STRUCTURE, SEMTAG_INACTIVE_CONCEPT, SEMTAG_MORPHOLOGIC_ABNORMALITY }),
									SEMTAG_NAVIGATIONAL_CONCEPT("navigational concept",
											new I_ConceptualizeUniversally[] { SEMTAG_SPECIAL_CONCEPT, SEMTAG_INACTIVE_CONCEPT }),
									...
									SEMTAG_PHYSICAL_OBJECT("physical object",
											...
											SEMTAG_PRODUCT("product",
													new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT, SEMTAG_PHYSICAL_OBJECT }),
									SEMTAG_PROCEDURE("procedure",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_REGIME_THERAPY("regime/therapy",
													new I_ConceptualizeUniversally[] { SEMTAG_PROCEDURE, SEMTAG_INACTIVE_CONCEPT }),
									SEMTAG_QUALIFIER_VALUE("qualifier value",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_ADMINISTRATIVE_CONCEPT("administrative concept",
													new I_ConceptualizeUniversally[] { SEMTAG_QUALIFIER_VALUE }),
									SEMTAG_SOCIAL_CONCEPT("social concept",
											new I_ConceptualizeUniversally[] { SEMTAG_SNOMED_ROOT, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_LIFE_STYLE("life style",
													new I_ConceptualizeUniversally[] { SEMTAG_SOCIAL_CONCEPT, SEMTAG_INACTIVE_CONCEPT }),
											SEMTAG_RACIAL_GROUP("racial group",
													new I_ConceptualizeUniversally[] { SEMTAG_SOCIAL_CONCEPT }),
											...
											SEMTAG_PERSON("person",
													...
													SEMTAG_OCCUPATION("occupation",
															new I_ConceptualizeUniversally[] { SEMTAG_PERSON, SEMTAG_INACTIVE_CONCEPT, SEMTAG_SOCIAL_CONCEPT }),
		TRANSLATION_STATUS("translation status",
				...
				TODO_STATUS("to-do status",
						...
						SME_TODO_STATUS("SME to-do status",
								new I_ConceptualizeUniversally[] { TODO_STATUS }),	
						TPO_SME_TODO_STATUS("TPO SME to-do status",
								new I_ConceptualizeUniversally[] { TODO_STATUS }),	
				...
				REJECTED_STATUS("rejected status",
						...
						REJECTED_BY_EDITORIAL_BOARD_STATUS("rejected by editorial board status",
								new I_ConceptualizeUniversally[] { REJECTED_STATUS }),
								REJECTED_BY_EDITORIAL_BOARD_TO_TSP_STATUS("rejected by editorial board to tsp status",
										new I_ConceptualizeUniversally[] { REJECTED_BY_EDITORIAL_BOARD_STATUS }),
								REJECTED_BY_EDITORIAL_BOARD__TO_TPO_STATUS("rejected by editorial board to tpo status",
										new I_ConceptualizeUniversally[] { REJECTED_BY_EDITORIAL_BOARD_STATUS }),
						REJECTED_FAST_TRACK_STATUS("rejected fast track status",
								new I_ConceptualizeUniversally[] { REJECTED_STATUS }),
				TRANSLATED_STATUS("translated status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						TRANSLATED_FAST_TRACK_STATUS("translated with fast track status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				REVIEWED_BY_TSP_STATUS("reviewed by TSP reviewer status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				REFERRED_TO_SME_STATUS("referred to SME status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				REFERRED_TO_CLINICAL_VALIDATOR_STATUS("referred to clinical validator status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				REFERRED_TO_TPO_SME_STATUS("referred to TPO SME status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				SME_FEEDBACK_COMPLETE_STATUS("SME feedback complete status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				CLINICAL_VALIDATOR_FEEDBACK_COMPLETE_STATUS("clinical validator feedback complete status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				TPO_SME_FEEDBACK_COMPLETE_STATUS("TPO SME feedback complete status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				APPROVED_FOR_PUBLICATION_STATUS("approved for publication status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						APPROVED_FOR_PUBLICATION_FAST_TRACK_STATUS("approved for publication with fast track status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						APPROVED_FOR_PUBLICATION_TPO_REV_STATUS("approved for publication by tpo reviewer status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						APPROVED_FOR_PUBLICATION_EB_STATUS("approved for publication by editorial board status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
				ESCALATED_TO_EDITORIAL_BOARD_STATUS("escalated to editorial board status",
						new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						ESCALATED_TO_EDITORIAL_BOARD_BY_TSP_STATUS("escalated to editorial board by tsp status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
						ESCALATED_TO_EDITORIAL_BOARD_BY_TPO_STATUS("escalated to editorial board by tpo status",
								new I_ConceptualizeUniversally[] { TRANSLATION_STATUS }),
	            ...
	            WORKFLOW_INITIAL_HISTORY_STATE(new String[] {"Initial history workflow state", "Initial history"}, null, new I_ConceptualizeUniversally[] { WORKFLOW_STATES }), 
	            WORKFLOW_CONCEPT_CREATION_STATE(new String[] {"Concept creation workflow state", "Concept creation"}, null, new I_ConceptualizeUniversally[] { WORKFLOW_STATES }), 
