...
public class TimestampBeforeWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static TimestampBeforeWorkflowHistorySearchInfo searchInfo = new TimestampBeforeWorkflowHistorySearchInfo();
