...
public class StateLastWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static StateLastWorkflowHistorySearchInfo searchInfo = new StateLastWorkflowHistorySearchInfo();
