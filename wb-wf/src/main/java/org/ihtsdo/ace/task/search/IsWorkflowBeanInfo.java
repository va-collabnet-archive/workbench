...
public class IsWorkflowBeanInfo extends AbstractSearchTestBeanInfo {
    private static IsWorkflowSearchInfo searchInfo = new IsWorkflowSearchInfo();

    public PropertyDescriptor[] getPropertyDescriptors() {
        PropertyDescriptor[] searchDescriptors = searchInfo.getPropertyDescriptors();

        List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>(Arrays.asList(searchDescriptors));
