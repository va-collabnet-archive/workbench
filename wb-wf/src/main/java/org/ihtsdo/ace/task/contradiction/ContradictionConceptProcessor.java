...
import org.ihtsdo.concept.ContradictionIdentifier.CONTRADICTION_RESULT;
...
public class ContradictionConceptProcessor implements I_ProcessUnfetchedConceptData {
	...
	private ContradictionIdentifier detector = null;
	...
	public ContradictionConceptProcessor(PositionBI position) 
	{
			...
			detector = new ContradictionIdentifier(); 
	}
