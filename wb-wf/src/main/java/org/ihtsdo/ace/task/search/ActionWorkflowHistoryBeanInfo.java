...
public class ActionWorkflowHistoryBeanInfo extends AbstractWorkflowHistorySearchTestBeanInfo {
    private static ActionWorkflowHistorySearchInfo searchInfo = new ActionWorkflowHistorySearchInfo();
