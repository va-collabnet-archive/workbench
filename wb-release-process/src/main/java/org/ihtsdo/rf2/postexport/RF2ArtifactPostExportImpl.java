...
public class RF2ArtifactPostExportImpl extends RF2ArtifactPostExportAbst{
	...
	public RF2ArtifactPostExportImpl(FILE_TYPE fType, File rf2FullFolder,
		...
		logger.info("FILE TYPE: " + fType);
		logger.info("RF2 Full Folder: " + rf2FullFolder);
		logger.info("RF2 Exported: " + rf2Exported);
...
//		this.rf2FullFolder = new File(rf2FullFolder.getAbsolutePath() + "/org/ihtsdo/rf2");
		...
		logger.info("Folder TEmp: " + folderTmp.getAbsolutePath());
		...
		logger.info("Sorted Temp: " + sortedfolderTmp.getAbsolutePath());
		...
		logger.info("sortTmpfolderSortedTmp: " + sortTmpfolderSortedTmp.getAbsolutePath());
		...
		logger.info("snapshotfolderTmp: " + snapshotfolderTmp.getAbsolutePath());
		...
		logger.info("rf2FullOutputFolder: " + rf2FullOutputFolder.getAbsolutePath());
		...
		logger.info("rf2DeltaOutputFolder: " + rf2DeltaOutputFolder.getAbsolutePath());
		...
		logger.info("rf2SnapshotOutputFolder: " + rf2SnapshotOutputFolder.getAbsolutePath());
...
//		filterPreviousfile.delete();
		...
		logger.info("sortedExportedfile: " + sortedExportedfile.getAbsolutePath());
		...
		logger.info("snapshotSortedPreviousfile: " + snapshotSortedPreviousfile.getAbsolutePath());
		sg.execute();
		sg=null;
		System.gc();
		...
		logger.info("snapshotSortedExportedfile: " + snapshotSortedExportedfile.getAbsolutePath());
		sg.execute();
		sg=null;
		System.gc();
		...
		logger.info("merging full final file: ");
