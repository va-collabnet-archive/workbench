...
public abstract class RF2ArtifactPostExportAbst {
	...
	public static enum FILE_TYPE{
		...
		RF2_DESCRIPTION(new int[]{0,1},new int[]{0},new Integer[]{2,3,4,5,6,7,8},"sct2_Description_SUFFIX-LANGUAGECODE_NAMESPACE",1),
		...
		RF2_TEXTDEFINITION(new int[]{0,1},new int[]{0},new Integer[]{2,4,5,6,7,8},"sct2_TextDefinition_SUFFIX-LANGUAGECODE_NAMESPACE",1),
		RF2_LANGUAGE_REFSET(new int[]{0,1},new int[]{0},new Integer[]{2,4,5,6},"der2_cRefset_LanguageSUFFIX-LANGUAGECODE_NAMESPACE",1), 
	...
	public File getFullOutputFile(String parentFolder,FILE_TYPE fType,String date){
		...
		retFile=retFile.replace("NAMESPACE",namespace);
		retFile=retFile.replace("LANGUAGECODE",langCode);
		retFile+="_" + date + fileExtension;
