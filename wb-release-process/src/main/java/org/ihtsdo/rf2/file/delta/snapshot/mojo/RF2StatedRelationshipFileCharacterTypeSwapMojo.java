 ...
 * 
 * @goal rf2-stated-relationship-characteristictypeid
 * 
 * @phase install
 */
public class RF2StatedRelationshipFileCharacterTypeSwapMojo extends AbstractMojo {
			...
			try {
				...
				while ((line = rf2FileReader.readLine()) != null ) {
				    	...
				    	if(part[8].equals("900000000000006009")){				    	
				    		//System.out.println("==========================================");
				    		String newChar= part[8].replace("900000000000006009", "900000000000010007");
				    		part[8] = newChar;	
				    		newline="";
				...
				System.out.println("======RF2 Stated Relationship Characteristic Type File updated==========");		
