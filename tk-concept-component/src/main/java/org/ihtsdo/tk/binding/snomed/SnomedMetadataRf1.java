...
public class SnomedMetadataRf1 {
    ...
    // SCT ID: none.
    /** The SYNOMY m_ descriptio n_ typ e_ r f1. */
    ...
    /** The PREFERRE d_ acceptabilit y_ r f1. */
    ...
    /** The ACCEPTABL e_ descriptio n_ typ e_ r f1. */
    ...
    // GB language 101032
    /** The G b_ languag e_ refse t_ r f1. */
...
//            UUID.fromString(""));
    ...
    // optional 1
    /** The OPTIONA l_ refinabilit y_ typ e_ r f1. */
    ...
    // mandatory 2
    /** The MANDATOR y_ refinabilit y_ typ e_ r f1. */
    ...
    // Defining 0
    /** The DEFININ g_ characteristi c_ typ e_ r f1. */
    ...
    // Inferred 0
    /** The INFERRE d_ definin g_ characteristi c_ typ e_ r f1. */
    ...
    //
    // Stated 0
    /** The STATE d_ definin g_ characteristi c_ typ e_ r f1. */
    ...
    // Qualifying 1
    /** The QUALIFIE r_ characteristic s_ typ e_ r f1. */
    ...
    // Historical 2
    /** The HISTORICA l_ characteristi c_ typ e_ r f1. */
    ...
    // Duplicate 2
    /** The DUPLICAT e_ inactiv e_ statu s_ r f1. */
    ...
    // Pending_move 11
    /** The PENDIN g_ mov e_ activ e_ statu s_ r f1. */
    ...
    // Ambiguous 4
    /** The AMBIGUOU s_ inactiv e_ statu s_ r f1. */
    ...
    // Moved_elsewhere 10
    /** The MOVE d_ elsewher e_ inactiv e_ statu s_ r f1. */
    ...
    /** The CONCEP t_ retire d_ activ e_ statu s_ r f1. */
    ...
    // Outdated 3
    /** The OUTDATE d_ inactiv e_ statu s_ r f1. */
    ...
    // Inappropriate 7
    /** The INAPPROPRIAT e_ inactiv e_ statu s_ r f1. */
    ...
    // Erroneous 5
    /** The ERRONEOU s_ inactiv e_ statu s_ r f1. */
    ...
    // reasonNotStated 1
    /** The RETIRE d_ inactiv e_ statu s_ r f1. */
    ...
    /** The MA y_ b e_ a_ attribut e_ r f1. */
    ...
    /** The SAM e_ a s_ attribut e_ r f1. */
    ...
    /** The REPLACE d_ b y_ attribut e_ r f1. */
    ...
    /** The REFER s_ t o_ refse t_ r f1. */
