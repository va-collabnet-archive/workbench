...
public class RelationshipConstraintOutgoing extends RelationshipConstraint {
    ...
    /**
     * Writes the incoming relationship constraint object to an external source.
     *
    ...
    /**
     * Reads the incoming relationship constraint object from an external
     * source.
     *
    ...
    /**
     * Instantiates a new incoming relationship constraint based on the
