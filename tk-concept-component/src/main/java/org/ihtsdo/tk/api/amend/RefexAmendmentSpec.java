...
public final class RefexAmendmentSpec {
    ...
    public UUID setMemberContentUuid() throws InvalidAmendmentSpec, IOException {
     ...
     * @throws IOException
     */
    public UUID computeMemberContentUuid() throws InvalidAmendmentSpec, IOException {
        try {
    ...
    private String getPrimoridalUuidStr(RefexProperty prop)
        ...
        throw new InvalidAmendmentSpec("Can't find nid for: " + prop +
    ...
    public RefexAmendmentSpec with(RefexProperty key, Number value) {
        put(key, value);
        return this;
    }

    public RefexAmendmentSpec with(RefexProperty key, String value) {
        assert key == RefexProperty.STRING1;
        properties.put(key, value);
        return this;
    }

    public RefexAmendmentSpec with(RefexProperty key, Boolean value) {
        assert key == RefexProperty.BOOLEAN1;
        properties.put(key, value);
        return this;
    }
    ...
    public void setContentUuid() throws InvalidAmendmentSpec, IOException {
        this.properties.put(RefexProperty.MEMBER_UUID,
