 ...
 * @see TkConcept
 */
public class TkRefsetStrStrRevision extends TkRevision {
    ...
    //~--- fields --------------------------------------------------------------
    /**
     * The first string value associated with this TK Refset String Revision.
     */
    public String string1;
    
    /**
     * The second string value associated with this TK Refset String Revision.
     */
     ...
     */
    public TkRefsetStrStrRevision(RefexStringStringVersionBI refexStringStringVersion) throws IOException {
     ...
     */
    public TkRefsetStrStrRevision(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
        super();
     ...
     */
    public TkRefsetStrStrRevision(TkRefsetStrStrRevision another, Map<UUID, UUID> conversionMap, long offset,
            boolean mapAll) {
    ...
    public boolean equals(Object obj) {
        ...
        if (TkRefsetStrStrRevision.class.isAssignableFrom(obj.getClass())) {
            TkRefsetStrStrRevision another = (TkRefsetStrStrRevision) obj;
     ...
     */
    @Override
    public TkRefsetStrStrRevision makeConversion(Map<UUID, UUID> conversionMap, long offset, boolean mapAll) {
        return new TkRefsetStrStrRevision(this, conversionMap, offset, mapAll);
    }
    ...
    public final void readExternal(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
        ...
        string2 = UtfHelper.readUtfV7(in, dataVersion);
    }
    ...
    //~--- get methods ---------------------------------------------------------
    /**
     * Gets the first string associated with this TK Refset String Revision.
     *
     * @return the first string associated with this TK Refset String Revision
     */
    ...
    /**
     * Gets the second string associated with this TK Refset String Revision.
     *
     * @return the second string associated with this TK Refset String Revision
     */
    ...
    //~--- set methods ---------------------------------------------------------
    /**
     * Sets the first string associated with this TK Refset String Revision.
     *
    ...
    /**
     * Sets the second string associated with this TK Refset String Revision.
     *
     * @param string2 associated with this TK Refset String Revision
     */
