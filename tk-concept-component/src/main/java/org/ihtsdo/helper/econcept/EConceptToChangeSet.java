 ...
 * the License.
 */
package org.ihtsdo.helper.econcept;
...
/**
 * Converts eConcept files to change set files, using the current time as the
 * commit time for the change set.
 *
 */
public class EConceptToChangeSet {

    /**
     * Create change set files, based on the input econFiles, with each file
     * appended with ".eccs".
     *
    ...
    /**
     * Create change set files from the source econFiles[i], writing the change
     * set to the corresponding eccsFiles[i] (correspondence based on array
     * index). This method allows output files to be written to any directory.
     *
     * @param econFiles Files to convert to change set files.
