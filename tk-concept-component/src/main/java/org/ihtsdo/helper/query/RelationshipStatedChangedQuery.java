...
public class RelationshipStatedChangedQuery {
    ...
    public RelationshipStatedChangedQuery(ViewCoordinate v1, ViewCoordinate v2) {
        ...
        query = Query.or(Relationship.added(true, v1, v2, Clause.and(WithRelationship.characteristic(true, Subsumption.IS, SnomedMetadataRf2.STATED_RELATIONSHIP_RF2))),
                 Relationship.changedStatus(true, v1, v2, Clause.and(WithRelationship.characteristic(true, Subsumption.IS, SnomedMetadataRf2.STATED_RELATIONSHIP_RF2))),
                 Relationship.changedGroup(true, v1, v2, Clause.and(WithRelationship.characteristic(true, Subsumption.IS, SnomedMetadataRf2.STATED_RELATIONSHIP_RF2))));
    }
