...
/**
 * The class <code>RelationshipInferredChangedQuery</code> represents a query asking
 * for inferred relationships which have been added or changed between two positions.
 */
public class RelationshipInferredChangedQuery {
    private Query query;
    
    /**
     * Constructs a inferred relationship changed query using the interval represented
     ...
     */
    public RelationshipInferredChangedQuery(ViewCoordinate v1, ViewCoordinate v2) {
