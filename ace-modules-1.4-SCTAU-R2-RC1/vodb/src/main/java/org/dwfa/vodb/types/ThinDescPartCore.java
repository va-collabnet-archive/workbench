...
public class ThinDescPartCore implements I_AmPart {
    ...
    public boolean equals(Object obj) {
        ...
        return ((initialCaseSignificant == another.initialCaseSignificant) && (lang.equals(another.lang))
            && (pathId == another.pathId) && (typeId == another.typeId) && (version == another.version));
    }
    ...
    public int hashCode() {
        ...
        return HashFunction.hashCode(new int[] { bhash, lang.hashCode(), pathId, statusId, typeId, version });
    }
