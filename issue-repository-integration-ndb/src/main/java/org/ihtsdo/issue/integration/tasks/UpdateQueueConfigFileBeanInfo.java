...
/**
 * The Class UpdateQueueConfigFileBeanInfo.
 */
public class UpdateQueueConfigFileBeanInfo extends SimpleBeanInfo {
	
	/**
	 * Instantiates a new update queue config file bean info.
	 */
	public UpdateQueueConfigFileBeanInfo() {
		super();
	}
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			PropertyDescriptor issueRepoProp = new PropertyDescriptor("issueRepoProp", UpdateQueueConfigFile.class);
			...
			PropertyDescriptor selectedWorker = new PropertyDescriptor("selectedWorker", UpdateQueueConfigFile.class);
			...
			PropertyDescriptor message = new PropertyDescriptor("message", UpdateQueueConfigFile.class);
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor bd = new BeanDescriptor(UpdateQueueConfigFile.class);
		bd.setDisplayName("<html><font color='green'><center>Update Queue<br>config file");
		return bd;
	}
