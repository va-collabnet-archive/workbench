...
/**
 * The Class AddSMERepositoryDataToProfile.
 */
@BeanList(specs = 
{ @Spec(directory = "tasks/ide/issues", type = BeanType.TASK_BEAN)})
public class AddSMERepositoryDataToProfile extends AbstractTask {
	...
	throws TaskFailedException {
			...
			try{
				...
				config.getDbConfig().getProperties().put("SMERepositoryUUID", 
						issueRepoConcept.getUids().iterator().next());
