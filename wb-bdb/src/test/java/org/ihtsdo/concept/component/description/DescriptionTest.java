...
public class DescriptionTest {
    ...
    private Description testObj1;
    private Description testObj2;
    private Description testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<Description> coll = new java.util.HashSet<Description>();
        coll.add(testObj1);
    ...
    private Description makeTestObject1() {
    ...
    private Description makeTestObject2() {
