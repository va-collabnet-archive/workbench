...
public class CidCidMemberTest {
    ...
    private CidCidMember testObj1;
    private CidCidMember testObj2;
    private CidCidMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidCidMember> coll = new java.util.HashSet<CidCidMember>();
        coll.add(testObj1);
    ...
    private CidCidMember makeTestObject1() {
        
        // Create an object to test... 
        CidCidMember obj = new CidCidMember();
        obj.setC1Nid(1);
        obj.setC2Nid(1);
        obj.revisions = new CopyOnWriteArrayList<CidCidRevision>();
        CidCidRevision rev = new CidCidRevision(); 
    ...
    private CidCidMember makeTestObject2() {
