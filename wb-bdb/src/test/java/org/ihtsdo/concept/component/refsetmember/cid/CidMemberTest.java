...
public class CidMemberTest {
    ...
    private CidMember testObj1;
    private CidMember testObj2;
    private CidMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidMember> coll = new java.util.HashSet<CidMember>();
        coll.add(testObj1);
    ...
    private CidMember makeTestObject1() {
        
        // Create an object to test... 
        CidMember obj = new CidMember();
        obj.setC1Nid(1);
        obj.revisions = new CopyOnWriteArrayList<CidRevision>();
    ...
    private CidMember makeTestObject2() {
