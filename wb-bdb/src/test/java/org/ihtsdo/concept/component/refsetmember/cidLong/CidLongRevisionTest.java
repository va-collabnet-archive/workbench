...
public class CidLongRevisionTest {

    private CidLongRevision testObj1;
    private CidLongRevision testObj2;
    private CidLongRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidLongRevision> coll = new java.util.HashSet<CidLongRevision>();
        coll.add(testObj1);
    ...
    private CidLongRevision makeTestObject1() {
        
        // Create an object to test... 
        CidLongRevision obj = new CidLongRevision();
        obj.setC1id(1);
        obj.setLongValue(1);
        obj.setC1id(1);
    ...
    private CidLongRevision makeTestObject2() {
