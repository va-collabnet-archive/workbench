...
public class CidCidCidRevisionTest {

    private CidCidCidRevision testObj1;
    private CidCidCidRevision testObj2;
    private CidCidCidRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidCidCidRevision> coll = new java.util.HashSet<CidCidCidRevision>();
        coll.add(testObj1);
    ...
    private CidCidCidRevision makeTestObject1() {
        
        // Create an object to test... 
        CidCidCidRevision obj = new CidCidCidRevision();
        obj.setC1id(1);
        obj.setC2id(1);
        obj.setC3id(1);
        obj.setC1Nid(1);
    ...
    private CidCidCidRevision makeTestObject2() {
