...
public class LongMemberTest {

    private LongMember testObj1;
    private LongMember testObj2;
    private LongMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<LongMember> coll = new java.util.HashSet<LongMember>();
        coll.add(testObj1);
    ...
    private LongMember makeTestObject1() {
