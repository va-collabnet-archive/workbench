...
public class ConceptAttributesTest {

    private ConceptAttributes testObj1;
    private ConceptAttributes testObj2;
    private ConceptAttributes testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<ConceptAttributes> coll = new java.util.HashSet<ConceptAttributes>();
        coll.add(testObj1);
    ...
    private ConceptAttributes makeTestObject1() throws IOException {
    ...
    private ConceptAttributes makeTestObject2() throws IOException {
