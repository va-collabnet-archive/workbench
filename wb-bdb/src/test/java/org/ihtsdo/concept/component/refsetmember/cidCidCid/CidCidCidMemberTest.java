...
public class CidCidCidMemberTest {
    ...
    private CidCidCidMember testObj1;
    private CidCidCidMember testObj2;
    private CidCidCidMember testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidCidCidMember> coll = new java.util.HashSet<CidCidCidMember>();
        coll.add(testObj1);
    ...
    private CidCidCidMember makeTestObject1() {
        
        // Create an object to test... 
        CidCidCidMember obj = new CidCidCidMember();
        obj.setC1Nid(1);
        obj.setC2Nid(1);
        obj.setC3Nid(1);
    ...
    private CidCidCidMember makeTestObject2() {
