...
public class CidFloatRevisionTest {
    ...
    private CidFloatRevision testObj1;
    private CidFloatRevision testObj2;
    private CidFloatRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidFloatRevision> coll = new java.util.HashSet<CidFloatRevision>();
        coll.add(testObj1);
    ...
    private CidFloatRevision makeTestObject1() {
        
        // Create an object to test... 
        CidFloatRevision obj = new CidFloatRevision();
        obj.setC1Nid(1);
    ...
    private CidFloatRevision makeTestObject2() {
