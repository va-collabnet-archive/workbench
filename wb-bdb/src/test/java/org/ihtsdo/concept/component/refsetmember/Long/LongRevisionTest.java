...
public class LongRevisionTest {

    private LongRevision testObj1;
    private LongRevision testObj2;
    private LongRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<LongRevision> coll = new java.util.HashSet<LongRevision>();
        coll.add(testObj1);
    ...
    private LongRevision makeTestObject1() {
        
        // Create an object to test... 
        LongRevision obj = new LongRevision();
    ...
    private LongRevision makeTestObject2() {
