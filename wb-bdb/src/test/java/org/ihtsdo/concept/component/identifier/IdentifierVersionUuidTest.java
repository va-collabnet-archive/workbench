...
public class IdentifierVersionUuidTest {

    private IdentifierVersionUuid testObj1;
    private IdentifierVersionUuid testObj2;
    private IdentifierVersionUuid testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<IdentifierVersionUuid> coll = new java.util.HashSet<IdentifierVersionUuid>();
        coll.add(testObj1);
    ...
    private IdentifierVersionUuid makeTestObject1() {
        
        // Create an object to test... 
        IdentifierVersionUuid obj = new IdentifierVersionUuid();
    ...
    private IdentifierVersionUuid makeTestObject2() {
