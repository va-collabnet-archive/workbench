...
public class CidRevisionTest {

    private CidRevision testObj1;
    private CidRevision testObj2;
    private CidRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidRevision> coll = new java.util.HashSet<CidRevision>();
        coll.add(testObj1);
    ...
    private CidRevision makeTestObject1() {
        
        // Create an object to test... 
        CidRevision obj = new CidRevision();
        obj.setC1id(1);
    ...
    private CidRevision makeTestObject2() {
