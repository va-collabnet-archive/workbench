...
public class CidIntRevisionTest {

    private CidIntRevision testObj1;
    private CidIntRevision testObj2;
    private CidIntRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<CidIntRevision> coll = new java.util.HashSet<CidIntRevision>();
        coll.add(testObj1);
    ...
    private CidIntRevision makeTestObject1() {
        
        // Create an object to test... 
        CidIntRevision obj = new CidIntRevision();
        obj.setC1id(1);
        obj.setIntValue(1);
        obj.setC1Nid(1);
        ...
        CidIntMember member = new CidIntMember();
    ...
    private CidIntRevision makeTestObject2() {
