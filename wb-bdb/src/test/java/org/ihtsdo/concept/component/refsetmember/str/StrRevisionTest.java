...
public class StrRevisionTest {

    private StrRevision testObj1;
    private StrRevision testObj2;
    private StrRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<StrRevision> coll = new java.util.HashSet<StrRevision>();
        coll.add(testObj1);
    ...
    private StrRevision makeTestObject1() {
    ...
    private StrRevision makeTestObject2() {
