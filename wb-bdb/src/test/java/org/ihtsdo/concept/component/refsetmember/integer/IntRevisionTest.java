...
public class IntRevisionTest {

    private IntRevision testObj1;
    private IntRevision testObj2;
    private IntRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<IntRevision> coll = new java.util.HashSet<IntRevision>();
        coll.add(testObj1);
    ...
    private IntRevision makeTestObject1() {
        
        // Create an object to test... 
        IntRevision obj = new IntRevision();
        obj.setIntValue(1);
        obj.setStatusAtPositionNid(1);
        obj.sapNid = 1; 
        
        IntMember member = new IntMember();
    ...
    private IntRevision makeTestObject2() {
