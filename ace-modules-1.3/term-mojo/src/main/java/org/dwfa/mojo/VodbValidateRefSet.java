...
public class VodbValidateRefSet extends AbstractMojo {
    ...
    /**
     * @parameter
     *            The number of items to add to the uncommitted list before
     *            committing
     */
        ...
        try {
            ...
            if (details.size() > 0) {
                ...
                throw new ConflictFailure(
                    "Conflicts found during ref set spec verification. See report file for more details.");
            }
        ...
        protected void setMembers() throws Exception {
            ...
            for (Integer refset : newRefsetMembers.keySet()) {
                ...
                for (Integer integer : keySet) {
                    ...
                    for (I_GetConceptData c : termFactory.getConcept(newMember.getConceptId()).getSourceRelTargets(
                        ...
                        if (conceptId == termFactory.getConcept(newMember.getInclusionReasonId()).getConceptId()
                            ...
                            if (!addedConcepts.contains(new Integer(conceptId))) {
                                ...
                                sb.append(" because of "
                                    + termFactory.getConcept(newMember.getInclusionReasonId()).toString());
