...
public class InstructWithReviewSelectedAndDoneBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor rv[] = { instruction, profilePropName };
            return rv;
    ...
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(InstructWithReviewSelectedAndDone.class);
        bd.setDisplayName("<html><font color='green'><center>Instruct and Wait:<br>Review selected<br>and Done");
        return bd;
    }
}
